# knetikcloud-sdk.UsersRelationshipsApi
...
var apiInstance = new knetikcloud-sdk.UsersRelationshipsApi();

var opts = { 
  'relationship': new knetikcloud-sdk.UserRelationshipResource() // UserRelationshipResource | The new relationship
};
