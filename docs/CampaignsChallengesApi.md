...
var opts = { 
  'challengeActivityTemplateResource': new KnetikPlatformApiDocumentationLatest.TemplateResource() // TemplateResource | The challengeActivity template resource object
};
