# knetikcloud-sdk.CampaignsChallengesApi
...
var apiInstance = new knetikcloud-sdk.CampaignsChallengesApi();

var opts = { 
  'challengeResource': new knetikcloud-sdk.ChallengeResource() // ChallengeResource | The challenge resource object
};
...
var opts = { 
  'challengeActivityResource': new knetikcloud-sdk.ChallengeActivityResource(), // ChallengeActivityResource | The challenge activity resource object
...
var opts = { 
  'challengeActivityTemplateResource': new knetikcloud-sdk.TemplateResource() // TemplateResource | The challengeActivity template resource object
};
...
apiInstance.createChallengeActivityTemplate(opts, callback);
```
...
var opts = { 
  'challengeTemplateResource': new knetikcloud-sdk.TemplateResource() // TemplateResource | The challenge template resource object
};
...
apiInstance.deleteChallengeActivity(id, challengeId, callback);
```
...
apiInstance.deleteChallengeActivityTemplate(id, opts, callback);
```
...
apiInstance.getChallengeActivity(id, challengeId, callback);
```
...
apiInstance.getChallengeActivityTemplate(id, callback);
```
...
apiInstance.getChallengeActivityTemplates(opts, callback);
```
...
apiInstance.updateChallengeActivity(id, challengeId, opts, callback);
```
...
apiInstance.updateChallengeActivityTemplate(id, opts, callback);
```
