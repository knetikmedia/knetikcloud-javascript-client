# knetikcloud-sdk.BRERuleEngineTriggersApi
...
var apiInstance = new knetikcloud-sdk.BRERuleEngineTriggersApi();

var opts = { 
  'breTriggerResource': new knetikcloud-sdk.BreTriggerResource() // BreTriggerResource | The BRE trigger resource object
};
