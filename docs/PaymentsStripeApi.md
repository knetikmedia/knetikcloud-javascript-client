# knetikcloud-sdk.PaymentsStripeApi
...
var apiInstance = new knetikcloud-sdk.PaymentsStripeApi();

var opts = { 
  'request': new knetikcloud-sdk.StripeCreatePaymentMethod() // StripeCreatePaymentMethod | The request to create a Stripe customer with payment info
};
...
var opts = { 
  'request': new knetikcloud-sdk.StripePaymentRequest() // StripePaymentRequest | The request to pay an invoice
};
