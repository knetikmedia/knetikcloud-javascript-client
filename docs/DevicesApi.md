...
var apiInstance = new KnetikcloudSdk.DevicesApi();

var userResources = [new KnetikcloudSdk.SimpleUserResource()]; // [SimpleUserResource] | userResources
...
var device = new KnetikcloudSdk.DeviceResource(); // DeviceResource | device
