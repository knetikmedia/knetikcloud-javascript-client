...
var apiInstance = new knetikcloud-sdk.DevicesApi();

var userResources = [new knetikcloud-sdk.SimpleUserResource()]; // [SimpleUserResource] | userResources
...
var device = new knetikcloud-sdk.DeviceResource(); // DeviceResource | device
