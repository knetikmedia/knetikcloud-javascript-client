...
# **createActivity**
> RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc createActivity(opts)
...
var opts = { 
  'activityResource': new KnetikPlatformApiDocumentationLatest.RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc() // RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc | The activity resource object
};
...
> AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings createActivityOccurrence(opts)
...
var opts = { 
  ...
  'activityOccurrenceResource': new KnetikPlatformApiDocumentationLatest.AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings() // AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings | The activity occurrence object
};
...
var opts = { 
  ...
  'filterId': new KnetikPlatformApiDocumentationLatest.ModelObject(), // ModelObject | Filter for activities with an id in the given comma separated list of ids
...
# **updateActivity**
> RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc updateActivity(id, opts)
