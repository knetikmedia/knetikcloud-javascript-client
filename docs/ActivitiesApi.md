...
var apiInstance = new knetikcloud-sdk.ActivitiesApi();

var opts = { 
  'activityResource': new knetikcloud-sdk.ActivityResource() // ActivityResource | The activity resource object
};
...
var opts = { 
  ...
  'activityOccurrenceResource': new knetikcloud-sdk.ActivityOccurrenceResource() // ActivityOccurrenceResource | The activity occurrence object
};
...
var opts = { 
  'activityTemplateResource': new knetikcloud-sdk.TemplateResource() // TemplateResource | The activity template resource object
};
...
var opts = { 
  'activityOccurrenceResults': new knetikcloud-sdk.ActivityOccurrenceResultsResource() // ActivityOccurrenceResultsResource | The activity occurrence object
};
