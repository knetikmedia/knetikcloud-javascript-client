...
> PageRevenueCountryReportResource executiveRevenueCountrySalesUsingGET(currencyCode, opts)
...
> PageRevenueProductReportResource executiveRevenueProductSalesUsingGET(currencyCode, opts)
