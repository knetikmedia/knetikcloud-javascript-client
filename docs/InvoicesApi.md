...
> PageInvoiceResource getInvoiceHistoryUsingGET(opts)
...
var opts = { 
  ...
  'filterCreatedDate': "filterCreatedDate_example", // String | Filters invoices by creation date. Multiple values possible for range search. Format: filter_date_created=OP,ts&... where OP in (GT, LT, GOE, LOE, EQ) and ts is a unix timestamp in seconds. Ex: filter_date_created=GT,1452154258&filter_date_created=LT,1554254874
...
# **getLogsUsingGET**
> PageInvoiceLogEntry getLogsUsingGET(id, opts)
