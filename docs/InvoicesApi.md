...
var apiInstance = new knetikcloud-sdk.InvoicesApi();

var opts = { 
  'req': new knetikcloud-sdk.InvoiceCreateRequest() // InvoiceCreateRequest | Invoice to be created
};
...
var opts = { 
  'request': new knetikcloud-sdk.PayBySavedMethodRequest() // PayBySavedMethodRequest | Payment info
};
...
apiInstance.setBundledInvoiceItemFulfillmentStatus(id, bundleSku, sku, status, callback);
```
...
var opts = { 
  'request': new knetikcloud-sdk.InvoicePaymentStatusRequest() // InvoicePaymentStatusRequest | Payment status info
};
...
var opts = { 
  'billingInfoRequest': new knetikcloud-sdk.AddressResource() // AddressResource | Address info
};
