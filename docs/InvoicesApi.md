...
var opts = { 
  ...
  'filterVendorIds': new KnetikPlatformApiDocumentationLatest.ModelObject(), // ModelObject | Filters invoices for ones from one of the vendors whose id is in the given comma separated list
