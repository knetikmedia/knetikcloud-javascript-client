...
> PageResourceCommentResource getCommentsUsingGET1(videoId, opts)
...
> PageResourceDispositionResource getDispositionsUsingGET1(videoId, opts)
...
# **getRelatedUsingGET**
> PageResourceVideoRelationshipResource getRelatedUsingGET(videoId, opts)
...
> PageResourceVideoResource getUserVideosUsingGET(userId, opts)
...
> PageResourceVideoResource searchVideosUsingGET(opts)
