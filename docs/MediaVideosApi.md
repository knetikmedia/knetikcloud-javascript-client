...
[**deleteRelationshipUsingDELETE**](MediaVideosApi.md#deleteRelationshipUsingDELETE) | **DELETE** /media/videos/{video_id}/related/{id} | Delete a video&#39;s relationship
...
[**updateRelationshipUsingPUT**](MediaVideosApi.md#updateRelationshipUsingPUT) | **PUT** /media/videos/{video_id}/related/{id}/relationship_details | Update a video&#39;s relationship details
...
> deleteRelationshipUsingDELETE(videoId, id)
...
apiInstance.deleteRelationshipUsingDELETE(videoId, id, callback);
```
...
> updateRelationshipUsingPUT(videoId, relationshipId, opts)
...
apiInstance.updateRelationshipUsingPUT(videoId, relationshipId, opts, callback);
```
