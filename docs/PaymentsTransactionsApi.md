# knetikcloud-sdk.PaymentsTransactionsApi
...
var apiInstance = new knetikcloud-sdk.PaymentsTransactionsApi();
...
var opts = { 
  'request': new knetikcloud-sdk.RefundRequest() // RefundRequest | Request containing refund details
};
