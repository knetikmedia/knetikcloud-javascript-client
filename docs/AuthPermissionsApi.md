# knetikcloud-sdk.AuthPermissionsApi
...
var apiInstance = new knetikcloud-sdk.AuthPermissionsApi();

var opts = { 
  'permissionResource': new knetikcloud-sdk.PermissionResource() // PermissionResource | The permission resource object
};
