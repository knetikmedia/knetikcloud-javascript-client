# knetikcloud-sdk.CampaignsRewardsApi
...
var apiInstance = new knetikcloud-sdk.CampaignsRewardsApi();

var opts = { 
  'rewardSetResource': new knetikcloud-sdk.RewardSetResource() // RewardSetResource | The reward set resource object
};
