...
var apiInstance = new knetikcloud-sdk.CurrenciesApi();

var opts = { 
  'currency': new knetikcloud-sdk.CurrencyResource() // CurrencyResource | The currency object
};
