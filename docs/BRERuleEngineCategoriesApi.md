# knetikcloud-sdk.BRERuleEngineCategoriesApi
...
var apiInstance = new knetikcloud-sdk.BRERuleEngineCategoriesApi();

var opts = { 
  'template': new knetikcloud-sdk.TemplateResource() // TemplateResource | The category template to create
};
...
var opts = { 
  'category': new knetikcloud-sdk.BreCategoryResource() // BreCategoryResource | The updated BRE category information
};
...
var opts = { 
  'template': new knetikcloud-sdk.TemplateResource() // TemplateResource | The updated category template definition
};
