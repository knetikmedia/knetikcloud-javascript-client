...
apiInstance.deleteGroupMemberUsingDELETE(uniqueName, userId, callback);
```
...
apiInstance.deleteGroupUsingDELETE(uniqueName, callback);
```
...
apiInstance.getGroupListUsingGET(userId, callback);
```
...
apiInstance.getGroupMemberUsingGET(uniqueName, userId, callback);
```
...
> PageResourceTemplateResource getGroupTemplatesUsingGET(opts)
...
> PageResourceGroupMemberResource searchGroupsUsingGET(uniqueName, opts)
...
> PageResourceGroupResource searchGroupsUsingGET1(opts)
