# knetikcloud-sdk.UsersGroupsApi
...
var apiInstance = new knetikcloud-sdk.UsersGroupsApi();

var uniqueName = "uniqueName_example"; // String | The group unique name

var user = new knetikcloud-sdk.GroupMemberResource(); // GroupMemberResource | The id and status for a user to add to the group
...
var users = [new knetikcloud-sdk.GroupMemberResource()]; // [GroupMemberResource] | The id and status for a list of users to add to the group
...
var opts = { 
  'groupResource': new knetikcloud-sdk.GroupResource() // GroupResource | The new group
};
...
var opts = { 
  'groupTemplateResource': new knetikcloud-sdk.TemplateResource() // TemplateResource | The group template resource object
};
...
var opts = { 
  'groupResource': new knetikcloud-sdk.GroupResource() // GroupResource | The updated group
};
