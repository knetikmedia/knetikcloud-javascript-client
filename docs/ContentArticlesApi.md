# knetikcloud-sdk.ContentArticlesApi
...
var apiInstance = new knetikcloud-sdk.ContentArticlesApi();

var opts = { 
  'articleResource': new knetikcloud-sdk.ArticleResource() // ArticleResource | The new article
};
...
var opts = { 
  'articleTemplateResource': new knetikcloud-sdk.TemplateResource() // TemplateResource | The article template resource object
};
...
var opts = { 
  'articleResource': new knetikcloud-sdk.ArticleResource() // ArticleResource | The article object
};
