...
var apiInstance = new knetikcloud-sdk.TaxesApi();

var opts = { 
  'taxResource': new knetikcloud-sdk.CountryTaxResource() // CountryTaxResource | The tax object
};
...
var opts = { 
  'taxResource': new knetikcloud-sdk.StateTaxResource() // StateTaxResource | The tax object
};
