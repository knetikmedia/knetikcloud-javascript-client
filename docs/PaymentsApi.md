...
var apiInstance = new knetikcloud-sdk.PaymentsApi();

var userId = 56; // Number | ID of the user for whom the payment method is being created

var opts = { 
  'paymentMethod': new knetikcloud-sdk.PaymentMethodResource() // PaymentMethodResource | Payment method being created
};
...
var opts = { 
  'request': new knetikcloud-sdk.PaymentAuthorizationResource() // PaymentAuthorizationResource | Payment authorization request
};
...
var opts = { 
  'paymentMethod': new knetikcloud-sdk.PaymentMethodResource() // PaymentMethodResource | The updated payment method data
};
