# knetikcloud-sdk.GamificationTriviaApi
...
var apiInstance = new knetikcloud-sdk.GamificationTriviaApi();

var questionId = "questionId_example"; // String | The id of the question

var opts = { 
  'answer': new knetikcloud-sdk.AnswerResource() // AnswerResource | The new answer
};
...
var opts = { 
  'request': new knetikcloud-sdk.ImportJobResource() // ImportJobResource | The new import job
};
...
var opts = { 
  'question': new knetikcloud-sdk.QuestionResource() // QuestionResource | The new question
};
...
var opts = { 
  'questionTemplateResource': new knetikcloud-sdk.QuestionTemplateResource() // QuestionTemplateResource | The question template resource object
};
...
var opts = { 
  'request': new knetikcloud-sdk.ImportJobResource() // ImportJobResource | The updated job
};
...
var opts = { 
  'question': new knetikcloud-sdk.QuestionResource() // QuestionResource | The updated question
};
...
var opts = { 
  'answer': new knetikcloud-sdk.AnswerResource() // AnswerResource | The updated answer
};
...
var opts = { 
  'question': new knetikcloud-sdk.QuestionResource(), // QuestionResource | New values for a set of question fields
  'filterSearch': "filterSearch_example", // String | Filter for documents whose question, answers or tags contains provided string
  'filterIdset': "filterIdset_example", // String | Filter for documents whose id is in the comma separated list provided
  'filterCategory': "filterCategory_example", // String | Filter for questions with specified category, by id
  'filterTagset': "filterTagset_example", // String | Filter for questions with specified tags (separated by comma)
