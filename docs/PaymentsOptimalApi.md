# knetikcloud-sdk.PaymentsOptimalApi
...
var apiInstance = new knetikcloud-sdk.PaymentsOptimalApi();

var opts = { 
  'request': new knetikcloud-sdk.OptimalPaymentRequest() // OptimalPaymentRequest | The payment request to initiate
};
