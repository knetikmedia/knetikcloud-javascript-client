# knetikcloud-sdk.PaymentsXsollaApi
...
var apiInstance = new knetikcloud-sdk.PaymentsXsollaApi();

var opts = { 
  'request': new knetikcloud-sdk.XsollaPaymentRequest() // XsollaPaymentRequest | The payment request to be sent to XSolla
};
