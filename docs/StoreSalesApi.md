...
var apiInstance = new knetikcloud-sdk.StoreSalesApi();

var opts = { 
  'catalogSale': new knetikcloud-sdk.CatalogSale() // CatalogSale | The catalog sale object
};
