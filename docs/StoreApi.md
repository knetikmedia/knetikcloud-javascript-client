...
> ItemTemplateResource createItemTemplateUsingPOST(opts)
...
var opts = { 
  'itemTemplateResource': new KnetikPlatformApiDocumentationLatest.ItemTemplateResource() // ItemTemplateResource | The new item template
};
...
------------- | ------------- | ------------- | -------------
 **itemTemplateResource** | [**ItemTemplateResource**](ItemTemplateResource.md)| The new item template | [optional] 
...
> ItemTemplateResource getItemTemplateUsingGET(id)
...
> PageItemTemplateResource getItemTemplatesUsingGET(opts)
...
> PageStoreItem getStoreItemsUsingGET(opts)
...
# **getUsingGET2**
> PageStoreItem getUsingGET2(opts)
...
var opts = { 
  'itemTemplateResource': new KnetikPlatformApiDocumentationLatest.ItemTemplateResource() // ItemTemplateResource | The item template resource object
};
...
------------- | ------------- | ------------- | -------------
 **id** | **String**| The id of the template | 
 **itemTemplateResource** | [**ItemTemplateResource**](ItemTemplateResource.md)| The item template resource object | [optional] 
