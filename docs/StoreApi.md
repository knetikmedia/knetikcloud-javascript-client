...
var apiInstance = new knetikcloud-sdk.StoreApi();

var opts = { 
  'itemTemplateResource': new knetikcloud-sdk.StoreItemTemplateResource() // StoreItemTemplateResource | The new item template
};
...
var opts = { 
  ...
  'storeItem': new knetikcloud-sdk.StoreItem() // StoreItem | The store item object
};
...
apiInstance.getBehaviors(callback);
```
...
var opts = { 
  'itemTemplateResource': new knetikcloud-sdk.StoreItemTemplateResource() // StoreItemTemplateResource | The item template resource object
};
