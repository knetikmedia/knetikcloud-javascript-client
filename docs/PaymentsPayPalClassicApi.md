# knetikcloud-sdk.PaymentsPayPalClassicApi
...
var apiInstance = new knetikcloud-sdk.PaymentsPayPalClassicApi();

var opts = { 
  'request': new knetikcloud-sdk.CreateBillingAgreementRequest() // CreateBillingAgreementRequest | The request to create a PayPal billing agreement
};
...
var opts = { 
  'request': new knetikcloud-sdk.CreatePayPalPaymentRequest() // CreatePayPalPaymentRequest | The request to create a PayPal payment token
};
...
var opts = { 
  'request': new knetikcloud-sdk.FinalizeBillingAgreementRequest() // FinalizeBillingAgreementRequest | The request to finalize a PayPal billing agreement
};
...
var opts = { 
  'request': new knetikcloud-sdk.FinalizePayPalPaymentRequest() // FinalizePayPalPaymentRequest | The request to finalize the payment
};
