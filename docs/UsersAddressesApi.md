# knetikcloud-sdk.UsersAddressesApi
...
var apiInstance = new knetikcloud-sdk.UsersAddressesApi();

var userId = "userId_example"; // String | The id of the user

var opts = { 
  'savedAddressResource': new knetikcloud-sdk.SavedAddressResource() // SavedAddressResource | The new address
};
...
var opts = { 
  'savedAddressResource': new knetikcloud-sdk.SavedAddressResource() // SavedAddressResource | The saved address resource object
};
