# knetikcloud-sdk.StoreShoppingCartsApi
...
var apiInstance = new knetikcloud-sdk.StoreShoppingCartsApi();

var id = "id_example"; // String | The id of the cart

var opts = { 
  'customDiscount': new knetikcloud-sdk.CouponDefinition() // CouponDefinition | The details of the discount to add
};
...
var opts = { 
  'skuRequest': new knetikcloud-sdk.SkuRequest() // SkuRequest | The request of the sku
};
...
var opts = { 
  'cartItemRequest': new knetikcloud-sdk.CartItemRequest() // CartItemRequest | The cart item request object
};
...
var opts = { 
  'cartShippingAddressRequest': new knetikcloud-sdk.CartShippingAddressRequest() // CartShippingAddressRequest | The cart shipping address request object
};
