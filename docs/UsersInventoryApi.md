# knetikcloud-sdk.UsersInventoryApi
...
var apiInstance = new knetikcloud-sdk.UsersInventoryApi();

var id = 56; // Number | The id of the user

var opts = { 
  'userInventoryAddRequest': new knetikcloud-sdk.UserInventoryAddRequest() // UserInventoryAddRequest | The user inventory add request object
};
...
var opts = { 
  ...
  'entitlementItem': new knetikcloud-sdk.EntitlementItem() // EntitlementItem | The entitlement item object
};
...
var opts = { 
  'template': new knetikcloud-sdk.ItemTemplateResource() // ItemTemplateResource | The entitlement template to be created
};
...
var grantRequest = new knetikcloud-sdk.EntitlementGrantRequest(); // EntitlementGrantRequest | grantRequest
...
var opts = { 
  'template': new knetikcloud-sdk.ItemTemplateResource() // ItemTemplateResource | The updated template
};
