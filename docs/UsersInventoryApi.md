...
# **getUserInventory1**
> PageResourceUserInventoryResource getUserInventory1(id, opts)
...
apiInstance.getUserInventory1(id, opts, callback);
```
...
> getUserInventoryLog1(userId, id, opts)
...
apiInstance.getUserInventoryLog1(userId, id, opts, callback);
```
