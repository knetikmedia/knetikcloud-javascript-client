...
> PageEntitlementItem getCurrenciesUsingGET1(opts)
...
> PageItemTemplateResource getEntitlementTemplatesUsingGET(opts)
...
> PageUserInventoryResource getInventoryListUsingGET(opts)
...
> PageUserInventoryResource getUserInventoryListUsingGET(id, opts)
...
> PageUserItemLogResource getUserInventoryLogUsingGET(userId, id, opts)
