# KnetikcloudSdk.UsersInventoryApi
...
var apiInstance = new KnetikcloudSdk.UsersInventoryApi();

var id = 56; // Number | The id of the user

var opts = { 
  'userInventoryAddRequest': new KnetikcloudSdk.UserInventoryAddRequest() // UserInventoryAddRequest | The user inventory add request object
};
...
var opts = { 
  ...
  'entitlementItem': new KnetikcloudSdk.EntitlementItem() // EntitlementItem | The entitlement item object
};
...
var opts = { 
  'template': new KnetikcloudSdk.ItemTemplateResource() // ItemTemplateResource | The entitlement template to be created
};
...
var grantRequest = new KnetikcloudSdk.EntitlementGrantRequest(); // EntitlementGrantRequest | grantRequest
...
var opts = { 
  'template': new KnetikcloudSdk.ItemTemplateResource() // ItemTemplateResource | The updated template
};
