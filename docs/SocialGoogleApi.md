# knetikcloud-sdk.SocialGoogleApi
...
var apiInstance = new knetikcloud-sdk.SocialGoogleApi();

var opts = { 
  'googleToken': new knetikcloud-sdk.GoogleToken() // GoogleToken | The token from google
};
