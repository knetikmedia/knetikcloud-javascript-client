# KnetikcloudSdk.GamificationLevelingApi
...
var apiInstance = new KnetikcloudSdk.GamificationLevelingApi();

var opts = { 
  'level': new KnetikcloudSdk.LevelingResource() // LevelingResource | The level schema definition
};
...
var opts = { 
  'newLevel': new KnetikcloudSdk.LevelingResource() // LevelingResource | The level schema definition
};
