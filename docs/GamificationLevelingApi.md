# knetikcloud-sdk.GamificationLevelingApi
...
var apiInstance = new knetikcloud-sdk.GamificationLevelingApi();

var opts = { 
  'level': new knetikcloud-sdk.LevelingResource() // LevelingResource | The level schema definition
};
...
var opts = { 
  'newLevel': new knetikcloud-sdk.LevelingResource() // LevelingResource | The level schema definition
};
