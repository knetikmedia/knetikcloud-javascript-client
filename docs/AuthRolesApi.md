...
var apiInstance = new knetikcloud-sdk.AuthRolesApi();

var opts = { 
  'roleResource': new knetikcloud-sdk.RoleResource() // RoleResource | The role resource object
};
...
var opts = { 
  'rolesList': [new knetikcloud-sdk.[String]()] // [String] | The list of unique roles
};
...
var opts = { 
  'permissionsList': [new knetikcloud-sdk.[String]()] // [String] | The list of unique permissions
};
