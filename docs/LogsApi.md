...
var apiInstance = new knetikcloud-sdk.LogsApi();

var opts = { 
  'logEntry': new knetikcloud-sdk.UserActionLog() // UserActionLog | The user log entry to be added
};
