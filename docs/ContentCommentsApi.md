# KnetikcloudSdk.ContentCommentsApi
...
var apiInstance = new KnetikcloudSdk.ContentCommentsApi();

var opts = { 
  'commentResource': new KnetikcloudSdk.CommentResource() // CommentResource | The comment to be added
};
