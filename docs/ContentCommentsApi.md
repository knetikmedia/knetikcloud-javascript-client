# knetikcloud-sdk.ContentCommentsApi
...
var apiInstance = new knetikcloud-sdk.ContentCommentsApi();

var opts = { 
  'commentResource': new knetikcloud-sdk.CommentResource() // CommentResource | The comment to be added
};
