# knetikcloud-sdk.BRERuleEngineEventsApi
...
var apiInstance = new knetikcloud-sdk.BRERuleEngineEventsApi();

var opts = { 
  'breEvent': new knetikcloud-sdk.BreEvent() // BreEvent | The BRE event object
};
