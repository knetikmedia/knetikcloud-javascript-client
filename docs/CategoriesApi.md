...
var apiInstance = new knetikcloud-sdk.CategoriesApi();

var opts = { 
  'category': new knetikcloud-sdk.CategoryResource() // CategoryResource | The category to create
};
...
var opts = { 
  'template': new knetikcloud-sdk.TemplateResource() // TemplateResource | The template to create
};
...
var opts = { 
  'category': new knetikcloud-sdk.CategoryResource() // CategoryResource | The category to update
};
...
var opts = { 
  'template': new knetikcloud-sdk.TemplateResource() // TemplateResource | The updated template information
};
