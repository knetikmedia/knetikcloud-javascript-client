...
> PageUsageInfo getUsageByDayUsingGET(startDate, endDate, opts)
...
> PageUsageInfo getUsageByHourUsingGET(startDate, endDate, opts)
...
> PageUsageInfo getUsageByMinuteUsingGET(startDate, endDate, opts)
...
> PageUsageInfo getUsageByMonthUsingGET(startDate, endDate, opts)
...
> PageUsageInfo getUsageByYearUsingGET(startDate, endDate, opts)
