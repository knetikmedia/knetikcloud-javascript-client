# knetikcloud-sdk.SocialFacebookApi
...
var apiInstance = new knetikcloud-sdk.SocialFacebookApi();

var opts = { 
  'facebookToken': new knetikcloud-sdk.FacebookToken() // FacebookToken | The token from facebook
};
