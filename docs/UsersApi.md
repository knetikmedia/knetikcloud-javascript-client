...
var opts = { 
  'passwordReset': new KnetikPlatformApiDocumentationLatest.ARequestToResetAUsersPasswordByUsingAKnownUserProperty() // ARequestToResetAUsersPasswordByUsingAKnownUserProperty | An object containing one of three methods to look up a user
};
