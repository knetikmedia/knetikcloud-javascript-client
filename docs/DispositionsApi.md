# knetikcloud-sdk.DispositionsApi
...
var apiInstance = new knetikcloud-sdk.DispositionsApi();

var opts = { 
  'disposition': new knetikcloud-sdk.DispositionResource() // DispositionResource | The new disposition record
};
