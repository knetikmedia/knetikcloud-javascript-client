...
var apiInstance = new knetikcloud-sdk.SearchApi();
...
var opts = { 
  'mappings': [new knetikcloud-sdk.SearchReferenceMapping()] // [SearchReferenceMapping] | The mappings to add
};
