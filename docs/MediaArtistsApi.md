# knetikcloud-sdk.MediaArtistsApi
...
var apiInstance = new knetikcloud-sdk.MediaArtistsApi();

var opts = { 
  'artistResource': new knetikcloud-sdk.ArtistResource() // ArtistResource | The new artist
};
...
var opts = { 
  'artistTemplateResource': new knetikcloud-sdk.TemplateResource() // TemplateResource | The artist template resource object
};
