# knetikcloud-sdk.StoreShippingApi
...
var apiInstance = new knetikcloud-sdk.StoreShippingApi();
...
var opts = { 
  ...
  'shippingItem': new knetikcloud-sdk.ShippingItem() // ShippingItem | The shipping item object
};
...
var opts = { 
  'shippingTemplateResource': new knetikcloud-sdk.ItemTemplateResource() // ItemTemplateResource | The new shipping template
};
...
var opts = { 
  'shippingTemplateResource': new knetikcloud-sdk.ItemTemplateResource() // ItemTemplateResource | The shipping template resource object
};
