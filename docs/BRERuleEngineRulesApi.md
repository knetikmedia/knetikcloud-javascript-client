...
> &#39;String&#39; convertExpressionToStringUsingPOST(opts)
...
apiInstance.convertExpressionToStringUsingPOST(opts, callback);
```
...
# **createRuleUsingPOST**
> BreRule createRuleUsingPOST(opts)
...
apiInstance.createRuleUsingPOST(opts, callback);
```
...
apiInstance.deleteRuleUsingDELETE(id, callback);
```
...
apiInstance.enableRuleUsingPUT(id, opts, callback);
```
...
apiInstance.getRuleUsingGET(id, callback);
```
...
# **getRulesUsingGET**
> PageResourceBreRule getRulesUsingGET(opts)
...
apiInstance.getRulesUsingGET(opts, callback);
```
...
apiInstance.updateRuleUsingPUT(id, opts, callback);
```
