# knetikcloud-sdk.PaymentsGoogleApi
...
var apiInstance = new knetikcloud-sdk.PaymentsGoogleApi();

var opts = { 
  'request': new knetikcloud-sdk.GooglePaymentRequest() // GooglePaymentRequest | The request for paying an invoice through a Google in-app payment
};
