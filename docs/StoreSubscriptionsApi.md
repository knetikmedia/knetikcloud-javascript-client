# KnetikcloudSdk.StoreSubscriptionsApi
...
var apiInstance = new KnetikcloudSdk.StoreSubscriptionsApi();

var opts = { 
  'subscriptionResource': new KnetikcloudSdk.SubscriptionResource() // SubscriptionResource | The subscription to be created
};
...
var opts = { 
  'subscriptionTemplateResource': new KnetikcloudSdk.SubscriptionTemplateResource() // SubscriptionTemplateResource | The new subscription template
};
...
var opts = { 
  'subscriptionResource': new KnetikcloudSdk.SubscriptionResource() // SubscriptionResource | The subscription resource object
};
...
var opts = { 
  'subscriptionTemplateResource': new KnetikcloudSdk.SubscriptionTemplateResource() // SubscriptionTemplateResource | The subscription template resource object
};
