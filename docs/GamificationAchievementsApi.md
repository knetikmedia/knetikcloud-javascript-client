...
> PageUserAchievementGroupResource getAllUserProgressForAchievementUsingGET(achievementName, opts)
...
> PageUserAchievementGroupResource getAllUserProgressUsingGET(opts)
...
> PageUserAchievementGroupResource getUserProgressUsingGET(userId, opts)
