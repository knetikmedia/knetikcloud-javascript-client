# knetikcloud-sdk.GamificationAchievementsApi
...
var apiInstance = new knetikcloud-sdk.GamificationAchievementsApi();

var opts = { 
  'achievement': new knetikcloud-sdk.AchievementDefinitionResource() // AchievementDefinitionResource | The achievement definition
};
...
var opts = { 
  'template': new knetikcloud-sdk.TemplateResource() // TemplateResource | The achievement template to be created
};
...
var opts = { 
  'template': new knetikcloud-sdk.TemplateResource() // TemplateResource | The updated template
};
