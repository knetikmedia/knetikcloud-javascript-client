# knetikcloud-sdk.BRERuleEngineGlobalsApi
...
var apiInstance = new knetikcloud-sdk.BRERuleEngineGlobalsApi();

var opts = { 
  'breGlobalResource': new knetikcloud-sdk.BreGlobalResource() // BreGlobalResource | The BRE global resource object
};
