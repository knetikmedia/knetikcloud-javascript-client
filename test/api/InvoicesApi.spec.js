...
(function(root, factory) {
  ...
  describe('InvoicesApi', function() {
    ...
    describe('listFulFillmentStatuses', function() {
      it('should call listFulFillmentStatuses successfully', function(done) {
        //uncomment below and update the code to test listFulFillmentStatuses
        //instance.listFulFillmentStatuses(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listPaymentStatuses', function() {
      it('should call listPaymentStatuses successfully', function(done) {
        //uncomment below and update the code to test listPaymentStatuses
        //instance.listPaymentStatuses(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
