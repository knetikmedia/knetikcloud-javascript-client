...
(function(root, factory) {
  ...
  describe('GamificationTriviaApi', function() {
    ...
    describe('getQuestionTags1', function() {
      it('should call getQuestionTags1 successfully', function(done) {
        //uncomment below and update the code to test getQuestionTags1
        //instance.getQuestionTags1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
