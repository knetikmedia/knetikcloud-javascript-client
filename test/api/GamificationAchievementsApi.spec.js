...
(function(root, factory) {
  ...
  describe('GamificationAchievementsApi', function() {
    ...
    describe('updateAchievementProgress', function() {
      it('should call updateAchievementProgress successfully', function(done) {
        //uncomment below and update the code to test updateAchievementProgress
        //instance.updateAchievementProgress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
