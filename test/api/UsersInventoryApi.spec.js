...
(function(root, factory) {
  ...
  describe('UsersInventoryApi', function() {
    ...
    describe('getUserInventory1', function() {
      it('should call getUserInventory1 successfully', function(done) {
        //uncomment below and update the code to test getUserInventory1
        //instance.getUserInventory1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUserInventoryLog1', function() {
      it('should call getUserInventoryLog1 successfully', function(done) {
        //uncomment below and update the code to test getUserInventoryLog1
        //instance.getUserInventoryLog1(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
