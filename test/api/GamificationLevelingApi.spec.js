...
(function(root, factory) {
  ...
  describe('GamificationLevelingApi', function() {
    ...
    describe('updateUserLevel', function() {
      it('should call updateUserLevel successfully', function(done) {
        //uncomment below and update the code to test updateUserLevel
        //instance.updateUserLevel(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
