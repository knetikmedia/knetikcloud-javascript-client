...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.AmazonS3Activity();
  });
  ...
  describe('AmazonS3Activity', function() {
    it('should create an instance of AmazonS3Activity', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.AmazonS3Activity();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.AmazonS3Activity);
    });
