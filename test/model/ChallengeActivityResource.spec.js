...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ChallengeActivityResource();
  });
  ...
  describe('ChallengeActivityResource', function() {
    it('should create an instance of ChallengeActivityResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ChallengeActivityResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ChallengeActivityResource);
    });
