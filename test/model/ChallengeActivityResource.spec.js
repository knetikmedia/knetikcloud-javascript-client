...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.ChallengeActivityResource();
  });
  ...
  describe('ChallengeActivityResource', function() {
    it('should create an instance of ChallengeActivityResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.ChallengeActivityResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.ChallengeActivityResource);
    });
