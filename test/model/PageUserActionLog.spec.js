...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUserActionLog();
  });
  ...
  describe('PageUserActionLog', function() {
    it('should create an instance of PageUserActionLog', function() {
      // uncomment below and update the code to test PageUserActionLog
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUserActionLog();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUserActionLog);
    });
