...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageCommentResource();
  });
  ...
  describe('PageCommentResource', function() {
    it('should create an instance of PageCommentResource', function() {
      // uncomment below and update the code to test PageCommentResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageCommentResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageCommentResource);
    });
