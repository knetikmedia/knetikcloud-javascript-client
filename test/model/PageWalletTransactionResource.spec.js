...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageWalletTransactionResource();
  });
  ...
  describe('PageWalletTransactionResource', function() {
    it('should create an instance of PageWalletTransactionResource', function() {
      // uncomment below and update the code to test PageWalletTransactionResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageWalletTransactionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageWalletTransactionResource);
    });
