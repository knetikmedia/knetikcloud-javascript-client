...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.TemplateEmailResource();
  });
  ...
  describe('TemplateEmailResource', function() {
    it('should create an instance of TemplateEmailResource', function() {
      ...
      //var instane = new KnetikcloudSdk.TemplateEmailResource();
      //expect(instance).to.be.a(KnetikcloudSdk.TemplateEmailResource);
    });
