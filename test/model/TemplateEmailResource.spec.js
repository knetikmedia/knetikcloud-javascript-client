...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.TemplateEmailResource();
  });
  ...
  describe('TemplateEmailResource', function() {
    it('should create an instance of TemplateEmailResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.TemplateEmailResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.TemplateEmailResource);
    });
