...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.PageResourceVideoRelationshipResource();
  });
  ...
  describe('PageResourceVideoRelationshipResource', function() {
    it('should create an instance of PageResourceVideoRelationshipResource', function() {
      ...
      //var instane = new KnetikcloudSdk.PageResourceVideoRelationshipResource();
      //expect(instance).to.be.a(KnetikcloudSdk.PageResourceVideoRelationshipResource);
    });
