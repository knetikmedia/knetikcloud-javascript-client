...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceVideoRelationshipResource();
  });
  ...
  describe('PageResourceVideoRelationshipResource', function() {
    it('should create an instance of PageResourceVideoRelationshipResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceVideoRelationshipResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceVideoRelationshipResource);
    });
