...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceVideoRelationshipResource();
  });
  ...
  describe('PageResourceVideoRelationshipResource', function() {
    it('should create an instance of PageResourceVideoRelationshipResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceVideoRelationshipResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceVideoRelationshipResource);
    });
