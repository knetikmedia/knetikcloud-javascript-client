...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.Artist();
  });
  ...
  describe('Artist', function() {
    it('should create an instance of Artist', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.Artist();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.Artist);
    });
