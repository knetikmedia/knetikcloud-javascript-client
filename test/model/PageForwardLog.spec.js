...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageForwardLog();
  });
  ...
  describe('PageForwardLog', function() {
    it('should create an instance of PageForwardLog', function() {
      // uncomment below and update the code to test PageForwardLog
      //var instane = new KnetikPlatformApiDocumentationLatest.PageForwardLog();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageForwardLog);
    });
