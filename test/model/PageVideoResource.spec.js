...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageVideoResource();
  });
  ...
  describe('PageVideoResource', function() {
    it('should create an instance of PageVideoResource', function() {
      // uncomment below and update the code to test PageVideoResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageVideoResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageVideoResource);
    });
