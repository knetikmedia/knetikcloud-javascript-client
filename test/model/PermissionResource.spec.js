...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PermissionResource();
  });
  ...
  describe('PermissionResource', function() {
    it('should create an instance of PermissionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PermissionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PermissionResource);
    });
