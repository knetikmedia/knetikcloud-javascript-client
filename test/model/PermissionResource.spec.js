...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PermissionResource();
  });
  ...
  describe('PermissionResource', function() {
    it('should create an instance of PermissionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PermissionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PermissionResource);
    });
