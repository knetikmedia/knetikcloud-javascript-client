...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageBareChallengeActivityResource();
  });
  ...
  describe('PageBareChallengeActivityResource', function() {
    it('should create an instance of PageBareChallengeActivityResource', function() {
      // uncomment below and update the code to test PageBareChallengeActivityResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageBareChallengeActivityResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageBareChallengeActivityResource);
    });
