...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.IOConfig();
  });
  ...
  describe('IOConfig', function() {
    it('should create an instance of IOConfig', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.IOConfig();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.IOConfig);
    });
