...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageSubscriptionResource();
  });
  ...
  describe('PageSubscriptionResource', function() {
    it('should create an instance of PageSubscriptionResource', function() {
      // uncomment below and update the code to test PageSubscriptionResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageSubscriptionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageSubscriptionResource);
    });
