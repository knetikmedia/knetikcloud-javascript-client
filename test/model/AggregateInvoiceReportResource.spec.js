...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.AggregateInvoiceReportResource();
  });
  ...
  describe('AggregateInvoiceReportResource', function() {
    it('should create an instance of AggregateInvoiceReportResource', function() {
      ...
      //var instane = new knetikcloud-sdk.AggregateInvoiceReportResource();
      //expect(instance).to.be.a(knetikcloud-sdk.AggregateInvoiceReportResource);
    });
