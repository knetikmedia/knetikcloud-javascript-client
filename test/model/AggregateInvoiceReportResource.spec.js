...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.AggregateInvoiceReportResource();
  });
  ...
  describe('AggregateInvoiceReportResource', function() {
    it('should create an instance of AggregateInvoiceReportResource', function() {
      ...
      //var instane = new KnetikcloudSdk.AggregateInvoiceReportResource();
      //expect(instance).to.be.a(KnetikcloudSdk.AggregateInvoiceReportResource);
    });
