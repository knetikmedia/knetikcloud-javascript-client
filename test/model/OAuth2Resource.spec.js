...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.OAuth2Resource();
  });
  ...
  describe('OAuth2Resource', function() {
    it('should create an instance of OAuth2Resource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.OAuth2Resource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.OAuth2Resource);
    });
