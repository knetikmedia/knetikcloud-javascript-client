...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageAggregateInvoiceReportResource();
  });
  ...
  describe('PageAggregateInvoiceReportResource', function() {
    it('should create an instance of PageAggregateInvoiceReportResource', function() {
      // uncomment below and update the code to test PageAggregateInvoiceReportResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageAggregateInvoiceReportResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageAggregateInvoiceReportResource);
    });
