...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.FileGroupPropertyDefinitionResource();
  });
  ...
  describe('FileGroupPropertyDefinitionResource', function() {
    it('should create an instance of FileGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.FileGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.FileGroupPropertyDefinitionResource);
    });
