...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.FileGroupPropertyDefinitionResource();
  });
  ...
  describe('FileGroupPropertyDefinitionResource', function() {
    it('should create an instance of FileGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.FileGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.FileGroupPropertyDefinitionResource);
    });
