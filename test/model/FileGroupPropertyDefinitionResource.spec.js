...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.FileGroupPropertyDefinitionResource();
  });
  ...
  describe('FileGroupPropertyDefinitionResource', function() {
    it('should create an instance of FileGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikcloudSdk.FileGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikcloudSdk.FileGroupPropertyDefinitionResource);
    });
