...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.PaymentMethodResource();
  });
  ...
  describe('PaymentMethodResource', function() {
    it('should create an instance of PaymentMethodResource', function() {
      ...
      //var instane = new KnetikcloudSdk.PaymentMethodResource();
      //expect(instance).to.be.a(KnetikcloudSdk.PaymentMethodResource);
    });
