...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PaymentMethodResource();
  });
  ...
  describe('PaymentMethodResource', function() {
    it('should create an instance of PaymentMethodResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PaymentMethodResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PaymentMethodResource);
    });
