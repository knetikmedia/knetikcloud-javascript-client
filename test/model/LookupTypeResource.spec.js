...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.LookupTypeResource();
  });
  ...
  describe('LookupTypeResource', function() {
    it('should create an instance of LookupTypeResource', function() {
      ...
      //var instane = new knetikcloud-sdk.LookupTypeResource();
      //expect(instance).to.be.a(knetikcloud-sdk.LookupTypeResource);
    });
