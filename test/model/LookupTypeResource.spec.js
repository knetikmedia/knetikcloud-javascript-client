...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.LookupTypeResource();
  });
  ...
  describe('LookupTypeResource', function() {
    it('should create an instance of LookupTypeResource', function() {
      ...
      //var instane = new KnetikcloudSdk.LookupTypeResource();
      //expect(instance).to.be.a(KnetikcloudSdk.LookupTypeResource);
    });
