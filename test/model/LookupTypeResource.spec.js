...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.LookupTypeResource();
  });
  ...
  describe('LookupTypeResource', function() {
    it('should create an instance of LookupTypeResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.LookupTypeResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.LookupTypeResource);
    });
