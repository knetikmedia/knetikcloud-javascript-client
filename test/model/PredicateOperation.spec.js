...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.PredicateOperation();
  });
  ...
  describe('PredicateOperation', function() {
    it('should create an instance of PredicateOperation', function() {
      ...
      //var instane = new KnetikcloudSdk.PredicateOperation();
      //expect(instance).to.be.a(KnetikcloudSdk.PredicateOperation);
    });
