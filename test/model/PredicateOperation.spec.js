...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PredicateOperation();
  });
  ...
  describe('PredicateOperation', function() {
    it('should create an instance of PredicateOperation', function() {
      ...
      //var instane = new knetikcloud-sdk.PredicateOperation();
      //expect(instance).to.be.a(knetikcloud-sdk.PredicateOperation);
    });
