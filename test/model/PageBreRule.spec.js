...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageBreRule();
  });
  ...
  describe('PageBreRule', function() {
    it('should create an instance of PageBreRule', function() {
      // uncomment below and update the code to test PageBreRule
      //var instane = new KnetikPlatformApiDocumentationLatest.PageBreRule();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageBreRule);
    });
