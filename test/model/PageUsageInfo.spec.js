...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUsageInfo();
  });
  ...
  describe('PageUsageInfo', function() {
    it('should create an instance of PageUsageInfo', function() {
      // uncomment below and update the code to test PageUsageInfo
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUsageInfo();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUsageInfo);
    });
