...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageCategoryResource();
  });
  ...
  describe('PageCategoryResource', function() {
    it('should create an instance of PageCategoryResource', function() {
      // uncomment below and update the code to test PageCategoryResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageCategoryResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageCategoryResource);
    });
