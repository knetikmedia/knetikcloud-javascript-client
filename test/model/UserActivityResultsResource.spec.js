...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.UserActivityResultsResource();
  });
  ...
  describe('UserActivityResultsResource', function() {
    it('should create an instance of UserActivityResultsResource', function() {
      ...
      //var instane = new knetikcloud-sdk.UserActivityResultsResource();
      //expect(instance).to.be.a(knetikcloud-sdk.UserActivityResultsResource);
    });
