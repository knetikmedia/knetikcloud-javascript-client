...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.UserActivityResultsResource();
  });
  ...
  describe('UserActivityResultsResource', function() {
    it('should create an instance of UserActivityResultsResource', function() {
      ...
      //var instane = new KnetikcloudSdk.UserActivityResultsResource();
      //expect(instance).to.be.a(KnetikcloudSdk.UserActivityResultsResource);
    });
