...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceClientResource();
  });
  ...
  describe('PageResourceClientResource', function() {
    it('should create an instance of PageResourceClientResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceClientResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceClientResource);
    });
