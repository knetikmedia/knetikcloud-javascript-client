...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceBillingReport();
  });
  ...
  describe('PageResourceBillingReport', function() {
    it('should create an instance of PageResourceBillingReport', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceBillingReport();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceBillingReport);
    });
