...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceMapstringobject();
  });
  ...
  describe('PageResourceMapstringobject', function() {
    it('should create an instance of PageResourceMapstringobject', function() {
      // uncomment below and update the code to test PageResourceMapstringobject
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceMapstringobject();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceMapstringobject);
    });
