...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.Expirable();
  });
  ...
  describe('Expirable', function() {
    it('should create an instance of Expirable', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.Expirable();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.Expirable);
    });
