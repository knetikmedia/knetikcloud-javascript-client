...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.SubscriptionResource();
  });
  ...
  describe('SubscriptionResource', function() {
    it('should create an instance of SubscriptionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.SubscriptionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.SubscriptionResource);
    });
