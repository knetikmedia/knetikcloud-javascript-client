...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.SubscriptionResource();
  });
  ...
  describe('SubscriptionResource', function() {
    it('should create an instance of SubscriptionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.SubscriptionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.SubscriptionResource);
    });
