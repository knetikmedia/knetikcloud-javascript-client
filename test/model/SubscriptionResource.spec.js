...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.SubscriptionResource();
  });
  ...
  describe('SubscriptionResource', function() {
    it('should create an instance of SubscriptionResource', function() {
      ...
      //var instane = new KnetikcloudSdk.SubscriptionResource();
      //expect(instance).to.be.a(KnetikcloudSdk.SubscriptionResource);
    });
