...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceTransactionResource();
  });
  ...
  describe('PageResourceTransactionResource', function() {
    it('should create an instance of PageResourceTransactionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceTransactionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceTransactionResource);
    });
