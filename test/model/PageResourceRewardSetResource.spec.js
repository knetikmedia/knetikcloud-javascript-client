...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceRewardSetResource();
  });
  ...
  describe('PageResourceRewardSetResource', function() {
    it('should create an instance of PageResourceRewardSetResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceRewardSetResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceRewardSetResource);
    });
