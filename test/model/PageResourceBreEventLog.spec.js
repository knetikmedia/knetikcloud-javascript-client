...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceBreEventLog();
  });
  ...
  describe('PageResourceBreEventLog', function() {
    it('should create an instance of PageResourceBreEventLog', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceBreEventLog();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceBreEventLog);
    });
