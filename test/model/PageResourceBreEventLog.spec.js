...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceBreEventLog();
  });
  ...
  describe('PageResourceBreEventLog', function() {
    it('should create an instance of PageResourceBreEventLog', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceBreEventLog();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceBreEventLog);
    });
