...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.XsollaPaymentRequest();
  });
  ...
  describe('XsollaPaymentRequest', function() {
    it('should create an instance of XsollaPaymentRequest', function() {
      ...
      //var instane = new knetikcloud-sdk.XsollaPaymentRequest();
      //expect(instance).to.be.a(knetikcloud-sdk.XsollaPaymentRequest);
    });
