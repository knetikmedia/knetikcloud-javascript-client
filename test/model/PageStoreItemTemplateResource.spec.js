...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageStoreItemTemplateResource();
  });
  ...
  describe('PageStoreItemTemplateResource', function() {
    it('should create an instance of PageStoreItemTemplateResource', function() {
      // uncomment below and update the code to test PageStoreItemTemplateResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageStoreItemTemplateResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageStoreItemTemplateResource);
    });
