...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceVideoResource();
  });
  ...
  describe('PageResourceVideoResource', function() {
    it('should create an instance of PageResourceVideoResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceVideoResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceVideoResource);
    });
