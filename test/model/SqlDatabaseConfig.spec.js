...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.SqlDatabaseConfig();
  });
  ...
  describe('SqlDatabaseConfig', function() {
    it('should create an instance of SqlDatabaseConfig', function() {
      ...
      //var instane = new knetikcloud-sdk.SqlDatabaseConfig();
      //expect(instance).to.be.a(knetikcloud-sdk.SqlDatabaseConfig);
    });
