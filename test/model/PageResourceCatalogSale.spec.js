...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceCatalogSale();
  });
  ...
  describe('PageResourceCatalogSale', function() {
    it('should create an instance of PageResourceCatalogSale', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceCatalogSale();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceCatalogSale);
    });
