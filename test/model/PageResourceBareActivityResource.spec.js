...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceBareActivityResource();
  });
  ...
  describe('PageResourceBareActivityResource', function() {
    it('should create an instance of PageResourceBareActivityResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceBareActivityResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceBareActivityResource);
    });
