...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.SampleCountriesResponse();
  });
  ...
  describe('SampleCountriesResponse', function() {
    it('should create an instance of SampleCountriesResponse', function() {
      ...
      //var instane = new KnetikcloudSdk.SampleCountriesResponse();
      //expect(instance).to.be.a(KnetikcloudSdk.SampleCountriesResponse);
    });
