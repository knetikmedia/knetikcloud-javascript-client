...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.SampleCountriesResponse();
  });
  ...
  describe('SampleCountriesResponse', function() {
    it('should create an instance of SampleCountriesResponse', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.SampleCountriesResponse();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.SampleCountriesResponse);
    });
