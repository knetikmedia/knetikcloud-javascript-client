...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.SampleCountriesResponse();
  });
  ...
  describe('SampleCountriesResponse', function() {
    it('should create an instance of SampleCountriesResponse', function() {
      ...
      //var instane = new knetikcloud-sdk.SampleCountriesResponse();
      //expect(instance).to.be.a(knetikcloud-sdk.SampleCountriesResponse);
    });
