...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceUserLevelingResource();
  });
  ...
  describe('PageResourceUserLevelingResource', function() {
    it('should create an instance of PageResourceUserLevelingResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceUserLevelingResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceUserLevelingResource);
    });
