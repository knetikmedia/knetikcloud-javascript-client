...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.InvoiceResource();
  });
  ...
  describe('InvoiceResource', function() {
    it('should create an instance of InvoiceResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.InvoiceResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.InvoiceResource);
    });
