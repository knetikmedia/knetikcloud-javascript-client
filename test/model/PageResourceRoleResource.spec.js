...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceRoleResource();
  });
  ...
  describe('PageResourceRoleResource', function() {
    it('should create an instance of PageResourceRoleResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceRoleResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceRoleResource);
    });
