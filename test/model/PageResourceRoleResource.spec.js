...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceRoleResource();
  });
  ...
  describe('PageResourceRoleResource', function() {
    it('should create an instance of PageResourceRoleResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceRoleResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceRoleResource);
    });
