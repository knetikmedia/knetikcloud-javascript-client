...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageSubscriptionTemplateResource();
  });
  ...
  describe('PageSubscriptionTemplateResource', function() {
    it('should create an instance of PageSubscriptionTemplateResource', function() {
      // uncomment below and update the code to test PageSubscriptionTemplateResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageSubscriptionTemplateResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageSubscriptionTemplateResource);
    });
