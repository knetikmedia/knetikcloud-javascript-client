...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.CustomerResource();
  });
  ...
  describe('CustomerResource', function() {
    it('should create an instance of CustomerResource', function() {
      // uncomment below and update the code to test CustomerResource
      //var instane = new KnetikPlatformApiDocumentationLatest.CustomerResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.CustomerResource);
    });
