...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.LeaderboardResource();
  });
  ...
  describe('LeaderboardResource', function() {
    it('should create an instance of LeaderboardResource', function() {
      ...
      //var instane = new KnetikcloudSdk.LeaderboardResource();
      //expect(instance).to.be.a(KnetikcloudSdk.LeaderboardResource);
    });
