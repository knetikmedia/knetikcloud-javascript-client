...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.LeaderboardResource();
  });
  ...
  describe('LeaderboardResource', function() {
    it('should create an instance of LeaderboardResource', function() {
      ...
      //var instane = new knetikcloud-sdk.LeaderboardResource();
      //expect(instance).to.be.a(knetikcloud-sdk.LeaderboardResource);
    });
