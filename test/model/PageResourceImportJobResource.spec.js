...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceImportJobResource();
  });
  ...
  describe('PageResourceImportJobResource', function() {
    it('should create an instance of PageResourceImportJobResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceImportJobResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceImportJobResource);
    });
