...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.PageResourceImportJobResource();
  });
  ...
  describe('PageResourceImportJobResource', function() {
    it('should create an instance of PageResourceImportJobResource', function() {
      ...
      //var instane = new KnetikcloudSdk.PageResourceImportJobResource();
      //expect(instance).to.be.a(KnetikcloudSdk.PageResourceImportJobResource);
    });
