...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceLocationLogResource();
  });
  ...
  describe('PageResourceLocationLogResource', function() {
    it('should create an instance of PageResourceLocationLogResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceLocationLogResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceLocationLogResource);
    });
