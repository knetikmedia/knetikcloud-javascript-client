...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceFulfillmentType();
  });
  ...
  describe('PageResourceFulfillmentType', function() {
    it('should create an instance of PageResourceFulfillmentType', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceFulfillmentType();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceFulfillmentType);
    });
