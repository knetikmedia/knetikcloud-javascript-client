...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceFulfillmentType();
  });
  ...
  describe('PageResourceFulfillmentType', function() {
    it('should create an instance of PageResourceFulfillmentType', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceFulfillmentType();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceFulfillmentType);
    });
