...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceEntitlementItem();
  });
  ...
  describe('PageResourceEntitlementItem', function() {
    it('should create an instance of PageResourceEntitlementItem', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceEntitlementItem();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceEntitlementItem);
    });
