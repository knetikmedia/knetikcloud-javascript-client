...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageCatalogSale();
  });
  ...
  describe('PageCatalogSale', function() {
    it('should create an instance of PageCatalogSale', function() {
      // uncomment below and update the code to test PageCatalogSale
      //var instane = new KnetikPlatformApiDocumentationLatest.PageCatalogSale();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageCatalogSale);
    });
