...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUserInventoryResource();
  });
  ...
  describe('PageUserInventoryResource', function() {
    it('should create an instance of PageUserInventoryResource', function() {
      // uncomment below and update the code to test PageUserInventoryResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUserInventoryResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUserInventoryResource);
    });
