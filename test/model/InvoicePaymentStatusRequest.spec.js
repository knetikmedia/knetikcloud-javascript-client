...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.InvoicePaymentStatusRequest();
  });
  ...
  describe('InvoicePaymentStatusRequest', function() {
    it('should create an instance of InvoicePaymentStatusRequest', function() {
      ...
      //var instane = new KnetikcloudSdk.InvoicePaymentStatusRequest();
      //expect(instance).to.be.a(KnetikcloudSdk.InvoicePaymentStatusRequest);
    });
