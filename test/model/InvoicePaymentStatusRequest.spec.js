...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.InvoicePaymentStatusRequest();
  });
  ...
  describe('InvoicePaymentStatusRequest', function() {
    it('should create an instance of InvoicePaymentStatusRequest', function() {
      ...
      //var instane = new knetikcloud-sdk.InvoicePaymentStatusRequest();
      //expect(instance).to.be.a(knetikcloud-sdk.InvoicePaymentStatusRequest);
    });
