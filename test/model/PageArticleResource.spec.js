...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageArticleResource();
  });
  ...
  describe('PageArticleResource', function() {
    it('should create an instance of PageArticleResource', function() {
      // uncomment below and update the code to test PageArticleResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageArticleResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageArticleResource);
    });
