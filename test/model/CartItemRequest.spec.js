...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.CartItemRequest();
  });
  ...
  describe('CartItemRequest', function() {
    it('should create an instance of CartItemRequest', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.CartItemRequest();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.CartItemRequest);
    });
