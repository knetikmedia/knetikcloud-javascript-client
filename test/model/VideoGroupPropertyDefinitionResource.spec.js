...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.VideoGroupPropertyDefinitionResource();
  });
  ...
  describe('VideoGroupPropertyDefinitionResource', function() {
    it('should create an instance of VideoGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikcloudSdk.VideoGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikcloudSdk.VideoGroupPropertyDefinitionResource);
    });
