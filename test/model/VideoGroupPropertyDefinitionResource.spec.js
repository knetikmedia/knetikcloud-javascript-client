...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.VideoGroupPropertyDefinitionResource();
  });
  ...
  describe('VideoGroupPropertyDefinitionResource', function() {
    it('should create an instance of VideoGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.VideoGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.VideoGroupPropertyDefinitionResource);
    });
