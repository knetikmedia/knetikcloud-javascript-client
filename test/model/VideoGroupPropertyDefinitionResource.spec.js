...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.VideoGroupPropertyDefinitionResource();
  });
  ...
  describe('VideoGroupPropertyDefinitionResource', function() {
    it('should create an instance of VideoGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.VideoGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.VideoGroupPropertyDefinitionResource);
    });
