...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ImportJobOutputResource();
  });
  ...
  describe('ImportJobOutputResource', function() {
    it('should create an instance of ImportJobOutputResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ImportJobOutputResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ImportJobOutputResource);
    });
