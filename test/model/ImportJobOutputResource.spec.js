...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.ImportJobOutputResource();
  });
  ...
  describe('ImportJobOutputResource', function() {
    it('should create an instance of ImportJobOutputResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.ImportJobOutputResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.ImportJobOutputResource);
    });
