...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ImportJobOutputResource();
  });
  ...
  describe('ImportJobOutputResource', function() {
    it('should create an instance of ImportJobOutputResource', function() {
      ...
      //var instane = new KnetikcloudSdk.ImportJobOutputResource();
      //expect(instance).to.be.a(KnetikcloudSdk.ImportJobOutputResource);
    });
