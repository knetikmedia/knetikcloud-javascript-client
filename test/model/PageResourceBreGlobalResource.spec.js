...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceBreGlobalResource();
  });
  ...
  describe('PageResourceBreGlobalResource', function() {
    it('should create an instance of PageResourceBreGlobalResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceBreGlobalResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceBreGlobalResource);
    });
