...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.GroupMemberResource();
  });
  ...
  describe('GroupMemberResource', function() {
    it('should create an instance of GroupMemberResource', function() {
      ...
      //var instane = new knetikcloud-sdk.GroupMemberResource();
      //expect(instance).to.be.a(knetikcloud-sdk.GroupMemberResource);
    });
