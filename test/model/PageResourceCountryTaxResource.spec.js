...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceCountryTaxResource();
  });
  ...
  describe('PageResourceCountryTaxResource', function() {
    it('should create an instance of PageResourceCountryTaxResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceCountryTaxResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceCountryTaxResource);
    });
