...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceSubscriptionResource();
  });
  ...
  describe('PageResourceSubscriptionResource', function() {
    it('should create an instance of PageResourceSubscriptionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceSubscriptionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceSubscriptionResource);
    });
