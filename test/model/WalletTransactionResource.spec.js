...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.WalletTransactionResource();
  });
  ...
  describe('WalletTransactionResource', function() {
    it('should create an instance of WalletTransactionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.WalletTransactionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.WalletTransactionResource);
    });
