...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.BreRule();
  });
  ...
  describe('BreRule', function() {
    it('should create an instance of BreRule', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.BreRule();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.BreRule);
    });
