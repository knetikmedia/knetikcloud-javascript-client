...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageOauthAccessTokenResource();
  });
  ...
  describe('PageOauthAccessTokenResource', function() {
    it('should create an instance of PageOauthAccessTokenResource', function() {
      // uncomment below and update the code to test PageOauthAccessTokenResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageOauthAccessTokenResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageOauthAccessTokenResource);
    });
