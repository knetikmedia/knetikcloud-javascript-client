...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.UserRelationshipResource();
  });
  ...
  describe('UserRelationshipResource', function() {
    it('should create an instance of UserRelationshipResource', function() {
      ...
      //var instane = new knetikcloud-sdk.UserRelationshipResource();
      //expect(instance).to.be.a(knetikcloud-sdk.UserRelationshipResource);
    });
