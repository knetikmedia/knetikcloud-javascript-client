...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceConfig();
  });
  ...
  describe('PageResourceConfig', function() {
    it('should create an instance of PageResourceConfig', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceConfig();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceConfig);
    });
