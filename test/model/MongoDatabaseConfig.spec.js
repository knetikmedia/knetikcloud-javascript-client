...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.MongoDatabaseConfig();
  });
  ...
  describe('MongoDatabaseConfig', function() {
    it('should create an instance of MongoDatabaseConfig', function() {
      ...
      //var instane = new KnetikcloudSdk.MongoDatabaseConfig();
      //expect(instance).to.be.a(KnetikcloudSdk.MongoDatabaseConfig);
    });
