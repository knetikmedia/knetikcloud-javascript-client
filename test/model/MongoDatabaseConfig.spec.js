...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.MongoDatabaseConfig();
  });
  ...
  describe('MongoDatabaseConfig', function() {
    it('should create an instance of MongoDatabaseConfig', function() {
      ...
      //var instane = new knetikcloud-sdk.MongoDatabaseConfig();
      //expect(instance).to.be.a(knetikcloud-sdk.MongoDatabaseConfig);
    });
