...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceBreCategoryResource();
  });
  ...
  describe('PageResourceBreCategoryResource', function() {
    it('should create an instance of PageResourceBreCategoryResource', function() {
      // uncomment below and update the code to test PageResourceBreCategoryResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceBreCategoryResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceBreCategoryResource);
    });
