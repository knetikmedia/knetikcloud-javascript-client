...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageInvoiceLogEntry();
  });
  ...
  describe('PageInvoiceLogEntry', function() {
    it('should create an instance of PageInvoiceLogEntry', function() {
      // uncomment below and update the code to test PageInvoiceLogEntry
      //var instane = new KnetikPlatformApiDocumentationLatest.PageInvoiceLogEntry();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageInvoiceLogEntry);
    });
