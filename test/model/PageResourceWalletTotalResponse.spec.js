...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceWalletTotalResponse();
  });
  ...
  describe('PageResourceWalletTotalResponse', function() {
    it('should create an instance of PageResourceWalletTotalResponse', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceWalletTotalResponse();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceWalletTotalResponse);
    });
