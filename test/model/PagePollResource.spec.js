...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PagePollResource();
  });
  ...
  describe('PagePollResource', function() {
    it('should create an instance of PagePollResource', function() {
      // uncomment below and update the code to test PagePollResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PagePollResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PagePollResource);
    });
