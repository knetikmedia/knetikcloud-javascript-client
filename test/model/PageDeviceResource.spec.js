...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageDeviceResource();
  });
  ...
  describe('PageDeviceResource', function() {
    it('should create an instance of PageDeviceResource', function() {
      // uncomment below and update the code to test PageDeviceResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageDeviceResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageDeviceResource);
    });
