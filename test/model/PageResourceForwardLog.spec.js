...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceForwardLog();
  });
  ...
  describe('PageResourceForwardLog', function() {
    it('should create an instance of PageResourceForwardLog', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceForwardLog();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceForwardLog);
    });
