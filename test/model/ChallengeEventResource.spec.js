...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ChallengeEventResource();
  });
  ...
  describe('ChallengeEventResource', function() {
    it('should create an instance of ChallengeEventResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ChallengeEventResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ChallengeEventResource);
    });
