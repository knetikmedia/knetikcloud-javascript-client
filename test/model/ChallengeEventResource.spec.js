...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ChallengeEventResource();
  });
  ...
  describe('ChallengeEventResource', function() {
    it('should create an instance of ChallengeEventResource', function() {
      ...
      //var instane = new KnetikcloudSdk.ChallengeEventResource();
      //expect(instance).to.be.a(KnetikcloudSdk.ChallengeEventResource);
    });
