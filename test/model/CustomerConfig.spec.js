...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.CustomerConfig();
  });
  ...
  describe('CustomerConfig', function() {
    it('should create an instance of CustomerConfig', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.CustomerConfig();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.CustomerConfig);
    });
