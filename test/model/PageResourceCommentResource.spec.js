...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceCommentResource();
  });
  ...
  describe('PageResourceCommentResource', function() {
    it('should create an instance of PageResourceCommentResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceCommentResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceCommentResource);
    });
