...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceItemTemplateResource();
  });
  ...
  describe('PageResourceItemTemplateResource', function() {
    it('should create an instance of PageResourceItemTemplateResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceItemTemplateResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceItemTemplateResource);
    });
