...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageTransactionResource();
  });
  ...
  describe('PageTransactionResource', function() {
    it('should create an instance of PageTransactionResource', function() {
      // uncomment below and update the code to test PageTransactionResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageTransactionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageTransactionResource);
    });
