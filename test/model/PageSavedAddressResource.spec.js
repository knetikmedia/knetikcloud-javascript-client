...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageSavedAddressResource();
  });
  ...
  describe('PageSavedAddressResource', function() {
    it('should create an instance of PageSavedAddressResource', function() {
      // uncomment below and update the code to test PageSavedAddressResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageSavedAddressResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageSavedAddressResource);
    });
