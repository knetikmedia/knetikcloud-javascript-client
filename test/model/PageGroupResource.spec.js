...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageGroupResource();
  });
  ...
  describe('PageGroupResource', function() {
    it('should create an instance of PageGroupResource', function() {
      // uncomment below and update the code to test PageGroupResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageGroupResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageGroupResource);
    });
