...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceLevelingResource();
  });
  ...
  describe('PageResourceLevelingResource', function() {
    it('should create an instance of PageResourceLevelingResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceLevelingResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceLevelingResource);
    });
