...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.GlobalResource();
  });
  ...
  describe('GlobalResource', function() {
    it('should create an instance of GlobalResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.GlobalResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.GlobalResource);
    });
