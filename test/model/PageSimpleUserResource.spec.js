...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageSimpleUserResource();
  });
  ...
  describe('PageSimpleUserResource', function() {
    it('should create an instance of PageSimpleUserResource', function() {
      // uncomment below and update the code to test PageSimpleUserResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageSimpleUserResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageSimpleUserResource);
    });
