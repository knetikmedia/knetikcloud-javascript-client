...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageRewardSetResource();
  });
  ...
  describe('PageRewardSetResource', function() {
    it('should create an instance of PageRewardSetResource', function() {
      // uncomment below and update the code to test PageRewardSetResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageRewardSetResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageRewardSetResource);
    });
