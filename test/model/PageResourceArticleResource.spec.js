...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceArticleResource();
  });
  ...
  describe('PageResourceArticleResource', function() {
    it('should create an instance of PageResourceArticleResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceArticleResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceArticleResource);
    });
