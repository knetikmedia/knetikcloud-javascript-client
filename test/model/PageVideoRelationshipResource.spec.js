...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageVideoRelationshipResource();
  });
  ...
  describe('PageVideoRelationshipResource', function() {
    it('should create an instance of PageVideoRelationshipResource', function() {
      // uncomment below and update the code to test PageVideoRelationshipResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageVideoRelationshipResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageVideoRelationshipResource);
    });
