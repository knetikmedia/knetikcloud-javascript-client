...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageConfig();
  });
  ...
  describe('PageConfig', function() {
    it('should create an instance of PageConfig', function() {
      // uncomment below and update the code to test PageConfig
      //var instane = new KnetikPlatformApiDocumentationLatest.PageConfig();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageConfig);
    });
