...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageEntitlementItem();
  });
  ...
  describe('PageEntitlementItem', function() {
    it('should create an instance of PageEntitlementItem', function() {
      // uncomment below and update the code to test PageEntitlementItem
      //var instane = new KnetikPlatformApiDocumentationLatest.PageEntitlementItem();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageEntitlementItem);
    });
