...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.AddressResource();
  });
  ...
  describe('AddressResource', function() {
    it('should create an instance of AddressResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.AddressResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.AddressResource);
    });
