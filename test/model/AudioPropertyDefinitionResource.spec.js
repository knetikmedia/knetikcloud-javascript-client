...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.AudioPropertyDefinitionResource();
  });
  ...
  describe('AudioPropertyDefinitionResource', function() {
    it('should create an instance of AudioPropertyDefinitionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.AudioPropertyDefinitionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.AudioPropertyDefinitionResource);
    });
