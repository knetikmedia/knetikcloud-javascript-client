...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.AudioPropertyDefinitionResource();
  });
  ...
  describe('AudioPropertyDefinitionResource', function() {
    it('should create an instance of AudioPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.AudioPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.AudioPropertyDefinitionResource);
    });
