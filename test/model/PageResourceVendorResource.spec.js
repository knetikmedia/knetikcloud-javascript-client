...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceVendorResource();
  });
  ...
  describe('PageResourceVendorResource', function() {
    it('should create an instance of PageResourceVendorResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceVendorResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceVendorResource);
    });
