...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageQuestionTemplateResource();
  });
  ...
  describe('PageQuestionTemplateResource', function() {
    it('should create an instance of PageQuestionTemplateResource', function() {
      // uncomment below and update the code to test PageQuestionTemplateResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageQuestionTemplateResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageQuestionTemplateResource);
    });
