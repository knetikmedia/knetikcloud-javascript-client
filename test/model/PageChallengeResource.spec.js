...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageChallengeResource();
  });
  ...
  describe('PageChallengeResource', function() {
    it('should create an instance of PageChallengeResource', function() {
      // uncomment below and update the code to test PageChallengeResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageChallengeResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageChallengeResource);
    });
