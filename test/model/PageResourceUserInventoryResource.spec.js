...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceUserInventoryResource();
  });
  ...
  describe('PageResourceUserInventoryResource', function() {
    it('should create an instance of PageResourceUserInventoryResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceUserInventoryResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceUserInventoryResource);
    });
