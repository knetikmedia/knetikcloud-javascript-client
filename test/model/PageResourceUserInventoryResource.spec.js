...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.PageResourceUserInventoryResource();
  });
  ...
  describe('PageResourceUserInventoryResource', function() {
    it('should create an instance of PageResourceUserInventoryResource', function() {
      ...
      //var instane = new KnetikcloudSdk.PageResourceUserInventoryResource();
      //expect(instance).to.be.a(KnetikcloudSdk.PageResourceUserInventoryResource);
    });
