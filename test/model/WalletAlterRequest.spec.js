...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.WalletAlterRequest();
  });
  ...
  describe('WalletAlterRequest', function() {
    it('should create an instance of WalletAlterRequest', function() {
      ...
      //var instane = new KnetikcloudSdk.WalletAlterRequest();
      //expect(instance).to.be.a(KnetikcloudSdk.WalletAlterRequest);
    });
