...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.WalletAlterRequest();
  });
  ...
  describe('WalletAlterRequest', function() {
    it('should create an instance of WalletAlterRequest', function() {
      ...
      //var instane = new knetikcloud-sdk.WalletAlterRequest();
      //expect(instance).to.be.a(knetikcloud-sdk.WalletAlterRequest);
    });
