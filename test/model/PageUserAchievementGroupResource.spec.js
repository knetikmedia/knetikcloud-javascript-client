...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUserAchievementGroupResource();
  });
  ...
  describe('PageUserAchievementGroupResource', function() {
    it('should create an instance of PageUserAchievementGroupResource', function() {
      // uncomment below and update the code to test PageUserAchievementGroupResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUserAchievementGroupResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUserAchievementGroupResource);
    });
