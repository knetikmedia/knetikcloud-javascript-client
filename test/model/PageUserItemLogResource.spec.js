...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUserItemLogResource();
  });
  ...
  describe('PageUserItemLogResource', function() {
    it('should create an instance of PageUserItemLogResource', function() {
      // uncomment below and update the code to test PageUserItemLogResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUserItemLogResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUserItemLogResource);
    });
