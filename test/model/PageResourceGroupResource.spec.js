...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceGroupResource();
  });
  ...
  describe('PageResourceGroupResource', function() {
    it('should create an instance of PageResourceGroupResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceGroupResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceGroupResource);
    });
