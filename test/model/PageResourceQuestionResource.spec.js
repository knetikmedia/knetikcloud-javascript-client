...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceQuestionResource();
  });
  ...
  describe('PageResourceQuestionResource', function() {
    it('should create an instance of PageResourceQuestionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceQuestionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceQuestionResource);
    });
