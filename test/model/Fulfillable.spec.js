...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.Fulfillable();
  });
  ...
  describe('Fulfillable', function() {
    it('should create an instance of Fulfillable', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.Fulfillable();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.Fulfillable);
    });
