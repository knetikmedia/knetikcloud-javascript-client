...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageAggregateCountResource();
  });
  ...
  describe('PageAggregateCountResource', function() {
    it('should create an instance of PageAggregateCountResource', function() {
      // uncomment below and update the code to test PageAggregateCountResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageAggregateCountResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageAggregateCountResource);
    });
