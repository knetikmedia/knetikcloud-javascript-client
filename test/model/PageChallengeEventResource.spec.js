...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageChallengeEventResource();
  });
  ...
  describe('PageChallengeEventResource', function() {
    it('should create an instance of PageChallengeEventResource', function() {
      // uncomment below and update the code to test PageChallengeEventResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageChallengeEventResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageChallengeEventResource);
    });
