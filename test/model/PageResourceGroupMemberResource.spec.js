...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceGroupMemberResource();
  });
  ...
  describe('PageResourceGroupMemberResource', function() {
    it('should create an instance of PageResourceGroupMemberResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceGroupMemberResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceGroupMemberResource);
    });
