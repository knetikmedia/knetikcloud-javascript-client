...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceTopicSubscriberResource();
  });
  ...
  describe('PageResourceTopicSubscriberResource', function() {
    it('should create an instance of PageResourceTopicSubscriberResource', function() {
      // uncomment below and update the code to test PageResourceTopicSubscriberResource
      //var instane = new KnetikCloud.PageResourceTopicSubscriberResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceTopicSubscriberResource);
    });
