...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.PageResourceSimpleReferenceResourceobject();
  });
  ...
  describe('PageResourceSimpleReferenceResourceobject', function() {
    it('should create an instance of PageResourceSimpleReferenceResourceobject', function() {
      ...
      //var instane = new KnetikcloudSdk.PageResourceSimpleReferenceResourceobject();
      //expect(instance).to.be.a(KnetikcloudSdk.PageResourceSimpleReferenceResourceobject);
    });
