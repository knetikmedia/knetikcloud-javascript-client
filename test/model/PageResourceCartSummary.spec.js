...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceCartSummary();
  });
  ...
  describe('PageResourceCartSummary', function() {
    it('should create an instance of PageResourceCartSummary', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceCartSummary();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceCartSummary);
    });
