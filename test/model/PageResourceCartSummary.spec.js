...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceCartSummary();
  });
  ...
  describe('PageResourceCartSummary', function() {
    it('should create an instance of PageResourceCartSummary', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceCartSummary();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceCartSummary);
    });
