...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageBillingReport();
  });
  ...
  describe('PageBillingReport', function() {
    it('should create an instance of PageBillingReport', function() {
      // uncomment below and update the code to test PageBillingReport
      //var instane = new KnetikPlatformApiDocumentationLatest.PageBillingReport();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageBillingReport);
    });
