...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageBareActivityResource();
  });
  ...
  describe('PageBareActivityResource', function() {
    it('should create an instance of PageBareActivityResource', function() {
      // uncomment below and update the code to test PageBareActivityResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageBareActivityResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageBareActivityResource);
    });
