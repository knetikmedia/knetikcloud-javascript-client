...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.OptimalPaymentRequest();
  });
  ...
  describe('OptimalPaymentRequest', function() {
    it('should create an instance of OptimalPaymentRequest', function() {
      ...
      //var instane = new KnetikcloudSdk.OptimalPaymentRequest();
      //expect(instance).to.be.a(KnetikcloudSdk.OptimalPaymentRequest);
    });
