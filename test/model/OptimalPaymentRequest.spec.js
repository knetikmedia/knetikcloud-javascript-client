...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.OptimalPaymentRequest();
  });
  ...
  describe('OptimalPaymentRequest', function() {
    it('should create an instance of OptimalPaymentRequest', function() {
      ...
      //var instane = new knetikcloud-sdk.OptimalPaymentRequest();
      //expect(instance).to.be.a(knetikcloud-sdk.OptimalPaymentRequest);
    });
