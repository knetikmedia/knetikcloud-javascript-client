...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageWalletTotalResponse();
  });
  ...
  describe('PageWalletTotalResponse', function() {
    it('should create an instance of PageWalletTotalResponse', function() {
      // uncomment below and update the code to test PageWalletTotalResponse
      //var instane = new KnetikPlatformApiDocumentationLatest.PageWalletTotalResponse();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageWalletTotalResponse);
    });
