...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.RevenueProductReportResource();
  });
  ...
  describe('RevenueProductReportResource', function() {
    it('should create an instance of RevenueProductReportResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.RevenueProductReportResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.RevenueProductReportResource);
    });
