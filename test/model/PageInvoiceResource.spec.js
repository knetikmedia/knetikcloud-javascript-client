...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageInvoiceResource();
  });
  ...
  describe('PageInvoiceResource', function() {
    it('should create an instance of PageInvoiceResource', function() {
      // uncomment below and update the code to test PageInvoiceResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageInvoiceResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageInvoiceResource);
    });
