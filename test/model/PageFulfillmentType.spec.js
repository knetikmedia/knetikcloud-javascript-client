...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageFulfillmentType();
  });
  ...
  describe('PageFulfillmentType', function() {
    it('should create an instance of PageFulfillmentType', function() {
      // uncomment below and update the code to test PageFulfillmentType
      //var instane = new KnetikPlatformApiDocumentationLatest.PageFulfillmentType();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageFulfillmentType);
    });
