...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.VariableTypeResource();
  });
  ...
  describe('VariableTypeResource', function() {
    it('should create an instance of VariableTypeResource', function() {
      ...
      //var instane = new KnetikcloudSdk.VariableTypeResource();
      //expect(instance).to.be.a(KnetikcloudSdk.VariableTypeResource);
    });
