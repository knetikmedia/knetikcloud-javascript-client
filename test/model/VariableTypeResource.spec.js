...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.VariableTypeResource();
  });
  ...
  describe('VariableTypeResource', function() {
    it('should create an instance of VariableTypeResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.VariableTypeResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.VariableTypeResource);
    });
