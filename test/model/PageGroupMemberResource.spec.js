...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageGroupMemberResource();
  });
  ...
  describe('PageGroupMemberResource', function() {
    it('should create an instance of PageGroupMemberResource', function() {
      // uncomment below and update the code to test PageGroupMemberResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageGroupMemberResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageGroupMemberResource);
    });
