...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageBreCategoryResource();
  });
  ...
  describe('PageBreCategoryResource', function() {
    it('should create an instance of PageBreCategoryResource', function() {
      // uncomment below and update the code to test PageBreCategoryResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageBreCategoryResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageBreCategoryResource);
    });
