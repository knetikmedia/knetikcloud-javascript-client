...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageDispositionResource();
  });
  ...
  describe('PageDispositionResource', function() {
    it('should create an instance of PageDispositionResource', function() {
      // uncomment below and update the code to test PageDispositionResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageDispositionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageDispositionResource);
    });
