...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ContributionResource();
  });
  ...
  describe('ContributionResource', function() {
    it('should create an instance of ContributionResource', function() {
      ...
      //var instane = new KnetikcloudSdk.ContributionResource();
      //expect(instance).to.be.a(KnetikcloudSdk.ContributionResource);
    });
