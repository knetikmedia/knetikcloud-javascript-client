...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ContributionResource();
  });
  ...
  describe('ContributionResource', function() {
    it('should create an instance of ContributionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ContributionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ContributionResource);
    });
