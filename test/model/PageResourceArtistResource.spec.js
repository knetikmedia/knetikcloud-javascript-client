...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceArtistResource();
  });
  ...
  describe('PageResourceArtistResource', function() {
    it('should create an instance of PageResourceArtistResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceArtistResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceArtistResource);
    });
