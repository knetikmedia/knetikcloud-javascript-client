...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageCurrencyResource();
  });
  ...
  describe('PageCurrencyResource', function() {
    it('should create an instance of PageCurrencyResource', function() {
      // uncomment below and update the code to test PageCurrencyResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageCurrencyResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageCurrencyResource);
    });
