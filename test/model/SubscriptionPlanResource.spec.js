...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.SubscriptionPlanResource();
  });
  ...
  describe('SubscriptionPlanResource', function() {
    it('should create an instance of SubscriptionPlanResource', function() {
      ...
      //var instane = new KnetikcloudSdk.SubscriptionPlanResource();
      //expect(instance).to.be.a(KnetikcloudSdk.SubscriptionPlanResource);
    });
