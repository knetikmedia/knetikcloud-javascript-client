...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.SubscriptionPlanResource();
  });
  ...
  describe('SubscriptionPlanResource', function() {
    it('should create an instance of SubscriptionPlanResource', function() {
      ...
      //var instane = new knetikcloud-sdk.SubscriptionPlanResource();
      //expect(instance).to.be.a(knetikcloud-sdk.SubscriptionPlanResource);
    });
