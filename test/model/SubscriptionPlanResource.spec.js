...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.SubscriptionPlanResource();
  });
  ...
  describe('SubscriptionPlanResource', function() {
    it('should create an instance of SubscriptionPlanResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.SubscriptionPlanResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.SubscriptionPlanResource);
    });
