...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc();
  });
  ...
  describe('RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc', function() {
    it('should create an instance of RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc', function() {
      // uncomment below and update the code to test RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc
      //var instane = new KnetikPlatformApiDocumentationLatest.RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc);
    });
