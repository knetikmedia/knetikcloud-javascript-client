...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.FlagReportResource();
  });
  ...
  describe('FlagReportResource', function() {
    it('should create an instance of FlagReportResource', function() {
      ...
      //var instane = new knetikcloud-sdk.FlagReportResource();
      //expect(instance).to.be.a(knetikcloud-sdk.FlagReportResource);
    });
