...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.FlagReportResource();
  });
  ...
  describe('FlagReportResource', function() {
    it('should create an instance of FlagReportResource', function() {
      ...
      //var instane = new KnetikcloudSdk.FlagReportResource();
      //expect(instance).to.be.a(KnetikcloudSdk.FlagReportResource);
    });
