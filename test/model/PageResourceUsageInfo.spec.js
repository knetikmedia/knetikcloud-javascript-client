...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceUsageInfo();
  });
  ...
  describe('PageResourceUsageInfo', function() {
    it('should create an instance of PageResourceUsageInfo', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceUsageInfo();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceUsageInfo);
    });
