...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageCartSummary();
  });
  ...
  describe('PageCartSummary', function() {
    it('should create an instance of PageCartSummary', function() {
      // uncomment below and update the code to test PageCartSummary
      //var instane = new KnetikPlatformApiDocumentationLatest.PageCartSummary();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageCartSummary);
    });
