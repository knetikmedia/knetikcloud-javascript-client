...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.UserLevelingResource();
  });
  ...
  describe('UserLevelingResource', function() {
    it('should create an instance of UserLevelingResource', function() {
      ...
      //var instane = new knetikcloud-sdk.UserLevelingResource();
      //expect(instance).to.be.a(knetikcloud-sdk.UserLevelingResource);
    });
