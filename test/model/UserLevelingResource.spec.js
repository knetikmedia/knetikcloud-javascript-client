...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.UserLevelingResource();
  });
  ...
  describe('UserLevelingResource', function() {
    it('should create an instance of UserLevelingResource', function() {
      ...
      //var instane = new KnetikcloudSdk.UserLevelingResource();
      //expect(instance).to.be.a(KnetikcloudSdk.UserLevelingResource);
    });
