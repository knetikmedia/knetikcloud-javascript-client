...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageBreTriggerResource();
  });
  ...
  describe('PageBreTriggerResource', function() {
    it('should create an instance of PageBreTriggerResource', function() {
      // uncomment below and update the code to test PageBreTriggerResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageBreTriggerResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageBreTriggerResource);
    });
