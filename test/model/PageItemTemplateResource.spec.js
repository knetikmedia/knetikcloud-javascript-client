...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageItemTemplateResource();
  });
  ...
  describe('PageItemTemplateResource', function() {
    it('should create an instance of PageItemTemplateResource', function() {
      // uncomment below and update the code to test PageItemTemplateResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageItemTemplateResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageItemTemplateResource);
    });
