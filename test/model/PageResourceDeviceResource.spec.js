...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceDeviceResource();
  });
  ...
  describe('PageResourceDeviceResource', function() {
    it('should create an instance of PageResourceDeviceResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceDeviceResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceDeviceResource);
    });
