...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ApplyPaymentRequest();
  });
  ...
  describe('ApplyPaymentRequest', function() {
    it('should create an instance of ApplyPaymentRequest', function() {
      ...
      //var instane = new KnetikcloudSdk.ApplyPaymentRequest();
      //expect(instance).to.be.a(KnetikcloudSdk.ApplyPaymentRequest);
    });
