...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ApplyPaymentRequest();
  });
  ...
  describe('ApplyPaymentRequest', function() {
    it('should create an instance of ApplyPaymentRequest', function() {
      ...
      //var instane = new knetikcloud-sdk.ApplyPaymentRequest();
      //expect(instance).to.be.a(knetikcloud-sdk.ApplyPaymentRequest);
    });
