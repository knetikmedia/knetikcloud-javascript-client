...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageBreEventLog();
  });
  ...
  describe('PageBreEventLog', function() {
    it('should create an instance of PageBreEventLog', function() {
      // uncomment below and update the code to test PageBreEventLog
      //var instane = new KnetikPlatformApiDocumentationLatest.PageBreEventLog();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageBreEventLog);
    });
