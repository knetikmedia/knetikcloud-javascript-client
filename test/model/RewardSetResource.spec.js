...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.RewardSetResource();
  });
  ...
  describe('RewardSetResource', function() {
    it('should create an instance of RewardSetResource', function() {
      ...
      //var instane = new knetikcloud-sdk.RewardSetResource();
      //expect(instance).to.be.a(knetikcloud-sdk.RewardSetResource);
    });
