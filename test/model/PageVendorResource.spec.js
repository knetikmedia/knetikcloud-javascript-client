...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageVendorResource();
  });
  ...
  describe('PageVendorResource', function() {
    it('should create an instance of PageVendorResource', function() {
      // uncomment below and update the code to test PageVendorResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageVendorResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageVendorResource);
    });
