...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.CountryTaxResource();
  });
  ...
  describe('CountryTaxResource', function() {
    it('should create an instance of CountryTaxResource', function() {
      ...
      //var instane = new knetikcloud-sdk.CountryTaxResource();
      //expect(instance).to.be.a(knetikcloud-sdk.CountryTaxResource);
    });
