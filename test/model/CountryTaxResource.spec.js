...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.CountryTaxResource();
  });
  ...
  describe('CountryTaxResource', function() {
    it('should create an instance of CountryTaxResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.CountryTaxResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.CountryTaxResource);
    });
