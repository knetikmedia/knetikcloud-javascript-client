...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ImportJobResource();
  });
  ...
  describe('ImportJobResource', function() {
    it('should create an instance of ImportJobResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ImportJobResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ImportJobResource);
    });
