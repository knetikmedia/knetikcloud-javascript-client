...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.CartShippingOption();
  });
  ...
  describe('CartShippingOption', function() {
    it('should create an instance of CartShippingOption', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.CartShippingOption();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.CartShippingOption);
    });
