...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.BreEventLog();
  });
  ...
  describe('BreEventLog', function() {
    it('should create an instance of BreEventLog', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.BreEventLog();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.BreEventLog);
    });
