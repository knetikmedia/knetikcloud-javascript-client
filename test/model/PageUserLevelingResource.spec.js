...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUserLevelingResource();
  });
  ...
  describe('PageUserLevelingResource', function() {
    it('should create an instance of PageUserLevelingResource', function() {
      // uncomment below and update the code to test PageUserLevelingResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUserLevelingResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUserLevelingResource);
    });
