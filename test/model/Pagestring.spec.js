...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.Pagestring();
  });
  ...
  describe('Pagestring', function() {
    it('should create an instance of Pagestring', function() {
      // uncomment below and update the code to test Pagestring
      //var instane = new KnetikPlatformApiDocumentationLatest.Pagestring();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.Pagestring);
    });
