...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceUserBaseResource();
  });
  ...
  describe('PageResourceUserBaseResource', function() {
    it('should create an instance of PageResourceUserBaseResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceUserBaseResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceUserBaseResource);
    });
