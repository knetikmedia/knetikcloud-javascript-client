...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceUserBaseResource();
  });
  ...
  describe('PageResourceUserBaseResource', function() {
    it('should create an instance of PageResourceUserBaseResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceUserBaseResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceUserBaseResource);
    });
