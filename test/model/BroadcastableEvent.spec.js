...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.BroadcastableEvent();
  });
  ...
  describe('BroadcastableEvent', function() {
    it('should create an instance of BroadcastableEvent', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.BroadcastableEvent();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.BroadcastableEvent);
    });
