...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.BroadcastableEvent();
  });
  ...
  describe('BroadcastableEvent', function() {
    it('should create an instance of BroadcastableEvent', function() {
      ...
      //var instane = new knetikcloud-sdk.BroadcastableEvent();
      //expect(instance).to.be.a(knetikcloud-sdk.BroadcastableEvent);
    });
