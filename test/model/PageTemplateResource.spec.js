...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageTemplateResource();
  });
  ...
  describe('PageTemplateResource', function() {
    it('should create an instance of PageTemplateResource', function() {
      // uncomment below and update the code to test PageTemplateResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageTemplateResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageTemplateResource);
    });
