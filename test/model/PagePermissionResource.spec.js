...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PagePermissionResource();
  });
  ...
  describe('PagePermissionResource', function() {
    it('should create an instance of PagePermissionResource', function() {
      // uncomment below and update the code to test PagePermissionResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PagePermissionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PagePermissionResource);
    });
