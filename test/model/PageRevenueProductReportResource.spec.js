...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageRevenueProductReportResource();
  });
  ...
  describe('PageRevenueProductReportResource', function() {
    it('should create an instance of PageRevenueProductReportResource', function() {
      // uncomment below and update the code to test PageRevenueProductReportResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageRevenueProductReportResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageRevenueProductReportResource);
    });
