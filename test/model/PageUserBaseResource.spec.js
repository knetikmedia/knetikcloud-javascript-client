...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUserBaseResource();
  });
  ...
  describe('PageUserBaseResource', function() {
    it('should create an instance of PageUserBaseResource', function() {
      // uncomment below and update the code to test PageUserBaseResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUserBaseResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUserBaseResource);
    });
