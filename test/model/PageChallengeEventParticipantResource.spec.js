...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageChallengeEventParticipantResource();
  });
  ...
  describe('PageChallengeEventParticipantResource', function() {
    it('should create an instance of PageChallengeEventParticipantResource', function() {
      // uncomment below and update the code to test PageChallengeEventParticipantResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageChallengeEventParticipantResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageChallengeEventParticipantResource);
    });
