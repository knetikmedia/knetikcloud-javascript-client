...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.CouponItem();
  });
  ...
  describe('CouponItem', function() {
    it('should create an instance of CouponItem', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.CouponItem();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.CouponItem);
    });
