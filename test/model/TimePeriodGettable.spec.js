...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.TimePeriodGettable();
  });
  ...
  describe('TimePeriodGettable', function() {
    it('should create an instance of TimePeriodGettable', function() {
      ...
      //var instane = new knetikcloud-sdk.TimePeriodGettable();
      //expect(instance).to.be.a(knetikcloud-sdk.TimePeriodGettable);
    });
