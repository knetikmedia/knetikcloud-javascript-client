...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.TimePeriodGettable();
  });
  ...
  describe('TimePeriodGettable', function() {
    it('should create an instance of TimePeriodGettable', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.TimePeriodGettable();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.TimePeriodGettable);
    });
