...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.CartShippableResponse();
  });
  ...
  describe('CartShippableResponse', function() {
    it('should create an instance of CartShippableResponse', function() {
      ...
      //var instane = new knetikcloud-sdk.CartShippableResponse();
      //expect(instance).to.be.a(knetikcloud-sdk.CartShippableResponse);
    });
