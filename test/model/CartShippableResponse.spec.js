...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.CartShippableResponse();
  });
  ...
  describe('CartShippableResponse', function() {
    it('should create an instance of CartShippableResponse', function() {
      ...
      //var instane = new KnetikcloudSdk.CartShippableResponse();
      //expect(instance).to.be.a(KnetikcloudSdk.CartShippableResponse);
    });
