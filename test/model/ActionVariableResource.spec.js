...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ActionVariableResource();
  });
  ...
  describe('ActionVariableResource', function() {
    it('should create an instance of ActionVariableResource', function() {
      ...
      //var instane = new KnetikcloudSdk.ActionVariableResource();
      //expect(instance).to.be.a(KnetikcloudSdk.ActionVariableResource);
    });
