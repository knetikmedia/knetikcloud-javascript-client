...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ActionVariableResource();
  });
  ...
  describe('ActionVariableResource', function() {
    it('should create an instance of ActionVariableResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ActionVariableResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ActionVariableResource);
    });
