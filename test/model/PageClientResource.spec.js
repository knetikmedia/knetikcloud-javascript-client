...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageClientResource();
  });
  ...
  describe('PageClientResource', function() {
    it('should create an instance of PageClientResource', function() {
      // uncomment below and update the code to test PageClientResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageClientResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageClientResource);
    });
