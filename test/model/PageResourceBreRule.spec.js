...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceBreRule();
  });
  ...
  describe('PageResourceBreRule', function() {
    it('should create an instance of PageResourceBreRule', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceBreRule();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceBreRule);
    });
