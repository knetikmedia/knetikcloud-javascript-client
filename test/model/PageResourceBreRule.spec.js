...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceBreRule();
  });
  ...
  describe('PageResourceBreRule', function() {
    it('should create an instance of PageResourceBreRule', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceBreRule();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceBreRule);
    });
