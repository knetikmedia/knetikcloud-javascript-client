...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.ImagePropertyDefinitionResource();
  });
  ...
  describe('ImagePropertyDefinitionResource', function() {
    it('should create an instance of ImagePropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.ImagePropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.ImagePropertyDefinitionResource);
    });
