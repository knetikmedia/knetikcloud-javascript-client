...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ImagePropertyDefinitionResource();
  });
  ...
  describe('ImagePropertyDefinitionResource', function() {
    it('should create an instance of ImagePropertyDefinitionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ImagePropertyDefinitionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ImagePropertyDefinitionResource);
    });
