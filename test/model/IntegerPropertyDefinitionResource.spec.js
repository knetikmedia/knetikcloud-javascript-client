...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.IntegerPropertyDefinitionResource();
  });
  ...
  describe('IntegerPropertyDefinitionResource', function() {
    it('should create an instance of IntegerPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikcloudSdk.IntegerPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikcloudSdk.IntegerPropertyDefinitionResource);
    });
