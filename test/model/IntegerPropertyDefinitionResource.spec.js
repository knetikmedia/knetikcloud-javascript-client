...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.IntegerPropertyDefinitionResource();
  });
  ...
  describe('IntegerPropertyDefinitionResource', function() {
    it('should create an instance of IntegerPropertyDefinitionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.IntegerPropertyDefinitionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.IntegerPropertyDefinitionResource);
    });
