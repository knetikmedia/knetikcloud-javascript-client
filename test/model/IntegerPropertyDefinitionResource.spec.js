...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.IntegerPropertyDefinitionResource();
  });
  ...
  describe('IntegerPropertyDefinitionResource', function() {
    it('should create an instance of IntegerPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.IntegerPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.IntegerPropertyDefinitionResource);
    });
