...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.SubscriptionPlan();
  });
  ...
  describe('SubscriptionPlan', function() {
    it('should create an instance of SubscriptionPlan', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.SubscriptionPlan();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.SubscriptionPlan);
    });
