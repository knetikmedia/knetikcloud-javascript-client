...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.CreateBillingAgreementRequest();
  });
  ...
  describe('CreateBillingAgreementRequest', function() {
    it('should create an instance of CreateBillingAgreementRequest', function() {
      ...
      //var instane = new knetikcloud-sdk.CreateBillingAgreementRequest();
      //expect(instance).to.be.a(knetikcloud-sdk.CreateBillingAgreementRequest);
    });
