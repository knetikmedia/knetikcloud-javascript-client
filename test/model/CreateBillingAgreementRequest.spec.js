...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.CreateBillingAgreementRequest();
  });
  ...
  describe('CreateBillingAgreementRequest', function() {
    it('should create an instance of CreateBillingAgreementRequest', function() {
      ...
      //var instane = new KnetikcloudSdk.CreateBillingAgreementRequest();
      //expect(instance).to.be.a(KnetikcloudSdk.CreateBillingAgreementRequest);
    });
