...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourcePermissionResource();
  });
  ...
  describe('PageResourcePermissionResource', function() {
    it('should create an instance of PageResourcePermissionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourcePermissionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourcePermissionResource);
    });
