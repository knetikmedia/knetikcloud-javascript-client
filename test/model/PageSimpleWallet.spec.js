...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageSimpleWallet();
  });
  ...
  describe('PageSimpleWallet', function() {
    it('should create an instance of PageSimpleWallet', function() {
      // uncomment below and update the code to test PageSimpleWallet
      //var instane = new KnetikPlatformApiDocumentationLatest.PageSimpleWallet();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageSimpleWallet);
    });
