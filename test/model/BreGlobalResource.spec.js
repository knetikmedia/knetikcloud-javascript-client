...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.BreGlobalResource();
  });
  ...
  describe('BreGlobalResource', function() {
    it('should create an instance of BreGlobalResource', function() {
      ...
      //var instane = new knetikcloud-sdk.BreGlobalResource();
      //expect(instance).to.be.a(knetikcloud-sdk.BreGlobalResource);
    });
