...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageLocationLogResource();
  });
  ...
  describe('PageLocationLogResource', function() {
    it('should create an instance of PageLocationLogResource', function() {
      // uncomment below and update the code to test PageLocationLogResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageLocationLogResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageLocationLogResource);
    });
