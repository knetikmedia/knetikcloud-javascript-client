...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.StringOperationResource();
  });
  ...
  describe('StringOperationResource', function() {
    it('should create an instance of StringOperationResource', function() {
      ...
      //var instane = new KnetikcloudSdk.StringOperationResource();
      //expect(instance).to.be.a(KnetikcloudSdk.StringOperationResource);
    });
