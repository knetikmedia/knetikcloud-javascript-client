...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.StringOperationResource();
  });
  ...
  describe('StringOperationResource', function() {
    it('should create an instance of StringOperationResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.StringOperationResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.StringOperationResource);
    });
