...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.StringOperationResource();
  });
  ...
  describe('StringOperationResource', function() {
    it('should create an instance of StringOperationResource', function() {
      ...
      //var instane = new knetikcloud-sdk.StringOperationResource();
      //expect(instance).to.be.a(knetikcloud-sdk.StringOperationResource);
    });
