...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PropertyFieldResource();
  });
  ...
  describe('PropertyFieldResource', function() {
    it('should create an instance of PropertyFieldResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PropertyFieldResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PropertyFieldResource);
    });
