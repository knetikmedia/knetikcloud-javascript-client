...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PropertyFieldResource();
  });
  ...
  describe('PropertyFieldResource', function() {
    it('should create an instance of PropertyFieldResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PropertyFieldResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PropertyFieldResource);
    });
