...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.PropertyFieldResource();
  });
  ...
  describe('PropertyFieldResource', function() {
    it('should create an instance of PropertyFieldResource', function() {
      ...
      //var instane = new KnetikcloudSdk.PropertyFieldResource();
      //expect(instance).to.be.a(KnetikcloudSdk.PropertyFieldResource);
    });
