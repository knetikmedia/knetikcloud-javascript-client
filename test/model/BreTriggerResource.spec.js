...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.BreTriggerResource();
  });
  ...
  describe('BreTriggerResource', function() {
    it('should create an instance of BreTriggerResource', function() {
      ...
      //var instane = new knetikcloud-sdk.BreTriggerResource();
      //expect(instance).to.be.a(knetikcloud-sdk.BreTriggerResource);
    });
