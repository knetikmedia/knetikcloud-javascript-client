...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.BreTriggerResource();
  });
  ...
  describe('BreTriggerResource', function() {
    it('should create an instance of BreTriggerResource', function() {
      ...
      //var instane = new KnetikcloudSdk.BreTriggerResource();
      //expect(instance).to.be.a(KnetikcloudSdk.BreTriggerResource);
    });
