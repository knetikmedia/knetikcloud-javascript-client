...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ConfigLookupResource();
  });
  ...
  describe('ConfigLookupResource', function() {
    it('should create an instance of ConfigLookupResource', function() {
      ...
      //var instane = new KnetikcloudSdk.ConfigLookupResource();
      //expect(instance).to.be.a(KnetikcloudSdk.ConfigLookupResource);
    });
