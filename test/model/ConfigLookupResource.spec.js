...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ConfigLookupResource();
  });
  ...
  describe('ConfigLookupResource', function() {
    it('should create an instance of ConfigLookupResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ConfigLookupResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ConfigLookupResource);
    });
