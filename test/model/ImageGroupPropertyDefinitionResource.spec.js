...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ImageGroupPropertyDefinitionResource();
  });
  ...
  describe('ImageGroupPropertyDefinitionResource', function() {
    it('should create an instance of ImageGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ImageGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ImageGroupPropertyDefinitionResource);
    });
