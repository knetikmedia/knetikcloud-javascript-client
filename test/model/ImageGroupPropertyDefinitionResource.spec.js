...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ImageGroupPropertyDefinitionResource();
  });
  ...
  describe('ImageGroupPropertyDefinitionResource', function() {
    it('should create an instance of ImageGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikcloudSdk.ImageGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikcloudSdk.ImageGroupPropertyDefinitionResource);
    });
