...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.Batch();
  });
  ...
  describe('Batch', function() {
    it('should create an instance of Batch', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.Batch();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.Batch);
    });
