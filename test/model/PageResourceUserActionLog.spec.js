...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceUserActionLog();
  });
  ...
  describe('PageResourceUserActionLog', function() {
    it('should create an instance of PageResourceUserActionLog', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceUserActionLog();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceUserActionLog);
    });
