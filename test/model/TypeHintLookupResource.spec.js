...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.TypeHintLookupResource();
  });
  ...
  describe('TypeHintLookupResource', function() {
    it('should create an instance of TypeHintLookupResource', function() {
      ...
      //var instane = new KnetikcloudSdk.TypeHintLookupResource();
      //expect(instance).to.be.a(KnetikcloudSdk.TypeHintLookupResource);
    });
