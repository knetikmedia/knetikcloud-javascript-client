...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.TypeHintLookupResource();
  });
  ...
  describe('TypeHintLookupResource', function() {
    it('should create an instance of TypeHintLookupResource', function() {
      ...
      //var instane = new knetikcloud-sdk.TypeHintLookupResource();
      //expect(instance).to.be.a(knetikcloud-sdk.TypeHintLookupResource);
    });
