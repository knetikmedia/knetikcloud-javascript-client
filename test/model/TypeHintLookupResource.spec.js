...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.TypeHintLookupResource();
  });
  ...
  describe('TypeHintLookupResource', function() {
    it('should create an instance of TypeHintLookupResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.TypeHintLookupResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.TypeHintLookupResource);
    });
