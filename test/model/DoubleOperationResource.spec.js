...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.DoubleOperationResource();
  });
  ...
  describe('DoubleOperationResource', function() {
    it('should create an instance of DoubleOperationResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.DoubleOperationResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.DoubleOperationResource);
    });
