...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.DoubleOperationResource();
  });
  ...
  describe('DoubleOperationResource', function() {
    it('should create an instance of DoubleOperationResource', function() {
      ...
      //var instane = new KnetikcloudSdk.DoubleOperationResource();
      //expect(instance).to.be.a(KnetikcloudSdk.DoubleOperationResource);
    });
