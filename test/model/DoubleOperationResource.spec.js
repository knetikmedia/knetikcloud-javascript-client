...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.DoubleOperationResource();
  });
  ...
  describe('DoubleOperationResource', function() {
    it('should create an instance of DoubleOperationResource', function() {
      ...
      //var instane = new knetikcloud-sdk.DoubleOperationResource();
      //expect(instance).to.be.a(knetikcloud-sdk.DoubleOperationResource);
    });
