...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceInvoiceResource();
  });
  ...
  describe('PageResourceInvoiceResource', function() {
    it('should create an instance of PageResourceInvoiceResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceInvoiceResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceInvoiceResource);
    });
