...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PropertyFieldListResource();
  });
  ...
  describe('PropertyFieldListResource', function() {
    it('should create an instance of PropertyFieldListResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PropertyFieldListResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PropertyFieldListResource);
    });
