...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.PropertyFieldListResource();
  });
  ...
  describe('PropertyFieldListResource', function() {
    it('should create an instance of PropertyFieldListResource', function() {
      ...
      //var instane = new KnetikcloudSdk.PropertyFieldListResource();
      //expect(instance).to.be.a(KnetikcloudSdk.PropertyFieldListResource);
    });
