...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.CartShippingAddressRequest();
  });
  ...
  describe('CartShippingAddressRequest', function() {
    it('should create an instance of CartShippingAddressRequest', function() {
      ...
      //var instane = new knetikcloud-sdk.CartShippingAddressRequest();
      //expect(instance).to.be.a(knetikcloud-sdk.CartShippingAddressRequest);
    });
