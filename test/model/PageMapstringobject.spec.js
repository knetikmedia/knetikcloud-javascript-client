...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageMapstringobject();
  });
  ...
  describe('PageMapstringobject', function() {
    it('should create an instance of PageMapstringobject', function() {
      // uncomment below and update the code to test PageMapstringobject
      //var instane = new KnetikPlatformApiDocumentationLatest.PageMapstringobject();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageMapstringobject);
    });
