...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceStoreItem();
  });
  ...
  describe('PageResourceStoreItem', function() {
    it('should create an instance of PageResourceStoreItem', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceStoreItem();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceStoreItem);
    });
