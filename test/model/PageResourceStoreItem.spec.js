...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceStoreItem();
  });
  ...
  describe('PageResourceStoreItem', function() {
    it('should create an instance of PageResourceStoreItem', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceStoreItem();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceStoreItem);
    });
