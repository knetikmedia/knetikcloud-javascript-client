...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceSimpleUserResource();
  });
  ...
  describe('PageResourceSimpleUserResource', function() {
    it('should create an instance of PageResourceSimpleUserResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceSimpleUserResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceSimpleUserResource);
    });
