...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageStateTaxResource();
  });
  ...
  describe('PageStateTaxResource', function() {
    it('should create an instance of PageStateTaxResource', function() {
      // uncomment below and update the code to test PageStateTaxResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageStateTaxResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageStateTaxResource);
    });
