...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.VideoPropertyDefinitionResource();
  });
  ...
  describe('VideoPropertyDefinitionResource', function() {
    it('should create an instance of VideoPropertyDefinitionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.VideoPropertyDefinitionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.VideoPropertyDefinitionResource);
    });
