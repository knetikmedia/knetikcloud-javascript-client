...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.VideoPropertyDefinitionResource();
  });
  ...
  describe('VideoPropertyDefinitionResource', function() {
    it('should create an instance of VideoPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.VideoPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.VideoPropertyDefinitionResource);
    });
