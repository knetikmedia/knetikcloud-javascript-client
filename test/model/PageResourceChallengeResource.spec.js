...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceChallengeResource();
  });
  ...
  describe('PageResourceChallengeResource', function() {
    it('should create an instance of PageResourceChallengeResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceChallengeResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceChallengeResource);
    });
