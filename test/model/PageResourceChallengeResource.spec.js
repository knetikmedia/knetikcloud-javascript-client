...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceChallengeResource();
  });
  ...
  describe('PageResourceChallengeResource', function() {
    it('should create an instance of PageResourceChallengeResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceChallengeResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceChallengeResource);
    });
