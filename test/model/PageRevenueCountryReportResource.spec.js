...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageRevenueCountryReportResource();
  });
  ...
  describe('PageRevenueCountryReportResource', function() {
    it('should create an instance of PageRevenueCountryReportResource', function() {
      // uncomment below and update the code to test PageRevenueCountryReportResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageRevenueCountryReportResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageRevenueCountryReportResource);
    });
