...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUserAchievementResource();
  });
  ...
  describe('PageUserAchievementResource', function() {
    it('should create an instance of PageUserAchievementResource', function() {
      // uncomment below and update the code to test PageUserAchievementResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUserAchievementResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUserAchievementResource);
    });
