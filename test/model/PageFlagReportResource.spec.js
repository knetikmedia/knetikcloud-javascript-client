...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageFlagReportResource();
  });
  ...
  describe('PageFlagReportResource', function() {
    it('should create an instance of PageFlagReportResource', function() {
      // uncomment below and update the code to test PageFlagReportResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageFlagReportResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageFlagReportResource);
    });
