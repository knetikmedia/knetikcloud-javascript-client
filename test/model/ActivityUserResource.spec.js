...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ActivityUserResource();
  });
  ...
  describe('ActivityUserResource', function() {
    it('should create an instance of ActivityUserResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ActivityUserResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ActivityUserResource);
    });
