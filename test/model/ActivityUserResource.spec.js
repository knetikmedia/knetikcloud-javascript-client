...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ActivityUserResource();
  });
  ...
  describe('ActivityUserResource', function() {
    it('should create an instance of ActivityUserResource', function() {
      ...
      //var instane = new KnetikcloudSdk.ActivityUserResource();
      //expect(instance).to.be.a(KnetikcloudSdk.ActivityUserResource);
    });
