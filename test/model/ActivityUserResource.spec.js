...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.ActivityUserResource();
  });
  ...
  describe('ActivityUserResource', function() {
    it('should create an instance of ActivityUserResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.ActivityUserResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.ActivityUserResource);
    });
