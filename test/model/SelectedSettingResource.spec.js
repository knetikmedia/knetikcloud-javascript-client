...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.SelectedSettingResource();
  });
  ...
  describe('SelectedSettingResource', function() {
    it('should create an instance of SelectedSettingResource', function() {
      ...
      //var instane = new KnetikcloudSdk.SelectedSettingResource();
      //expect(instance).to.be.a(KnetikcloudSdk.SelectedSettingResource);
    });
