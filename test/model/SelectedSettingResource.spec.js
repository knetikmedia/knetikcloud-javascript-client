...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.SelectedSettingResource();
  });
  ...
  describe('SelectedSettingResource', function() {
    it('should create an instance of SelectedSettingResource', function() {
      ...
      //var instane = new knetikcloud-sdk.SelectedSettingResource();
      //expect(instance).to.be.a(knetikcloud-sdk.SelectedSettingResource);
    });
