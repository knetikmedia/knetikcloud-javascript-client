...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ActivityOccurrenceJoinResult();
  });
  ...
  describe('ActivityOccurrenceJoinResult', function() {
    it('should create an instance of ActivityOccurrenceJoinResult', function() {
      ...
      //var instane = new knetikcloud-sdk.ActivityOccurrenceJoinResult();
      //expect(instance).to.be.a(knetikcloud-sdk.ActivityOccurrenceJoinResult);
    });
