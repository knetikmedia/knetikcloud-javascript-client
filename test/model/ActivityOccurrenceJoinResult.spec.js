...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ActivityOccurrenceJoinResult();
  });
  ...
  describe('ActivityOccurrenceJoinResult', function() {
    it('should create an instance of ActivityOccurrenceJoinResult', function() {
      ...
      //var instane = new KnetikcloudSdk.ActivityOccurrenceJoinResult();
      //expect(instance).to.be.a(KnetikcloudSdk.ActivityOccurrenceJoinResult);
    });
