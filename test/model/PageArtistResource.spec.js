...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageArtistResource();
  });
  ...
  describe('PageArtistResource', function() {
    it('should create an instance of PageArtistResource', function() {
      // uncomment below and update the code to test PageArtistResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageArtistResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageArtistResource);
    });
