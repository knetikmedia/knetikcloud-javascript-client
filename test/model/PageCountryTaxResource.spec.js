...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageCountryTaxResource();
  });
  ...
  describe('PageCountryTaxResource', function() {
    it('should create an instance of PageCountryTaxResource', function() {
      // uncomment below and update the code to test PageCountryTaxResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageCountryTaxResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageCountryTaxResource);
    });
