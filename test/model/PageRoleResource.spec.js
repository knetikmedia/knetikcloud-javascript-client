...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageRoleResource();
  });
  ...
  describe('PageRoleResource', function() {
    it('should create an instance of PageRoleResource', function() {
      // uncomment below and update the code to test PageRoleResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageRoleResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageRoleResource);
    });
