...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceSimpleWallet();
  });
  ...
  describe('PageResourceSimpleWallet', function() {
    it('should create an instance of PageResourceSimpleWallet', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceSimpleWallet();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceSimpleWallet);
    });
