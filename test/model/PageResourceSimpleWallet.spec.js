...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceSimpleWallet();
  });
  ...
  describe('PageResourceSimpleWallet', function() {
    it('should create an instance of PageResourceSimpleWallet', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceSimpleWallet();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceSimpleWallet);
    });
