...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.CreatePayPalPaymentRequest();
  });
  ...
  describe('CreatePayPalPaymentRequest', function() {
    it('should create an instance of CreatePayPalPaymentRequest', function() {
      ...
      //var instane = new KnetikcloudSdk.CreatePayPalPaymentRequest();
      //expect(instance).to.be.a(KnetikcloudSdk.CreatePayPalPaymentRequest);
    });
