...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.CreatePayPalPaymentRequest();
  });
  ...
  describe('CreatePayPalPaymentRequest', function() {
    it('should create an instance of CreatePayPalPaymentRequest', function() {
      ...
      //var instane = new knetikcloud-sdk.CreatePayPalPaymentRequest();
      //expect(instance).to.be.a(knetikcloud-sdk.CreatePayPalPaymentRequest);
    });
