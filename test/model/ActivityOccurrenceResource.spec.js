...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ActivityOccurrenceResource();
  });
  ...
  describe('ActivityOccurrenceResource', function() {
    it('should create an instance of ActivityOccurrenceResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ActivityOccurrenceResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ActivityOccurrenceResource);
    });
