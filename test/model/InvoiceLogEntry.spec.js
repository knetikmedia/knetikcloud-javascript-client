...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.InvoiceLogEntry();
  });
  ...
  describe('InvoiceLogEntry', function() {
    it('should create an instance of InvoiceLogEntry', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.InvoiceLogEntry();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.InvoiceLogEntry);
    });
