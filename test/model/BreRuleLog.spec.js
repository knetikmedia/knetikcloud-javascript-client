...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.BreRuleLog();
  });
  ...
  describe('BreRuleLog', function() {
    it('should create an instance of BreRuleLog', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.BreRuleLog();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.BreRuleLog);
    });
