...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.ItemTemplateResource();
  });
  ...
  describe('ItemTemplateResource', function() {
    it('should create an instance of ItemTemplateResource', function() {
      ...
      //var instane = new KnetikcloudSdk.ItemTemplateResource();
      //expect(instance).to.be.a(KnetikcloudSdk.ItemTemplateResource);
    });
