...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.ItemTemplateResource();
  });
  ...
  describe('ItemTemplateResource', function() {
    it('should create an instance of ItemTemplateResource', function() {
      ...
      //var instane = new knetikcloud-sdk.ItemTemplateResource();
      //expect(instance).to.be.a(knetikcloud-sdk.ItemTemplateResource);
    });
