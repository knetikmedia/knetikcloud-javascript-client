...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.ItemTemplateResource();
  });
  ...
  describe('ItemTemplateResource', function() {
    it('should create an instance of ItemTemplateResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.ItemTemplateResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.ItemTemplateResource);
    });
