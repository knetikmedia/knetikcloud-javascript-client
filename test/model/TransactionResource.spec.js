...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.TransactionResource();
  });
  ...
  describe('TransactionResource', function() {
    it('should create an instance of TransactionResource', function() {
      ...
      //var instane = new knetikcloud-sdk.TransactionResource();
      //expect(instance).to.be.a(knetikcloud-sdk.TransactionResource);
    });
