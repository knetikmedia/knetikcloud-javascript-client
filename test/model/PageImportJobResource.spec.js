...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageImportJobResource();
  });
  ...
  describe('PageImportJobResource', function() {
    it('should create an instance of PageImportJobResource', function() {
      // uncomment below and update the code to test PageImportJobResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageImportJobResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageImportJobResource);
    });
