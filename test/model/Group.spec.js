...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.Group();
  });
  ...
  describe('Group', function() {
    it('should create an instance of Group', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.Group();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.Group);
    });
