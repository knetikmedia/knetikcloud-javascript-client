...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceChallengeEventResource();
  });
  ...
  describe('PageResourceChallengeEventResource', function() {
    it('should create an instance of PageResourceChallengeEventResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceChallengeEventResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceChallengeEventResource);
    });
