...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceChallengeEventResource();
  });
  ...
  describe('PageResourceChallengeEventResource', function() {
    it('should create an instance of PageResourceChallengeEventResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceChallengeEventResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceChallengeEventResource);
    });
