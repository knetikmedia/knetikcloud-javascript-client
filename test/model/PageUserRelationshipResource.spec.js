...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageUserRelationshipResource();
  });
  ...
  describe('PageUserRelationshipResource', function() {
    it('should create an instance of PageUserRelationshipResource', function() {
      // uncomment below and update the code to test PageUserRelationshipResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageUserRelationshipResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageUserRelationshipResource);
    });
