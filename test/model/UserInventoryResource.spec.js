...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.UserInventoryResource();
  });
  ...
  describe('UserInventoryResource', function() {
    it('should create an instance of UserInventoryResource', function() {
      ...
      //var instane = new KnetikcloudSdk.UserInventoryResource();
      //expect(instance).to.be.a(KnetikcloudSdk.UserInventoryResource);
    });
