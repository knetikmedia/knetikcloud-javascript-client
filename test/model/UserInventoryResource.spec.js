...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.UserInventoryResource();
  });
  ...
  describe('UserInventoryResource', function() {
    it('should create an instance of UserInventoryResource', function() {
      ...
      //var instane = new knetikcloud-sdk.UserInventoryResource();
      //expect(instance).to.be.a(knetikcloud-sdk.UserInventoryResource);
    });
