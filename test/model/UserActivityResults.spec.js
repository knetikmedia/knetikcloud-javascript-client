...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.UserActivityResults();
  });
  ...
  describe('UserActivityResults', function() {
    it('should create an instance of UserActivityResults', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.UserActivityResults();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.UserActivityResults);
    });
