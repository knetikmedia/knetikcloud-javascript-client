...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.UserActivityResults();
  });
  ...
  describe('UserActivityResults', function() {
    it('should create an instance of UserActivityResults', function() {
      ...
      //var instane = new KnetikcloudSdk.UserActivityResults();
      //expect(instance).to.be.a(KnetikcloudSdk.UserActivityResults);
    });
