...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.RevenueCountryReportResource();
  });
  ...
  describe('RevenueCountryReportResource', function() {
    it('should create an instance of RevenueCountryReportResource', function() {
      ...
      //var instane = new KnetikcloudSdk.RevenueCountryReportResource();
      //expect(instance).to.be.a(KnetikcloudSdk.RevenueCountryReportResource);
    });
