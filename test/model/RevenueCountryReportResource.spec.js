...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.RevenueCountryReportResource();
  });
  ...
  describe('RevenueCountryReportResource', function() {
    it('should create an instance of RevenueCountryReportResource', function() {
      ...
      //var instane = new knetikcloud-sdk.RevenueCountryReportResource();
      //expect(instance).to.be.a(knetikcloud-sdk.RevenueCountryReportResource);
    });
