...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceUserItemLogResource();
  });
  ...
  describe('PageResourceUserItemLogResource', function() {
    it('should create an instance of PageResourceUserItemLogResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceUserItemLogResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceUserItemLogResource);
    });
