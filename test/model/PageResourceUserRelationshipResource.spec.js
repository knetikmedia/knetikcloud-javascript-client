...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceUserRelationshipResource();
  });
  ...
  describe('PageResourceUserRelationshipResource', function() {
    it('should create an instance of PageResourceUserRelationshipResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceUserRelationshipResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceUserRelationshipResource);
    });
