...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceUserRelationshipResource();
  });
  ...
  describe('PageResourceUserRelationshipResource', function() {
    it('should create an instance of PageResourceUserRelationshipResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceUserRelationshipResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceUserRelationshipResource);
    });
