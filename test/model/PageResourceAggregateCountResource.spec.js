...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourceAggregateCountResource();
  });
  ...
  describe('PageResourceAggregateCountResource', function() {
    it('should create an instance of PageResourceAggregateCountResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourceAggregateCountResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourceAggregateCountResource);
    });
