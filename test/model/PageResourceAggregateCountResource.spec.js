...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceAggregateCountResource();
  });
  ...
  describe('PageResourceAggregateCountResource', function() {
    it('should create an instance of PageResourceAggregateCountResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceAggregateCountResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceAggregateCountResource);
    });
