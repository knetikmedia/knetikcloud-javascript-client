...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.StoreItem();
  });
  ...
  describe('StoreItem', function() {
    it('should create an instance of StoreItem', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.StoreItem();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.StoreItem);
    });
