...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceBreTriggerResource();
  });
  ...
  describe('PageResourceBreTriggerResource', function() {
    it('should create an instance of PageResourceBreTriggerResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceBreTriggerResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceBreTriggerResource);
    });
