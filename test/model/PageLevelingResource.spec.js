...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageLevelingResource();
  });
  ...
  describe('PageLevelingResource', function() {
    it('should create an instance of PageLevelingResource', function() {
      // uncomment below and update the code to test PageLevelingResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageLevelingResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageLevelingResource);
    });
