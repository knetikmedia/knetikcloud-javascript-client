...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.Subscription();
  });
  ...
  describe('Subscription', function() {
    it('should create an instance of Subscription', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.Subscription();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.Subscription);
    });
