...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageCampaignResource();
  });
  ...
  describe('PageCampaignResource', function() {
    it('should create an instance of PageCampaignResource', function() {
      // uncomment below and update the code to test PageCampaignResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageCampaignResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageCampaignResource);
    });
