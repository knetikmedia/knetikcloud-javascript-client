...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceInvoiceLogEntry();
  });
  ...
  describe('PageResourceInvoiceLogEntry', function() {
    it('should create an instance of PageResourceInvoiceLogEntry', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceInvoiceLogEntry();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceInvoiceLogEntry);
    });
