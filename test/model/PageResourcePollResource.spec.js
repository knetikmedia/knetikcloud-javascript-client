...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourcePollResource();
  });
  ...
  describe('PageResourcePollResource', function() {
    it('should create an instance of PageResourcePollResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourcePollResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourcePollResource);
    });
