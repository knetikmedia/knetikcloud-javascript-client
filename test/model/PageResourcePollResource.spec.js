...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.PageResourcePollResource();
  });
  ...
  describe('PageResourcePollResource', function() {
    it('should create an instance of PageResourcePollResource', function() {
      ...
      //var instane = new knetikcloud-sdk.PageResourcePollResource();
      //expect(instance).to.be.a(knetikcloud-sdk.PageResourcePollResource);
    });
