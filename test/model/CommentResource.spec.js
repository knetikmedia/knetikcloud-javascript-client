...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.CommentResource();
  });
  ...
  describe('CommentResource', function() {
    it('should create an instance of CommentResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.CommentResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.CommentResource);
    });
