...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceQuestionTemplateResource();
  });
  ...
  describe('PageResourceQuestionTemplateResource', function() {
    it('should create an instance of PageResourceQuestionTemplateResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceQuestionTemplateResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceQuestionTemplateResource);
    });
