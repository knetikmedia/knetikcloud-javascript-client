...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageQuestionResource();
  });
  ...
  describe('PageQuestionResource', function() {
    it('should create an instance of PageQuestionResource', function() {
      // uncomment below and update the code to test PageQuestionResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageQuestionResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageQuestionResource);
    });
