...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new knetikcloud-sdk.AvailableSettingResource();
  });
  ...
  describe('AvailableSettingResource', function() {
    it('should create an instance of AvailableSettingResource', function() {
      ...
      //var instane = new knetikcloud-sdk.AvailableSettingResource();
      //expect(instance).to.be.a(knetikcloud-sdk.AvailableSettingResource);
    });
