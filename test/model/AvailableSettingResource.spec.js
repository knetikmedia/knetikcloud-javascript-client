...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikcloudSdk.AvailableSettingResource();
  });
  ...
  describe('AvailableSettingResource', function() {
    it('should create an instance of AvailableSettingResource', function() {
      ...
      //var instane = new KnetikcloudSdk.AvailableSettingResource();
      //expect(instance).to.be.a(KnetikcloudSdk.AvailableSettingResource);
    });
