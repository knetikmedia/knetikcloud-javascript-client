...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.RefundResource();
  });
  ...
  describe('RefundResource', function() {
    it('should create an instance of RefundResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.RefundResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.RefundResource);
    });
