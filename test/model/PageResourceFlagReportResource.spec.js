...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageResourceFlagReportResource();
  });
  ...
  describe('PageResourceFlagReportResource', function() {
    it('should create an instance of PageResourceFlagReportResource', function() {
      ...
      //var instane = new KnetikPlatformApiDocumentationLatest.PageResourceFlagReportResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageResourceFlagReportResource);
    });
