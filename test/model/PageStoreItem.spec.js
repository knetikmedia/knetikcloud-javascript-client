...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageStoreItem();
  });
  ...
  describe('PageStoreItem', function() {
    it('should create an instance of PageStoreItem', function() {
      // uncomment below and update the code to test PageStoreItem
      //var instane = new KnetikPlatformApiDocumentationLatest.PageStoreItem();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageStoreItem);
    });
