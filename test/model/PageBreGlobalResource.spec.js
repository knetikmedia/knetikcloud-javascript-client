...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikPlatformApiDocumentationLatest.PageBreGlobalResource();
  });
  ...
  describe('PageBreGlobalResource', function() {
    it('should create an instance of PageBreGlobalResource', function() {
      // uncomment below and update the code to test PageBreGlobalResource
      //var instane = new KnetikPlatformApiDocumentationLatest.PageBreGlobalResource();
      //expect(instance).to.be.a(KnetikPlatformApiDocumentationLatest.PageBreGlobalResource);
    });
