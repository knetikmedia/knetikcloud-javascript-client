...
*KnetikCloud.BRERuleEngineExpressionsApi* | [**getBREExpressions**](docs/BRERuleEngineExpressionsApi.md#getBREExpressions) | **GET** /bre/expressions/lookup | Get a list of &#39;lookup&#39; type expressions
...
*KnetikCloud.PaymentsXsollaApi* | [**receiveXsollaNotification**](docs/PaymentsXsollaApi.md#receiveXsollaNotification) | **POST** /payment/provider/xsolla/notifications | Receives payment response from Xsolla
...
*KnetikCloud.SearchApi* | [**addSearchIndex**](docs/SearchApi.md#addSearchIndex) | **POST** /search/index/{type}/{id} | Add a new object to an index
*KnetikCloud.SearchApi* | [**addSearchMappings**](docs/SearchApi.md#addSearchMappings) | **POST** /search/mappings | Register reference mappings
*KnetikCloud.SearchApi* | [**deleteSearchIndex**](docs/SearchApi.md#deleteSearchIndex) | **DELETE** /search/index/{type}/{id} | Delete an object
*KnetikCloud.SearchApi* | [**deleteSearchIndexes**](docs/SearchApi.md#deleteSearchIndexes) | **DELETE** /search/index/{type} | Delete all objects in an index
...
*KnetikCloud.StoreApi* | [**getStore**](docs/StoreApi.md#getStore) | **GET** /store | Get a listing of store items
...
*KnetikCloud.UsersGroupsApi* | [**updateGroups**](docs/UsersGroupsApi.md#updateGroups) | **GET** /users/groups | List and search groups
...
## Documentation for Models
 ...
 - [KnetikCloud.CollectionCountry](docs/CollectionCountry.md)
 - [KnetikCloud.Collectionstring](docs/Collectionstring.md)
 - [KnetikCloud.CommentResource](docs/CommentResource.md)
 - [KnetikCloud.CommentSearch](docs/CommentSearch.md)
 ...
 - [KnetikCloud.PredicateOperation](docs/PredicateOperation.md)
