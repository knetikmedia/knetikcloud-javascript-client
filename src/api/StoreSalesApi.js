...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CatalogSale', 'model/PageCatalogSale'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CatalogSale'), require('../model/PageCatalogSale'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.StoreSalesApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.CatalogSale, root.KnetikPlatformApiDocumentationLatest.PageCatalogSale);
  }
}(this, function(ApiClient, CatalogSale, PageCatalogSale) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageCatalogSale} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageCatalogSale}
     */
    this.getCatalogSalesUsingGET = function(opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageCatalogSale;
