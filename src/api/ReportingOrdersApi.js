...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getInvoiceReports operation.
     * @callback module:api/ReportingOrdersApi~getInvoiceReportsCallback
     ...
     * @param {module:api/ReportingOrdersApi~getInvoiceReportsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PageResourceAggregateInvoiceReportResource}
     */
    this.getInvoiceReports = function(currencyCode, opts, callback) {
      opts = opts || {};
      var postBody = null;
