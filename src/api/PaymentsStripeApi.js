...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/PaymentsStripeApi~createCustomerUsingPOSTCallback
     ...
     * @param {module:api/PaymentsStripeApi~createCustomerUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PaymentMethodResource}
     */
    this.createCustomerUsingPOST = function(opts, callback) {
      opts = opts || {};
