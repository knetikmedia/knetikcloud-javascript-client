...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Cart', 'model/CartItemRequest', 'model/CartShippableResponse', 'model/CartShippingAddressRequest', 'model/PageCartSummary', 'model/SampleCountriesResponse', 'model/SkuRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Cart'), require('../model/CartItemRequest'), require('../model/CartShippableResponse'), require('../model/CartShippingAddressRequest'), require('../model/PageCartSummary'), require('../model/SampleCountriesResponse'), require('../model/SkuRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.StoreShoppingCartsApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.Cart, root.KnetikPlatformApiDocumentationLatest.CartItemRequest, root.KnetikPlatformApiDocumentationLatest.CartShippableResponse, root.KnetikPlatformApiDocumentationLatest.CartShippingAddressRequest, root.KnetikPlatformApiDocumentationLatest.PageCartSummary, root.KnetikPlatformApiDocumentationLatest.SampleCountriesResponse, root.KnetikPlatformApiDocumentationLatest.SkuRequest);
  }
}(this, function(ApiClient, Cart, CartItemRequest, CartShippableResponse, CartShippingAddressRequest, PageCartSummary, SampleCountriesResponse, SkuRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageCartSummary} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageCartSummary}
     */
    this.searchCartsUsingGET = function(opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageCartSummary;
