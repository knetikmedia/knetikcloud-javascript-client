...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/StoreShoppingCartsApi~getCountriesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} id The id of the cart
     * @param {module:api/StoreShoppingCartsApi~getCountriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SampleCountriesResponse}
     */
    this.getCountries = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw new Error("Missing the required parameter 'id' when calling getCountries");
      }
