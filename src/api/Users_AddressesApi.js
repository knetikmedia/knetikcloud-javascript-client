...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Users_AddressesApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceSavedAddressResource, root.KnetikCloud.Result, root.KnetikCloud.SavedAddressResource);
  }
}(this, function(ApiClient, PageResourceSavedAddressResource, Result, SavedAddressResource) {
  'use strict';

  /**
   * Users_Addresses service.
   * @module api/Users_AddressesApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Users_AddressesApi. 
   * @alias module:api/Users_AddressesApi
   * @class
