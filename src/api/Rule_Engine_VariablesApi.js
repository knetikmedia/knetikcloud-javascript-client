...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Rule_Engine_VariablesApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceSimpleReferenceResourceobject, root.KnetikCloud.Result, root.KnetikCloud.VariableTypeResource);
  }
}(this, function(ApiClient, PageResourceSimpleReferenceResourceobject, Result, VariableTypeResource) {
  'use strict';

  /**
   * Rule_Engine_Variables service.
   * @module api/Rule_Engine_VariablesApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Rule_Engine_VariablesApi. 
   * @alias module:api/Rule_Engine_VariablesApi
   * @class
