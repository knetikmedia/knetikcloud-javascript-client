...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Authentication', 'model/PageLocationLogResource', 'model/TokenDetailsResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Authentication'), require('../model/PageLocationLogResource'), require('../model/TokenDetailsResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.UtilSecurityApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.Authentication, root.KnetikPlatformApiDocumentationLatest.PageLocationLogResource, root.KnetikPlatformApiDocumentationLatest.TokenDetailsResource);
  }
}(this, function(ApiClient, Authentication, PageLocationLogResource, TokenDetailsResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/Authentication} opts.authentication The Authentication Object
