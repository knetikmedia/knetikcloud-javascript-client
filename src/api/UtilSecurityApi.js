...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PageResourceLocationLogResource', 'model/TokenDetailsResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PageResourceLocationLogResource'), require('../model/TokenDetailsResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.UtilSecurityApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.PageResourceLocationLogResource, root.KnetikPlatformApiDocumentationLatest.TokenDetailsResource);
  }
}(this, function(ApiClient, PageResourceLocationLogResource, TokenDetailsResource) {
  'use strict';
