...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Messaging_TopicsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceTopicResource, root.KnetikCloud.Result, root.KnetikCloud.TopicSubscriberResource, root.KnetikCloud.ValueWrapperboolean);
  }
}(this, function(ApiClient, PageResourceTopicResource, Result, TopicSubscriberResource, ValueWrapperboolean) {
  'use strict';

  /**
   * Messaging_Topics service.
   * @module api/Messaging_TopicsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Messaging_TopicsApi. 
   * @alias module:api/Messaging_TopicsApi
   * @class
