...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Campaigns_ChallengesApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ChallengeActivityResource, root.KnetikCloud.ChallengeEventResource, root.KnetikCloud.ChallengeResource, root.KnetikCloud.PageResourceBareChallengeActivityResource, root.KnetikCloud.PageResourceChallengeEventResource, root.KnetikCloud.PageResourceChallengeResource, root.KnetikCloud.PageResourceTemplateResource, root.KnetikCloud.Result, root.KnetikCloud.TemplateResource);
  }
  ...
  /**
   * Campaigns_Challenges service.
   * @module api/Campaigns_ChallengesApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Campaigns_ChallengesApi. 
   * @alias module:api/Campaigns_ChallengesApi
   * @class
