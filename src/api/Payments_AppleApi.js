...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Payments_AppleApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ApplyPaymentRequest, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, ApplyPaymentRequest, Result) {
  'use strict';

  /**
   * Payments_Apple service.
   * @module api/Payments_AppleApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Payments_AppleApi. 
   * @alias module:api/Payments_AppleApi
   * @class
