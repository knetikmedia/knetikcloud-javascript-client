...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ARequestToResetAUsersPasswordByUsingAKnownUserProperty', 'model/NewPasswordRequest', 'model/PageResourceTemplateResource', 'model/PageResourceUserBaseResource', 'model/Result', 'model/TemplateResource', 'model/UserResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ARequestToResetAUsersPasswordByUsingAKnownUserProperty'), require('../model/NewPasswordRequest'), require('../model/PageResourceTemplateResource'), require('../model/PageResourceUserBaseResource'), require('../model/Result'), require('../model/TemplateResource'), require('../model/UserResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.UsersApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.ARequestToResetAUsersPasswordByUsingAKnownUserProperty, root.KnetikPlatformApiDocumentationLatest.NewPasswordRequest, root.KnetikPlatformApiDocumentationLatest.PageResourceTemplateResource, root.KnetikPlatformApiDocumentationLatest.PageResourceUserBaseResource, root.KnetikPlatformApiDocumentationLatest.Result, root.KnetikPlatformApiDocumentationLatest.TemplateResource, root.KnetikPlatformApiDocumentationLatest.UserResource);
  }
}(this, function(ApiClient, ARequestToResetAUsersPasswordByUsingAKnownUserProperty, NewPasswordRequest, PageResourceTemplateResource, PageResourceUserBaseResource, Result, TemplateResource, UserResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ARequestToResetAUsersPasswordByUsingAKnownUserProperty} opts.passwordReset An object containing one of three methods to look up a user
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
