...
export default class LogsApi {
    ...
    */
     ...
     */
    getBREEventLogsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = PageResourceBreEventLog;
     ...
     */
    getBREForwardLogWithHttpInfo(id) {
      let postBody = null;
     ...
     */
    getBREForwardLogsWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = PageResourceForwardLog;
    ...
    getUserLogsWithHttpInfo(opts) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = PageResourceUserActionLog;
