...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BreEventLog', 'model/ForwardLog', 'model/PageBreEventLog', 'model/PageForwardLog', 'model/PageUserActionLog', 'model/UserActionLog'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BreEventLog'), require('../model/ForwardLog'), require('../model/PageBreEventLog'), require('../model/PageForwardLog'), require('../model/PageUserActionLog'), require('../model/UserActionLog'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.LogsApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.BreEventLog, root.KnetikPlatformApiDocumentationLatest.ForwardLog, root.KnetikPlatformApiDocumentationLatest.PageBreEventLog, root.KnetikPlatformApiDocumentationLatest.PageForwardLog, root.KnetikPlatformApiDocumentationLatest.PageUserActionLog, root.KnetikPlatformApiDocumentationLatest.UserActionLog);
  }
}(this, function(ApiClient, BreEventLog, ForwardLog, PageBreEventLog, PageForwardLog, PageUserActionLog, UserActionLog) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageBreEventLog} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageBreEventLog}
     */
    this.getEventsLogsUsingGET = function(opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageBreEventLog;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageForwardLog} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageForwardLog}
     */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageUserActionLog} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageUserActionLog}
     */
    this.getUserLogsUsingGET1 = function(opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageUserActionLog;
