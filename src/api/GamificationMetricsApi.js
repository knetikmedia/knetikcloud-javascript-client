...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the addMetricUsingPOST operation.
     * @callback module:api/GamificationMetricsApi~addMetricUsingPOSTCallback
     ...
     * @param {module:api/GamificationMetricsApi~addMetricUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.addMetricUsingPOST = function(opts, callback) {
      opts = opts || {};
