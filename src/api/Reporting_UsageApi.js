...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Reporting_UsageApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceUsageInfo, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, PageResourceUsageInfo, Result) {
  'use strict';

  /**
   * Reporting_Usage service.
   * @module api/Reporting_UsageApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Reporting_UsageApi. 
   * @alias module:api/Reporting_UsageApi
   * @class
