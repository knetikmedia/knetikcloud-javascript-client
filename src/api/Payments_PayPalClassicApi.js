...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Payments_PayPalClassicApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.CreateBillingAgreementRequest, root.KnetikCloud.CreatePayPalPaymentRequest, root.KnetikCloud.FinalizeBillingAgreementRequest, root.KnetikCloud.FinalizePayPalPaymentRequest, root.KnetikCloud.Result);
  }
  ...
  /**
   * Payments_PayPalClassic service.
   * @module api/Payments_PayPalClassicApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Payments_PayPalClassicApi. 
   * @alias module:api/Payments_PayPalClassicApi
   * @class
