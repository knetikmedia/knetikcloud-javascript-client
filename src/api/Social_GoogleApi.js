...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Social_GoogleApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.GoogleToken, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, GoogleToken, Result) {
  'use strict';

  /**
   * Social_Google service.
   * @module api/Social_GoogleApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Social_GoogleApi. 
   * @alias module:api/Social_GoogleApi
   * @class
