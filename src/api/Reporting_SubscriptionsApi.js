...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Reporting_SubscriptionsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceBillingReport, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, PageResourceBillingReport, Result) {
  'use strict';

  /**
   * Reporting_Subscriptions service.
   * @module api/Reporting_SubscriptionsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Reporting_SubscriptionsApi. 
   * @alias module:api/Reporting_SubscriptionsApi
   * @class
