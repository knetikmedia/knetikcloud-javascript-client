...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Users_GroupsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ChatMessageRequest, root.KnetikCloud.ChatMessageResource, root.KnetikCloud.GroupMemberResource, root.KnetikCloud.GroupMemberStatusWrapper, root.KnetikCloud.GroupResource, root.KnetikCloud.PageResourceChatMessageResource, root.KnetikCloud.PageResourceGroupMemberResource, root.KnetikCloud.PageResourceGroupResource, root.KnetikCloud.PageResourceTemplateResource, root.KnetikCloud.Result, root.KnetikCloud.StringWrapper, root.KnetikCloud.TemplateResource, root.KnetikCloud.ValueWrapperboolean);
  }
  ...
  /**
   * Users_Groups service.
   * @module api/Users_GroupsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Users_GroupsApi. 
   * @alias module:api/Users_GroupsApi
   * @class
