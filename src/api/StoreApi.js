...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PageResourceStoreItem', 'model/PageResourceStoreItemTemplateResource', 'model/Result', 'model/StoreItem', 'model/StoreItemTemplateResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PageResourceStoreItem'), require('../model/PageResourceStoreItemTemplateResource'), require('../model/Result'), require('../model/StoreItem'), require('../model/StoreItemTemplateResource'));
  } else {
...
}(this, function(ApiClient, PageResourceStoreItem, PageResourceStoreItemTemplateResource, Result, StoreItem, StoreItemTemplateResource) {
  'use strict';
