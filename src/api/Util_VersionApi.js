...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Util_VersionApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Result, root.KnetikCloud.Version);
  }
}(this, function(ApiClient, Result, Version) {
  'use strict';

  /**
   * Util_Version service.
   * @module api/Util_VersionApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Util_VersionApi. 
   * @alias module:api/Util_VersionApi
   * @class
