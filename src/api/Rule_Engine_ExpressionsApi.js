...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Rule_Engine_ExpressionsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ExpressionResource, root.KnetikCloud.Result, root.KnetikCloud.StringWrapper);
  }
}(this, function(ApiClient, ExpressionResource, Result, StringWrapper) {
  'use strict';

  /**
   * Rule_Engine_Expressions service.
   * @module api/Rule_Engine_ExpressionsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Rule_Engine_ExpressionsApi. 
   * @alias module:api/Rule_Engine_ExpressionsApi
   * @class
