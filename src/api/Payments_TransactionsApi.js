...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Payments_TransactionsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceTransactionResource, root.KnetikCloud.RefundRequest, root.KnetikCloud.RefundResource, root.KnetikCloud.Result, root.KnetikCloud.TransactionResource);
  }
}(this, function(ApiClient, PageResourceTransactionResource, RefundRequest, RefundResource, Result, TransactionResource) {
  'use strict';

  /**
   * Payments_Transactions service.
   * @module api/Payments_TransactionsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Payments_TransactionsApi. 
   * @alias module:api/Payments_TransactionsApi
   * @class
