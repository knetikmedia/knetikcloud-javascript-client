...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Payments_FattMerchantApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.FattMerchantPaymentMethodRequest, root.KnetikCloud.PaymentMethodResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, FattMerchantPaymentMethodRequest, PaymentMethodResource, Result) {
  'use strict';

  /**
   * Payments_FattMerchant service.
   * @module api/Payments_FattMerchantApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Payments_FattMerchantApi. 
   * @alias module:api/Payments_FattMerchantApi
   * @class
