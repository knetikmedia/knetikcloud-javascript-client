...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Gamification_LevelingApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BreTriggerResource, root.KnetikCloud.IntWrapper, root.KnetikCloud.LevelingResource, root.KnetikCloud.PageResourceLevelingResource, root.KnetikCloud.PageResourceUserLevelingResource, root.KnetikCloud.Result, root.KnetikCloud.UserLevelingResource);
  }
  ...
  /**
   * Gamification_Leveling service.
   * @module api/Gamification_LevelingApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Gamification_LevelingApi. 
   * @alias module:api/Gamification_LevelingApi
   * @class
