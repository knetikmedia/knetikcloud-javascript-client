...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Users_RelationshipsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceUserRelationshipResource, root.KnetikCloud.Result, root.KnetikCloud.UserRelationshipResource);
  }
}(this, function(ApiClient, PageResourceUserRelationshipResource, Result, UserRelationshipResource) {
  'use strict';

  /**
   * Users_Relationships service.
   * @module api/Users_RelationshipsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Users_RelationshipsApi. 
   * @alias module:api/Users_RelationshipsApi
   * @class
