...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CommentResource', 'model/ContributionResource', 'model/DispositionResource', 'model/FlagResource', 'model/PageCommentResource', 'model/PageDispositionResource', 'model/PageVideoRelationshipResource', 'model/PageVideoResource', 'model/VideoRelationshipResource', 'model/VideoResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CommentResource'), require('../model/ContributionResource'), require('../model/DispositionResource'), require('../model/FlagResource'), require('../model/PageCommentResource'), require('../model/PageDispositionResource'), require('../model/PageVideoRelationshipResource'), require('../model/PageVideoResource'), require('../model/VideoRelationshipResource'), require('../model/VideoResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.MediaVideosApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.CommentResource, root.KnetikPlatformApiDocumentationLatest.ContributionResource, root.KnetikPlatformApiDocumentationLatest.DispositionResource, root.KnetikPlatformApiDocumentationLatest.FlagResource, root.KnetikPlatformApiDocumentationLatest.PageCommentResource, root.KnetikPlatformApiDocumentationLatest.PageDispositionResource, root.KnetikPlatformApiDocumentationLatest.PageVideoRelationshipResource, root.KnetikPlatformApiDocumentationLatest.PageVideoResource, root.KnetikPlatformApiDocumentationLatest.VideoRelationshipResource, root.KnetikPlatformApiDocumentationLatest.VideoResource);
  }
}(this, function(ApiClient, CommentResource, ContributionResource, DispositionResource, FlagResource, PageCommentResource, PageDispositionResource, PageVideoRelationshipResource, PageVideoResource, VideoRelationshipResource, VideoResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/MediaVideosApi~deleteRelationshipUsingDELETECallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MediaVideosApi~deleteRelationshipUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteRelationshipUsingDELETE = function(videoId, id, callback) {
      var postBody = null;

      // verify the required parameter 'videoId' is set
      if (videoId == undefined || videoId == null) {
        throw new Error("Missing the required parameter 'videoId' when calling deleteRelationshipUsingDELETE");
      }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageVideoRelationshipResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageVideoRelationshipResource}
     */
    this.getRelatedUsingGET = function(videoId, opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageVideoRelationshipResource;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageVideoResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageVideoResource}
     */
    this.getUserVideosUsingGET = function(userId, opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageVideoResource;
     ...
     * @callback module:api/MediaVideosApi~updateRelationshipUsingPUTCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MediaVideosApi~updateRelationshipUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updateRelationshipUsingPUT = function(videoId, relationshipId, opts, callback) {
      opts = opts || {};
      var postBody = opts['details'];

      // verify the required parameter 'videoId' is set
      if (videoId == undefined || videoId == null) {
        throw new Error("Missing the required parameter 'videoId' when calling updateRelationshipUsingPUT");
      }

      // verify the required parameter 'relationshipId' is set
      if (relationshipId == undefined || relationshipId == null) {
        throw new Error("Missing the required parameter 'relationshipId' when calling updateRelationshipUsingPUT");
      }
