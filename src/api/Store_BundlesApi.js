...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Store_BundlesApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BundleItem, root.KnetikCloud.ItemTemplateResource, root.KnetikCloud.PageResourceItemTemplateResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, BundleItem, ItemTemplateResource, PageResourceItemTemplateResource, Result) {
  'use strict';

  /**
   * Store_Bundles service.
   * @module api/Store_BundlesApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Store_BundlesApi. 
   * @alias module:api/Store_BundlesApi
   * @class
