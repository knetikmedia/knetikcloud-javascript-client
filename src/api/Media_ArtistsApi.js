...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Media_ArtistsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ArtistResource, root.KnetikCloud.PageResourceArtistResource, root.KnetikCloud.PageResourceTemplateResource, root.KnetikCloud.Result, root.KnetikCloud.TemplateResource);
  }
}(this, function(ApiClient, ArtistResource, PageResourceArtistResource, PageResourceTemplateResource, Result, TemplateResource) {
  'use strict';

  /**
   * Media_Artists service.
   * @module api/Media_ArtistsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Media_ArtistsApi. 
   * @alias module:api/Media_ArtistsApi
   * @class
