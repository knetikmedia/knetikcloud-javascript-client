...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Reporting_OrdersApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceAggregateInvoiceReportResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, PageResourceAggregateInvoiceReportResource, Result) {
  'use strict';

  /**
   * Reporting_Orders service.
   * @module api/Reporting_OrdersApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Reporting_OrdersApi. 
   * @alias module:api/Reporting_OrdersApi
   * @class
