...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Gamification_MetricsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.MetricResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, MetricResource, Result) {
  'use strict';

  /**
   * Gamification_Metrics service.
   * @module api/Gamification_MetricsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Gamification_MetricsApi. 
   * @alias module:api/Gamification_MetricsApi
   * @class
