...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PageResourceTopicResource', 'model/PageResourceTopicSubscriberResource', 'model/Result', 'model/TopicSubscriberResource', 'model/ValueWrapperboolean'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PageResourceTopicResource'), require('../model/PageResourceTopicSubscriberResource'), require('../model/Result'), require('../model/TopicSubscriberResource'), require('../model/ValueWrapperboolean'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.MessagingTopicsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceTopicResource, root.KnetikCloud.PageResourceTopicSubscriberResource, root.KnetikCloud.Result, root.KnetikCloud.TopicSubscriberResource, root.KnetikCloud.ValueWrapperboolean);
  }
}(this, function(ApiClient, PageResourceTopicResource, PageResourceTopicSubscriberResource, Result, TopicSubscriberResource, ValueWrapperboolean) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * &lt;b&gt;Permissions Needed:&lt;/b&gt; TOPICS_ADMIN
     * @param {String} id The id of the topic
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PageResourceTopicSubscriberResource} and HTTP response
     */
    this.getTopicSubscribersWithHttpInfo = function(id) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getTopicSubscribers");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = PageResourceTopicSubscriberResource;

      return this.apiClient.callApi(
        '/messaging/topics/{id}/subscribers', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * &lt;b&gt;Permissions Needed:&lt;/b&gt; TOPICS_ADMIN
     * @param {String} id The id of the topic
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PageResourceTopicSubscriberResource}
     */
    this.getTopicSubscribers = function(id) {
      return this.getTopicSubscribersWithHttpInfo(id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
