...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Users_FriendshipsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceSimpleUserResource, root.KnetikCloud.Result, root.KnetikCloud.StringWrapper);
  }
}(this, function(ApiClient, PageResourceSimpleUserResource, Result, StringWrapper) {
  'use strict';

  /**
   * Users_Friendships service.
   * @module api/Users_FriendshipsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Users_FriendshipsApi. 
   * @alias module:api/Users_FriendshipsApi
   * @class
