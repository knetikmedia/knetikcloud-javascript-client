...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Auth_ClientsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ClientResource, root.KnetikCloud.GrantTypeResource, root.KnetikCloud.PageResourceClientResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, ClientResource, GrantTypeResource, PageResourceClientResource, Result) {
  'use strict';

  /**
   * Auth_Clients service.
   * @module api/Auth_ClientsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Auth_ClientsApi. 
   * @alias module:api/Auth_ClientsApi
   * @class
