...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Auth_RolesApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ClientResource, root.KnetikCloud.PageResourceRoleResource, root.KnetikCloud.Result, root.KnetikCloud.RoleResource, root.KnetikCloud.UserResource);
  }
  ...
  /**
   * Auth_Roles service.
   * @module api/Auth_RolesApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Auth_RolesApi. 
   * @alias module:api/Auth_RolesApi
   * @class
