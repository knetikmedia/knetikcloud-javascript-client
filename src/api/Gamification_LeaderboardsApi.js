...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Gamification_LeaderboardsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.LeaderboardEntryResource, root.KnetikCloud.LeaderboardResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, LeaderboardEntryResource, LeaderboardResource, Result) {
  'use strict';

  /**
   * Gamification_Leaderboards service.
   * @module api/Gamification_LeaderboardsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Gamification_LeaderboardsApi. 
   * @alias module:api/Gamification_LeaderboardsApi
   * @class
