...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Util_SecurityApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceLocationLogResource, root.KnetikCloud.Result, root.KnetikCloud.TokenDetailsResource);
  }
}(this, function(ApiClient, PageResourceLocationLogResource, Result, TokenDetailsResource) {
  'use strict';

  /**
   * Util_Security service.
   * @module api/Util_SecurityApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Util_SecurityApi. 
   * @alias module:api/Util_SecurityApi
   * @class
