...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Social_FacebookApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.FacebookToken, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, FacebookToken, Result) {
  'use strict';

  /**
   * Social_Facebook service.
   * @module api/Social_FacebookApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Social_FacebookApi. 
   * @alias module:api/Social_FacebookApi
   * @class
