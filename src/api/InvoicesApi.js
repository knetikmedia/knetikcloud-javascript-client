...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressResource', 'model/InvoiceCreateRequest', 'model/InvoicePaymentStatusRequest', 'model/InvoiceResource', 'model/ModelObject', 'model/PageResourceInvoiceLogEntry', 'model/PageResourceInvoiceResource', 'model/PayBySavedMethodRequest', 'model/Result'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AddressResource'), require('../model/InvoiceCreateRequest'), require('../model/InvoicePaymentStatusRequest'), require('../model/InvoiceResource'), require('../model/ModelObject'), require('../model/PageResourceInvoiceLogEntry'), require('../model/PageResourceInvoiceResource'), require('../model/PayBySavedMethodRequest'), require('../model/Result'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.InvoicesApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.AddressResource, root.KnetikPlatformApiDocumentationLatest.InvoiceCreateRequest, root.KnetikPlatformApiDocumentationLatest.InvoicePaymentStatusRequest, root.KnetikPlatformApiDocumentationLatest.InvoiceResource, root.KnetikPlatformApiDocumentationLatest.ModelObject, root.KnetikPlatformApiDocumentationLatest.PageResourceInvoiceLogEntry, root.KnetikPlatformApiDocumentationLatest.PageResourceInvoiceResource, root.KnetikPlatformApiDocumentationLatest.PayBySavedMethodRequest, root.KnetikPlatformApiDocumentationLatest.Result);
  }
}(this, function(ApiClient, AddressResource, InvoiceCreateRequest, InvoicePaymentStatusRequest, InvoiceResource, ModelObject, PageResourceInvoiceLogEntry, PageResourceInvoiceResource, PayBySavedMethodRequest, Result) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/ModelObject} opts.filterVendorIds Filters invoices for ones from one of the vendors whose id is in the given comma separated list
