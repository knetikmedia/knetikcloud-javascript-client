...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressResource', 'model/InvoiceCreateRequest', 'model/InvoicePaymentStatusRequest', 'model/InvoiceResource', 'model/PageInvoiceLogEntry', 'model/PageInvoiceResource', 'model/PayBySavedMethodRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AddressResource'), require('../model/InvoiceCreateRequest'), require('../model/InvoicePaymentStatusRequest'), require('../model/InvoiceResource'), require('../model/PageInvoiceLogEntry'), require('../model/PageInvoiceResource'), require('../model/PayBySavedMethodRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.InvoicesApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.AddressResource, root.KnetikPlatformApiDocumentationLatest.InvoiceCreateRequest, root.KnetikPlatformApiDocumentationLatest.InvoicePaymentStatusRequest, root.KnetikPlatformApiDocumentationLatest.InvoiceResource, root.KnetikPlatformApiDocumentationLatest.PageInvoiceLogEntry, root.KnetikPlatformApiDocumentationLatest.PageInvoiceResource, root.KnetikPlatformApiDocumentationLatest.PayBySavedMethodRequest);
  }
}(this, function(ApiClient, AddressResource, InvoiceCreateRequest, InvoicePaymentStatusRequest, InvoiceResource, PageInvoiceLogEntry, PageInvoiceResource, PayBySavedMethodRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageInvoiceResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.filterCreatedDate Filters invoices by creation date. Multiple values possible for range search. Format: filter_date_created&#x3D;OP,ts&amp;... where OP in (GT, LT, GOE, LOE, EQ) and ts is a unix timestamp in seconds. Ex: filter_date_created&#x3D;GT,1452154258&amp;filter_date_created&#x3D;LT,1554254874
     ...
     * data is of type: {@link module:model/PageInvoiceResource}
     */
    this.getInvoiceHistoryUsingGET = function(opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageInvoiceResource;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageInvoiceLogEntry} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageInvoiceLogEntry}
     */
    this.getLogsUsingGET = function(id, opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageInvoiceLogEntry;
