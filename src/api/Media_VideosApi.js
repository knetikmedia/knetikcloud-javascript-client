...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Media_VideosApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.CommentResource, root.KnetikCloud.ContributionResource, root.KnetikCloud.DispositionResource, root.KnetikCloud.FlagResource, root.KnetikCloud.IntWrapper, root.KnetikCloud.PageResourceCommentResource, root.KnetikCloud.PageResourceDispositionResource, root.KnetikCloud.PageResourceTemplateResource, root.KnetikCloud.PageResourceVideoRelationshipResource, root.KnetikCloud.PageResourceVideoResource, root.KnetikCloud.Result, root.KnetikCloud.StringWrapper, root.KnetikCloud.TemplateResource, root.KnetikCloud.VideoRelationshipResource, root.KnetikCloud.VideoResource);
  }
  ...
  /**
   * Media_Videos service.
   * @module api/Media_VideosApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Media_VideosApi. 
   * @alias module:api/Media_VideosApi
   * @class
