...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EntitlementItem', 'model/InvoiceResource', 'model/ItemTemplateResource', 'model/PageResourceEntitlementItem', 'model/PageResourceItemTemplateResource', 'model/PageResourceUserInventoryResource', 'model/PageResourceUserItemLogResource', 'model/UserInventoryAddRequest', 'model/UserInventoryResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/EntitlementItem'), require('../model/InvoiceResource'), require('../model/ItemTemplateResource'), require('../model/PageResourceEntitlementItem'), require('../model/PageResourceItemTemplateResource'), require('../model/PageResourceUserInventoryResource'), require('../model/PageResourceUserItemLogResource'), require('../model/UserInventoryAddRequest'), require('../model/UserInventoryResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.UsersInventoryApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.EntitlementItem, root.KnetikPlatformApiDocumentationLatest.InvoiceResource, root.KnetikPlatformApiDocumentationLatest.ItemTemplateResource, root.KnetikPlatformApiDocumentationLatest.PageResourceEntitlementItem, root.KnetikPlatformApiDocumentationLatest.PageResourceItemTemplateResource, root.KnetikPlatformApiDocumentationLatest.PageResourceUserInventoryResource, root.KnetikPlatformApiDocumentationLatest.PageResourceUserItemLogResource, root.KnetikPlatformApiDocumentationLatest.UserInventoryAddRequest, root.KnetikPlatformApiDocumentationLatest.UserInventoryResource);
  }
}(this, function(ApiClient, EntitlementItem, InvoiceResource, ItemTemplateResource, PageResourceEntitlementItem, PageResourceItemTemplateResource, PageResourceUserInventoryResource, PageResourceUserItemLogResource, UserInventoryAddRequest, UserInventoryResource) {
  'use strict';
