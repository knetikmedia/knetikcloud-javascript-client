...
(function(root, factory) {
...
}(this, function(ApiClient, EntitlementGrantRequest, EntitlementItem, InvoiceResource, ItemTemplateResource, PageResourceEntitlementItem, PageResourceItemTemplateResource, PageResourceUserInventoryResource, PageResourceUserItemLogResource, UserInventoryAddRequest, UserInventoryResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the grantEntitlementUsingPOST operation.
     * @callback module:api/UsersInventoryApi~grantEntitlementUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UsersInventoryApi~grantEntitlementUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.grantEntitlementUsingPOST = function(userId, grantRequest, callback) {
      var postBody = grantRequest;

      // verify the required parameter 'userId' is set
      if (userId == undefined || userId == null) {
        throw new Error("Missing the required parameter 'userId' when calling grantEntitlementUsingPOST");
      }

      // verify the required parameter 'grantRequest' is set
      if (grantRequest == undefined || grantRequest == null) {
        throw new Error("Missing the required parameter 'grantRequest' when calling grantEntitlementUsingPOST");
      }
