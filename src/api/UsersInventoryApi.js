...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getUserInventory1 operation.
     * @callback module:api/UsersInventoryApi~getUserInventory1Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsersInventoryApi~getUserInventory1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PageResourceUserInventoryResource}
     */
    this.getUserInventory1 = function(id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw new Error("Missing the required parameter 'id' when calling getUserInventory1");
      }
    ...
    /**
     * Callback function to receive the result of the getUserInventoryLog1 operation.
     * @callback module:api/UsersInventoryApi~getUserInventoryLog1Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UsersInventoryApi~getUserInventoryLog1Callback} callback The callback function, accepting three arguments: error, data, response
     */
    this.getUserInventoryLog1 = function(userId, id, opts, callback) {
      opts = opts || {};
      var postBody = opts['timestamp'];

      // verify the required parameter 'userId' is set
      if (userId == undefined || userId == null) {
        throw new Error("Missing the required parameter 'userId' when calling getUserInventoryLog1");
      }

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw new Error("Missing the required parameter 'id' when calling getUserInventoryLog1");
      }
