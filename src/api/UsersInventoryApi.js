...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EntitlementItem', 'model/InvoiceResource', 'model/ItemTemplateResource', 'model/PageEntitlementItem', 'model/PageItemTemplateResource', 'model/PageUserInventoryResource', 'model/PageUserItemLogResource', 'model/UserInventoryAddRequest', 'model/UserInventoryResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/EntitlementItem'), require('../model/InvoiceResource'), require('../model/ItemTemplateResource'), require('../model/PageEntitlementItem'), require('../model/PageItemTemplateResource'), require('../model/PageUserInventoryResource'), require('../model/PageUserItemLogResource'), require('../model/UserInventoryAddRequest'), require('../model/UserInventoryResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.UsersInventoryApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.EntitlementItem, root.KnetikPlatformApiDocumentationLatest.InvoiceResource, root.KnetikPlatformApiDocumentationLatest.ItemTemplateResource, root.KnetikPlatformApiDocumentationLatest.PageEntitlementItem, root.KnetikPlatformApiDocumentationLatest.PageItemTemplateResource, root.KnetikPlatformApiDocumentationLatest.PageUserInventoryResource, root.KnetikPlatformApiDocumentationLatest.PageUserItemLogResource, root.KnetikPlatformApiDocumentationLatest.UserInventoryAddRequest, root.KnetikPlatformApiDocumentationLatest.UserInventoryResource);
  }
}(this, function(ApiClient, EntitlementItem, InvoiceResource, ItemTemplateResource, PageEntitlementItem, PageItemTemplateResource, PageUserInventoryResource, PageUserItemLogResource, UserInventoryAddRequest, UserInventoryResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createTemplateUsingPOST3 operation.
     * @callback module:api/UsersInventoryApi~createTemplateUsingPOST3Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsersInventoryApi~createTemplateUsingPOST3Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ItemTemplateResource}
     */
    this.createTemplateUsingPOST3 = function(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the deleteEntitlementTemplateUsingDELETE operation.
     * @callback module:api/UsersInventoryApi~deleteEntitlementTemplateUsingDELETECallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsersInventoryApi~deleteEntitlementTemplateUsingDELETECallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteEntitlementTemplateUsingDELETE = function(id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw new Error("Missing the required parameter 'id' when calling deleteEntitlementTemplateUsingDELETE");
      }
    ...
    /**
     * Callback function to receive the result of the getEntitlementTemplateUsingGET operation.
     * @callback module:api/UsersInventoryApi~getEntitlementTemplateUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ItemTemplateResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} id The id of the template
     * @param {module:api/UsersInventoryApi~getEntitlementTemplateUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ItemTemplateResource}
     */
    this.getEntitlementTemplateUsingGET = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw new Error("Missing the required parameter 'id' when calling getEntitlementTemplateUsingGET");
      }
    ...
    /**
     * Callback function to receive the result of the getEntitlementTemplatesUsingGET operation.
     * @callback module:api/UsersInventoryApi~getEntitlementTemplatesUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} opts.page The number of the page returned, starting with 1 (default to 1)
     * @param {String} opts.order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (default to id:ASC)
     * @param {module:api/UsersInventoryApi~getEntitlementTemplatesUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PageItemTemplateResource}
     */
    this.getEntitlementTemplatesUsingGET = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the updateTemplateUsingPUT3 operation.
     * @callback module:api/UsersInventoryApi~updateTemplateUsingPUT3Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/UsersInventoryApi~updateTemplateUsingPUT3Callback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updateTemplateUsingPUT3 = function(id, opts, callback) {
      opts = opts || {};
      var postBody = opts['template'];

      // verify the required parameter 'id' is set
      if (id == undefined || id == null) {
        throw new Error("Missing the required parameter 'id' when calling updateTemplateUsingPUT3");
      }
