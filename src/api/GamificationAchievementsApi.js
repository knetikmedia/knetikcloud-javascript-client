...
(function(root, factory) {
...
}(this, function(ApiClient, AchievementDefinitionResource, AchievementProgressUpdateRequest, BreTriggerResource, PageResourceAchievementDefinitionResource, PageResourceTemplateResource, PageResourceUserAchievementGroupResource, Result, TemplateResource, UserAchievementGroupResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the updateAchievementProgress operation.
     * @callback module:api/GamificationAchievementsApi~updateAchievementProgressCallback
     * @param {String} error Error message, if any.
     * @param {module:model/UserAchievementGroupResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/GamificationAchievementsApi~updateAchievementProgressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/UserAchievementGroupResource}
     */
    this.updateAchievementProgress = function(userId, achievementName, opts, callback) {
      opts = opts || {};
      var postBody = opts['request'];

      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling updateAchievementProgress");
      }

      // verify the required parameter 'achievementName' is set
      if (achievementName === undefined || achievementName === null) {
        throw new Error("Missing the required parameter 'achievementName' when calling updateAchievementProgress");
      }
