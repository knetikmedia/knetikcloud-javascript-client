...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AchievementDefinitionResource', 'model/AchievementProgressUpdateRequest', 'model/BreTriggerResource', 'model/PageAchievementDefinitionResource', 'model/PageTemplateResource', 'model/PageUserAchievementResource', 'model/TemplateResource', 'model/UserAchievementResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AchievementDefinitionResource'), require('../model/AchievementProgressUpdateRequest'), require('../model/BreTriggerResource'), require('../model/PageAchievementDefinitionResource'), require('../model/PageTemplateResource'), require('../model/PageUserAchievementResource'), require('../model/TemplateResource'), require('../model/UserAchievementResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.GamificationAchievementsApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.AchievementDefinitionResource, root.KnetikPlatformApiDocumentationLatest.AchievementProgressUpdateRequest, root.KnetikPlatformApiDocumentationLatest.BreTriggerResource, root.KnetikPlatformApiDocumentationLatest.PageAchievementDefinitionResource, root.KnetikPlatformApiDocumentationLatest.PageTemplateResource, root.KnetikPlatformApiDocumentationLatest.PageUserAchievementResource, root.KnetikPlatformApiDocumentationLatest.TemplateResource, root.KnetikPlatformApiDocumentationLatest.UserAchievementResource);
  }
}(this, function(ApiClient, AchievementDefinitionResource, AchievementProgressUpdateRequest, BreTriggerResource, PageAchievementDefinitionResource, PageTemplateResource, PageUserAchievementResource, TemplateResource, UserAchievementResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageUserAchievementResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageUserAchievementResource}
     */
    this.getAllUserProgressForAchievementUsingGET = function(achievementName, opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageUserAchievementResource;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/UserAchievementResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/UserAchievementResource}
     */
    this.getUserProgressForAchievementUsingGET = function(userId, achievementName, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = UserAchievementResource;
