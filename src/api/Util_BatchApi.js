...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Util_BatchApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Batch, root.KnetikCloud.BatchResult, root.KnetikCloud.BatchReturn, root.KnetikCloud.Result);
  }
  ...
  /**
   * Util_Batch service.
   * @module api/Util_BatchApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Util_BatchApi. 
   * @alias module:api/Util_BatchApi
   * @class
