...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Auth_PermissionsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourcePermissionResource, root.KnetikCloud.PermissionResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, PageResourcePermissionResource, PermissionResource, Result) {
  'use strict';

  /**
   * Auth_Permissions service.
   * @module api/Auth_PermissionsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Auth_PermissionsApi. 
   * @alias module:api/Auth_PermissionsApi
   * @class
