...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AnswerResource', 'model/Collectionstring', 'model/DeltaResource', 'model/ImportJobResource', 'model/PageResourceImportJobResource', 'model/PageResourceQuestionResource', 'model/PageResourceQuestionTemplateResource', 'model/QuestionResource', 'model/QuestionTemplateResource', 'model/Result', 'model/StringWrapper'], factory);
