...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/LocationsApi~getCitiesCallback
     ...
     * @param {module:api/LocationsApi~getCitiesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CityResource>}
     */
    this.getCities = function(countryCodeIso3, stateCode, callback) {
      var postBody = null;

      // verify the required parameter 'countryCodeIso3' is set
      if (countryCodeIso3 == undefined || countryCodeIso3 == null) {
        throw new Error("Missing the required parameter 'countryCodeIso3' when calling getCities");
      }

      // verify the required parameter 'stateCode' is set
      if (stateCode == undefined || stateCode == null) {
        throw new Error("Missing the required parameter 'stateCode' when calling getCities");
      }
    ...
    /**
     * Callback function to receive the result of the getCountries1 operation.
     * @callback module:api/LocationsApi~getCountries1Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/LocationsApi~getCountries1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CountryResource>}
     */
    this.getCountries1 = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the getCountries2 operation.
     * @callback module:api/LocationsApi~getCountries2Callback
     * @param {String} error Error message, if any.
     ...
     * @param {String} countryCodeIso3 The iso3 code of the country
     * @param {module:api/LocationsApi~getCountries2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/StateResource>}
     */
    this.getCountries2 = function(countryCodeIso3, callback) {
      var postBody = null;

      // verify the required parameter 'countryCodeIso3' is set
      if (countryCodeIso3 == undefined || countryCodeIso3 == null) {
        throw new Error("Missing the required parameter 'countryCodeIso3' when calling getCountries2");
      }
