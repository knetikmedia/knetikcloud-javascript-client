...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Store_ShippingApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ItemTemplateResource, root.KnetikCloud.PageResourceItemTemplateResource, root.KnetikCloud.Result, root.KnetikCloud.ShippingItem);
  }
}(this, function(ApiClient, ItemTemplateResource, PageResourceItemTemplateResource, Result, ShippingItem) {
  'use strict';

  /**
   * Store_Shipping service.
   * @module api/Store_ShippingApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Store_ShippingApi. 
   * @alias module:api/Store_ShippingApi
   * @class
