...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ChallengeActivityResource', 'model/ChallengeEventResource', 'model/ChallengeResource', 'model/PageBareChallengeActivityResource', 'model/PageChallengeEventResource', 'model/PageChallengeResource', 'model/PageTemplateResource', 'model/TemplateResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ChallengeActivityResource'), require('../model/ChallengeEventResource'), require('../model/ChallengeResource'), require('../model/PageBareChallengeActivityResource'), require('../model/PageChallengeEventResource'), require('../model/PageChallengeResource'), require('../model/PageTemplateResource'), require('../model/TemplateResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.CampaignsChallengesApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.ChallengeActivityResource, root.KnetikPlatformApiDocumentationLatest.ChallengeEventResource, root.KnetikPlatformApiDocumentationLatest.ChallengeResource, root.KnetikPlatformApiDocumentationLatest.PageBareChallengeActivityResource, root.KnetikPlatformApiDocumentationLatest.PageChallengeEventResource, root.KnetikPlatformApiDocumentationLatest.PageChallengeResource, root.KnetikPlatformApiDocumentationLatest.PageTemplateResource, root.KnetikPlatformApiDocumentationLatest.TemplateResource);
  }
}(this, function(ApiClient, ChallengeActivityResource, ChallengeEventResource, ChallengeResource, PageBareChallengeActivityResource, PageChallengeEventResource, PageChallengeResource, PageTemplateResource, TemplateResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageBareChallengeActivityResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageBareChallengeActivityResource}
     */
    this.getActivitiesUsingGET1 = function(challengeId, opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageBareChallengeActivityResource;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageChallengeEventResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.filterStartDateMin events starting after this date, unix timestamp in seconds
     * @param {Number} opts.filterStartDateMax events starting before this date, unix timestamp in seconds
     * @param {Number} opts.filterEndDateMin events ending after this date, unix timestamp in seconds
     * @param {Number} opts.filterEndDateMax events ending before this date, unix timestamp in seconds
     ...
     * data is of type: {@link module:model/PageChallengeEventResource}
     */
    this.getChallengeEventssUsingGET = function(opts, callback) {
      ...
      var queryParams = {
        'filter_start_date_min': opts['filterStartDateMin'],
        'filter_start_date_max': opts['filterStartDateMax'],
        'filter_end_date_min': opts['filterEndDateMin'],
        'filter_end_date_max': opts['filterEndDateMax'],
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageChallengeEventResource;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageChallengeResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageChallengeResource}
     */
    this.getChallengesUsingGET1 = function(opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageChallengeResource;
