...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Rule_Engine_EventsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BreEvent, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, BreEvent, Result) {
  'use strict';

  /**
   * Rule_Engine_Events service.
   * @module api/Rule_Engine_EventsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Rule_Engine_EventsApi. 
   * @alias module:api/Rule_Engine_EventsApi
   * @class
