...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikPlatformApiDocumentationLatest.UtilVersionApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.Version);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/UtilVersionApi~getUsingGET3Callback
     ...
     * @param {module:api/UtilVersionApi~getUsingGET3Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Version}
     */
    this.getUsingGET3 = function(callback) {
      var postBody = null;
