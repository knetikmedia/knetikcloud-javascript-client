...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BreTriggerResource', 'model/LevelingResource', 'model/PageLevelingResource', 'model/PageUserLevelingResource', 'model/UserLevelingResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BreTriggerResource'), require('../model/LevelingResource'), require('../model/PageLevelingResource'), require('../model/PageUserLevelingResource'), require('../model/UserLevelingResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.GamificationLevelingApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.BreTriggerResource, root.KnetikPlatformApiDocumentationLatest.LevelingResource, root.KnetikPlatformApiDocumentationLatest.PageLevelingResource, root.KnetikPlatformApiDocumentationLatest.PageUserLevelingResource, root.KnetikPlatformApiDocumentationLatest.UserLevelingResource);
  }
}(this, function(ApiClient, BreTriggerResource, LevelingResource, PageLevelingResource, PageUserLevelingResource, UserLevelingResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageLevelingResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageLevelingResource}
     */
    this.getLevelsUsingGET = function(opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageLevelingResource;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PageUserLevelingResource} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PageUserLevelingResource}
     */
    this.getUserLevelsUsingGET = function(userId, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['*/*'];
      var returnType = PageUserLevelingResource;
