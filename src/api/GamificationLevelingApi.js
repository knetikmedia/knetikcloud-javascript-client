...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getUserLevels = function(userId, callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the updateUserLevel operation.
     * @callback module:api/GamificationLevelingApi~updateUserLevelCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/GamificationLevelingApi~updateUserLevelCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updateUserLevel = function(userId, name, opts, callback) {
      opts = opts || {};
      var postBody = opts['progress'];

      // verify the required parameter 'userId' is set
      if (userId == undefined || userId == null) {
        throw new Error("Missing the required parameter 'userId' when calling updateUserLevel");
      }

      // verify the required parameter 'name' is set
      if (name == undefined || name == null) {
        throw new Error("Missing the required parameter 'name' when calling updateUserLevel");
      }
