...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Payments_StripeApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PaymentMethodResource, root.KnetikCloud.Result, root.KnetikCloud.StripeCreatePaymentMethod, root.KnetikCloud.StripePaymentRequest);
  }
}(this, function(ApiClient, PaymentMethodResource, Result, StripeCreatePaymentMethod, StripePaymentRequest) {
  'use strict';

  /**
   * Payments_Stripe service.
   * @module api/Payments_StripeApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Payments_StripeApi. 
   * @alias module:api/Payments_StripeApi
   * @class
