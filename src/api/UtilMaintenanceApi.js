...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the updateMaintenance1 operation.
     * @callback module:api/UtilMaintenanceApi~updateMaintenance1Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/Maintenance} opts.maintenance The maintenance object
     * @param {module:api/UtilMaintenanceApi~updateMaintenance1Callback} callback The callback function, accepting three arguments: error, data, response
     */
    this.updateMaintenance1 = function(opts, callback) {
      opts = opts || {};
      var postBody = opts['maintenance'];
