...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PageUsageInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PageUsageInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.ReportingUsageApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.PageUsageInfo);
  }
}(this, function(ApiClient, PageUsageInfo) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/PageUsageInfo} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/PageUsageInfo}
     */
