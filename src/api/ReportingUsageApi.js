...
* @version 3.0.7
*/
export default class ReportingUsageApi {
    ...
    */
     ...
     */
    getUsageByDayWithHttpInfo(startDate, endDate, opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = PageResourceUsageInfo;
     ...
     */
    getUsageByDay(startDate, endDate, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PageResourceUsageInfo} and HTTP response
     */
    getUsageByHourWithHttpInfo(startDate, endDate, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PageResourceUsageInfo}
     */
    getUsageByHour(startDate, endDate, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PageResourceUsageInfo} and HTTP response
     */
    getUsageByMinuteWithHttpInfo(startDate, endDate, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PageResourceUsageInfo}
     */
    getUsageByMinute(startDate, endDate, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PageResourceUsageInfo} and HTTP response
     */
    getUsageByMonthWithHttpInfo(startDate, endDate, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PageResourceUsageInfo}
     */
    getUsageByMonth(startDate, endDate, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PageResourceUsageInfo} and HTTP response
     */
    getUsageByYearWithHttpInfo(startDate, endDate, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PageResourceUsageInfo}
     */
    getUsageByYear(startDate, endDate, opts) {
     ...
     */
    getUsageEndpointsWithHttpInfo(startDate, endDate) {
      let postBody = null;
     ...
     */
    getUsageEndpoints(startDate, endDate) {
