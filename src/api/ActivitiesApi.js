...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings', 'model/ActivityOccurrenceCreationFailure', 'model/ActivityOccurrenceResults', 'model/ActivityOccurrenceResultsResource', 'model/PageResourceBareActivityResource', 'model/PageResourceTemplateResource', 'model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc', 'model/Result', 'model/TemplateResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings'), require('../model/ActivityOccurrenceCreationFailure'), require('../model/ActivityOccurrenceResults'), require('../model/ActivityOccurrenceResultsResource'), require('../model/PageResourceBareActivityResource'), require('../model/PageResourceTemplateResource'), require('../model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc'), require('../model/Result'), require('../model/TemplateResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.ActivitiesApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings, root.KnetikPlatformApiDocumentationLatest.ActivityOccurrenceCreationFailure, root.KnetikPlatformApiDocumentationLatest.ActivityOccurrenceResults, root.KnetikPlatformApiDocumentationLatest.ActivityOccurrenceResultsResource, root.KnetikPlatformApiDocumentationLatest.PageResourceBareActivityResource, root.KnetikPlatformApiDocumentationLatest.PageResourceTemplateResource, root.KnetikPlatformApiDocumentationLatest.RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc, root.KnetikPlatformApiDocumentationLatest.Result, root.KnetikPlatformApiDocumentationLatest.TemplateResource);
  }
}(this, function(ApiClient, AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings, ActivityOccurrenceCreationFailure, ActivityOccurrenceResults, ActivityOccurrenceResultsResource, PageResourceBareActivityResource, PageResourceTemplateResource, RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc, Result, TemplateResource) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc} opts.activityResource The activity resource object
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc} and HTTP response
     */
    this.createActivityWithHttpInfo = function(opts) {
      ...
      var returnType = RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc;
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc} opts.activityResource The activity resource object
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc}
     */
     ...
     * @param {module:model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings} opts.activityOccurrenceResource The activity occurrence object
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings} and HTTP response
     */
    this.createActivityOccurrenceWithHttpInfo = function(opts) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings;
     ...
     * @param {Boolean} opts.test if true, indicates that the occurrence should NOT be created. This can be used to test for eligibility and valid settings (default to false)
     * @param {module:model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings} opts.activityOccurrenceResource The activity occurrence object
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings}
     */
