...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ActivityOccurrenceCreationFailure', 'model/ActivityOccurrenceResource', 'model/ActivityOccurrenceResults', 'model/ActivityResource', 'model/PageResourceBareActivityResource', 'model/Result'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ActivityOccurrenceCreationFailure'), require('../model/ActivityOccurrenceResource'), require('../model/ActivityOccurrenceResults'), require('../model/ActivityResource'), require('../model/PageResourceBareActivityResource'), require('../model/Result'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.ActivitiesApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.ActivityOccurrenceCreationFailure, root.KnetikPlatformApiDocumentationLatest.ActivityOccurrenceResource, root.KnetikPlatformApiDocumentationLatest.ActivityOccurrenceResults, root.KnetikPlatformApiDocumentationLatest.ActivityResource, root.KnetikPlatformApiDocumentationLatest.PageResourceBareActivityResource, root.KnetikPlatformApiDocumentationLatest.Result);
  }
}(this, function(ApiClient, ActivityOccurrenceCreationFailure, ActivityOccurrenceResource, ActivityOccurrenceResults, ActivityResource, PageResourceBareActivityResource, Result) {
  'use strict';
