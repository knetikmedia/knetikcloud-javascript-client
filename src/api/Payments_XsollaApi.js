...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Payments_XsollaApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Result, root.KnetikCloud.XsollaPaymentRequest);
  }
}(this, function(ApiClient, Result, XsollaPaymentRequest) {
  'use strict';

  /**
   * Payments_Xsolla service.
   * @module api/Payments_XsollaApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Payments_XsollaApi. 
   * @alias module:api/Payments_XsollaApi
   * @class
