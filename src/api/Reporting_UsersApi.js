...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Reporting_UsersApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceAggregateCountResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, PageResourceAggregateCountResource, Result) {
  'use strict';

  /**
   * Reporting_Users service.
   * @module api/Reporting_UsersApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Reporting_UsersApi. 
   * @alias module:api/Reporting_UsersApi
   * @class
