...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PageResourceSimpleWallet', 'model/PageResourceWalletTotalResponse', 'model/PageResourceWalletTransactionResource', 'model/SimpleWallet', 'model/WalletAlterRequest', 'model/WalletTransactionResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PageResourceSimpleWallet'), require('../model/PageResourceWalletTotalResponse'), require('../model/PageResourceWalletTransactionResource'), require('../model/SimpleWallet'), require('../model/WalletAlterRequest'), require('../model/WalletTransactionResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.PaymentsWalletsApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.PageResourceSimpleWallet, root.KnetikPlatformApiDocumentationLatest.PageResourceWalletTotalResponse, root.KnetikPlatformApiDocumentationLatest.PageResourceWalletTransactionResource, root.KnetikPlatformApiDocumentationLatest.SimpleWallet, root.KnetikPlatformApiDocumentationLatest.WalletAlterRequest, root.KnetikPlatformApiDocumentationLatest.WalletTransactionResource);
  }
}(this, function(ApiClient, PageResourceSimpleWallet, PageResourceWalletTotalResponse, PageResourceWalletTransactionResource, SimpleWallet, WalletAlterRequest, WalletTransactionResource) {
  'use strict';
