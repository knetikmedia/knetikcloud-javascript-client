...
(function(root, factory) {
  ...
  /**
   * Users_Inventory service.
   * @module api/Users_InventoryApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Users_InventoryApi. 
   * @alias module:api/Users_InventoryApi
   * @class
