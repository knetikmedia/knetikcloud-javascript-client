...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Rule_Engine_GlobalsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BreGlobalResource, root.KnetikCloud.PageResourceBreGlobalResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, BreGlobalResource, PageResourceBreGlobalResource, Result) {
  'use strict';

  /**
   * Rule_Engine_Globals service.
   * @module api/Rule_Engine_GlobalsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Rule_Engine_GlobalsApi. 
   * @alias module:api/Rule_Engine_GlobalsApi
   * @class
