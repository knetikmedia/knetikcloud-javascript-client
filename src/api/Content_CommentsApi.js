...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Content_CommentsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.CommentResource, root.KnetikCloud.PageResourceCommentResource, root.KnetikCloud.Result, root.KnetikCloud.StringWrapper);
  }
}(this, function(ApiClient, CommentResource, PageResourceCommentResource, Result, StringWrapper) {
  'use strict';

  /**
   * Content_Comments service.
   * @module api/Content_CommentsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Content_CommentsApi. 
   * @alias module:api/Content_CommentsApi
   * @class
