...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Reporting_ChallengesApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceChallengeEventParticipantResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, PageResourceChallengeEventParticipantResource, Result) {
  'use strict';

  /**
   * Reporting_Challenges service.
   * @module api/Reporting_ChallengesApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Reporting_ChallengesApi. 
   * @alias module:api/Reporting_ChallengesApi
   * @class
