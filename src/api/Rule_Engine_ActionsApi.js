...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Rule_Engine_ActionsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ActionResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, ActionResource, Result) {
  'use strict';

  /**
   * Rule_Engine_Actions service.
   * @module api/Rule_Engine_ActionsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Rule_Engine_ActionsApi. 
   * @alias module:api/Rule_Engine_ActionsApi
   * @class
