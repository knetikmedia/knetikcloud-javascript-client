...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BreGlobalResource', 'model/PageResourceBreGlobalResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BreGlobalResource'), require('../model/PageResourceBreGlobalResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.BRERuleEngineGlobalsApi = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.BreGlobalResource, root.KnetikPlatformApiDocumentationLatest.PageResourceBreGlobalResource);
  }
}(this, function(ApiClient, BreGlobalResource, PageResourceBreGlobalResource) {
  'use strict';
