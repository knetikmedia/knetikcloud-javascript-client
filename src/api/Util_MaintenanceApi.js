...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Util_MaintenanceApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Maintenance, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, Maintenance, Result) {
  'use strict';

  /**
   * Util_Maintenance service.
   * @module api/Util_MaintenanceApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Util_MaintenanceApi. 
   * @alias module:api/Util_MaintenanceApi
   * @class
