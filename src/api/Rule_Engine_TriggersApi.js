...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Rule_Engine_TriggersApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BreTriggerResource, root.KnetikCloud.PageResourceBreTriggerResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, BreTriggerResource, PageResourceBreTriggerResource, Result) {
  'use strict';

  /**
   * Rule_Engine_Triggers service.
   * @module api/Rule_Engine_TriggersApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Rule_Engine_TriggersApi. 
   * @alias module:api/Rule_Engine_TriggersApi
   * @class
