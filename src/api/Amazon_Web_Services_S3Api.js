...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Amazon_Web_Services_S3Api = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.AmazonS3Activity, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, AmazonS3Activity, Result) {
  'use strict';

  /**
   * Amazon_Web_Services_S3 service.
   * @module api/Amazon_Web_Services_S3Api
   * @version 3.0.9
   */

  /**
   * Constructs a new Amazon_Web_Services_S3Api. 
   * @alias module:api/Amazon_Web_Services_S3Api
   * @class
