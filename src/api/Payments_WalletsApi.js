...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Payments_WalletsApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.PageResourceSimpleWallet, root.KnetikCloud.PageResourceWalletTotalResponse, root.KnetikCloud.PageResourceWalletTransactionResource, root.KnetikCloud.Result, root.KnetikCloud.SimpleWallet, root.KnetikCloud.WalletAlterRequest, root.KnetikCloud.WalletTransactionResource);
  }
  ...
  /**
   * Payments_Wallets service.
   * @module api/Payments_WalletsApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Payments_WalletsApi. 
   * @alias module:api/Payments_WalletsApi
   * @class
