...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.Media_ModerationApi = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.FlagReportResource, root.KnetikCloud.FlagResource, root.KnetikCloud.PageResourceFlagReportResource, root.KnetikCloud.PageResourceFlagResource, root.KnetikCloud.Result);
  }
}(this, function(ApiClient, FlagReportResource, FlagResource, PageResourceFlagReportResource, PageResourceFlagResource, Result) {
  'use strict';

  /**
   * Media_Moderation service.
   * @module api/Media_ModerationApi
   * @version 3.0.9
   */

  /**
   * Constructs a new Media_ModerationApi. 
   * @alias module:api/Media_ModerationApi
   * @class
