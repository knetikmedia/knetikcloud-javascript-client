...
(function(factory) {
   ...
   * <pre>
   * var knetikcloud-sdk = require('index'); // See note below*.
   * var xxxSvc = new knetikcloud-sdk.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new knetikcloud-sdk.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new knetikcloud-sdk.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new knetikcloud-sdk.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
