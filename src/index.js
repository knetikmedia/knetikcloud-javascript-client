...
(function(factory) {
   ...
   * <pre>
   * var KnetikcloudSdk = require('index'); // See note below*.
   * var xxxSvc = new KnetikcloudSdk.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new KnetikcloudSdk.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new KnetikcloudSdk.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new KnetikcloudSdk.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
