...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings', 'model/ARequestToResetAUsersPasswordByUsingAKnownUserProperty', 'model/AchievementDefinitionResource', 'model/ActionResource', 'model/ActionVariableResource', 'model/ActivityEntitlementResource', 'model/ActivityOccurrenceCreationFailure', 'model/ActivityOccurrenceJoinResult', 'model/ActivityOccurrenceResults', 'model/ActivityOccurrenceResultsResource', 'model/ActivityUserResource', 'model/AddressResource', 'model/AggregateCountResource', 'model/AggregateInvoiceReportResource', 'model/AmazonS3Activity', 'model/AnswerResource', 'model/ApplyPaymentRequest', 'model/ArticleResource', 'model/ArtistResource', 'model/AudioGroupProperty', 'model/AudioGroupPropertyDefinitionResource', 'model/AudioProperty', 'model/AudioPropertyDefinitionResource', 'model/BareActivityResource', 'model/BareChallengeActivityResource', 'model/Batch', 'model/BatchRequest', 'model/BatchResult', 'model/BatchReturn', 'model/Behavior', 'model/BehaviorDefinitionResource', 'model/BillingReport', 'model/BooleanProperty', 'model/BooleanPropertyDefinitionResource', 'model/BooleanResource', 'model/BreCategoryResource', 'model/BreEvent', 'model/BreEventLog', 'model/BreGlobalResource', 'model/BreGlobalScopeDefinition', 'model/BreRule', 'model/BreRuleLog', 'model/BreTriggerParameterDefinition', 'model/BreTriggerResource', 'model/BroadcastableEvent', 'model/BundleItem', 'model/BundledSku', 'model/CacheClearEvent', 'model/CampaignResource', 'model/Cart', 'model/CartItemRequest', 'model/CartLineItem', 'model/CartShippableResponse', 'model/CartShippingAddressRequest', 'model/CartShippingOption', 'model/CartSummary', 'model/CatalogSale', 'model/CategoryResource', 'model/ChallengeActivityResource', 'model/ChallengeEventParticipantResource', 'model/ChallengeEventResource', 'model/ChallengeResource', 'model/ClientResource', 'model/CollectionCountry', 'model/Collectionstring', 'model/CommentResource', 'model/CommentSearch', 'model/Config', 'model/ConfigLookupResource', 'model/ConstantResource', 'model/Consumable', 'model/ContributionResource', 'model/Country', 'model/CountryResource', 'model/CountryTaxResource', 'model/CouponDefinition', 'model/CouponItem', 'model/CreateBillingAgreementRequest', 'model/CreatePayPalPaymentRequest', 'model/CurrencyResource', 'model/CustomerConfig', 'model/DatabaseConfig', 'model/DateOperationResource', 'model/DateProperty', 'model/DatePropertyDefinitionResource', 'model/DeltaResource', 'model/DeviceResource', 'model/Discount', 'model/DispositionCount', 'model/DispositionResource', 'model/DoubleOperationResource', 'model/DoubleProperty', 'model/DoublePropertyDefinitionResource', 'model/EntitlementGrantRequest', 'model/EntitlementItem', 'model/ErrorResource', 'model/EventContextResource', 'model/Expirable', 'model/ExpressionResource', 'model/Expressionobject', 'model/FacebookToken', 'model/FileGroupProperty', 'model/FileGroupPropertyDefinitionResource', 'model/FileProperty', 'model/FilePropertyDefinitionResource', 'model/FinalizeBillingAgreementRequest', 'model/FinalizePayPalPaymentRequest', 'model/FlagReportResource', 'model/FlagResource', 'model/FormattedTextProperty', 'model/FormattedTextPropertyDefinitionResource', 'model/ForwardLog', 'model/Fulfillable', 'model/FulfillmentType', 'model/GlobalCheckAndIncrementResource', 'model/GlobalResource', 'model/GooglePaymentRequest', 'model/GoogleToken', 'model/GrantTypeResource', 'model/GroupMemberResource', 'model/GroupResource', 'model/GuestPlayable', 'model/IOConfig', 'model/ImageGroupProperty', 'model/ImageGroupPropertyDefinitionResource', 'model/ImageProperty', 'model/ImagePropertyDefinitionResource', 'model/ImportJobOutputResource', 'model/ImportJobResource', 'model/IntegerOperationResource', 'model/IntegerProperty', 'model/IntegerPropertyDefinitionResource', 'model/InventorySubscriptionResource', 'model/InvoiceCreateRequest', 'model/InvoiceItemResource', 'model/InvoiceLogEntry', 'model/InvoicePaymentStatusRequest', 'model/InvoiceResource', 'model/Item', 'model/ItemBehaviorDefinitionResource', 'model/ItemTemplateResource', 'model/KeyValuePairstringstring', 'model/LeaderboardEntryResource', 'model/LeaderboardResource', 'model/LevelingResource', 'model/LimitedGettable', 'model/LimitedGettableGroup', 'model/Localizer', 'model/LocationLogResource', 'model/LongProperty', 'model/LongPropertyDefinitionResource', 'model/LookupResource', 'model/LookupTypeResource', 'model/Maintenance', 'model/MapResource', 'model/Mapstringobject', 'model/MetricResource', 'model/MongoDatabaseConfig', 'model/NestedCategory', 'model/NewCustomerEvent', 'model/NewPasswordRequest', 'model/OAuth2Resource', 'model/OauthAccessTokenResource', 'model/Operator', 'model/OptimalPaymentRequest', 'model/Order', 'model/PageResourceAchievementDefinitionResource', 'model/PageResourceAggregateCountResource', 'model/PageResourceAggregateInvoiceReportResource', 'model/PageResourceArticleResource', 'model/PageResourceArtistResource', 'model/PageResourceBareActivityResource', 'model/PageResourceBareChallengeActivityResource', 'model/PageResourceBillingReport', 'model/PageResourceBreCategoryResource', 'model/PageResourceBreEventLog', 'model/PageResourceBreGlobalResource', 'model/PageResourceBreRule', 'model/PageResourceBreTriggerResource', 'model/PageResourceCampaignResource', 'model/PageResourceCartSummary', 'model/PageResourceCatalogSale', 'model/PageResourceCategoryResource', 'model/PageResourceChallengeEventParticipantResource', 'model/PageResourceChallengeEventResource', 'model/PageResourceChallengeResource', 'model/PageResourceClientResource', 'model/PageResourceCommentResource', 'model/PageResourceConfig', 'model/PageResourceCountryTaxResource', 'model/PageResourceCurrencyResource', 'model/PageResourceDeviceResource', 'model/PageResourceDispositionResource', 'model/PageResourceEntitlementItem', 'model/PageResourceFlagReportResource', 'model/PageResourceForwardLog', 'model/PageResourceFulfillmentType', 'model/PageResourceGroupMemberResource', 'model/PageResourceGroupResource', 'model/PageResourceImportJobResource', 'model/PageResourceInvoiceLogEntry', 'model/PageResourceInvoiceResource', 'model/PageResourceItemTemplateResource', 'model/PageResourceLevelingResource', 'model/PageResourceLocationLogResource', 'model/PageResourceMapstringobject', 'model/PageResourceOauthAccessTokenResource', 'model/PageResourcePermissionResource', 'model/PageResourcePollResource', 'model/PageResourceQuestionResource', 'model/PageResourceQuestionTemplateResource', 'model/PageResourceRevenueCountryReportResource', 'model/PageResourceRevenueProductReportResource', 'model/PageResourceRewardSetResource', 'model/PageResourceRoleResource', 'model/PageResourceSavedAddressResource', 'model/PageResourceSimpleReferenceResourceobject', 'model/PageResourceSimpleUserResource', 'model/PageResourceSimpleWallet', 'model/PageResourceStateTaxResource', 'model/PageResourceStoreItem', 'model/PageResourceStoreItemTemplateResource', 'model/PageResourceSubscriptionResource', 'model/PageResourceSubscriptionTemplateResource', 'model/PageResourceTemplateResource', 'model/PageResourceTransactionResource', 'model/PageResourceUsageInfo', 'model/PageResourceUserAchievementGroupResource', 'model/PageResourceUserActionLog', 'model/PageResourceUserBaseResource', 'model/PageResourceUserInventoryResource', 'model/PageResourceUserItemLogResource', 'model/PageResourceUserLevelingResource', 'model/PageResourceUserRelationshipResource', 'model/PageResourceVendorResource', 'model/PageResourceVideoRelationshipResource', 'model/PageResourceVideoResource', 'model/PageResourceWalletTotalResponse', 'model/PageResourceWalletTransactionResource', 'model/PageResourcestring', 'model/ParameterResource', 'model/PayBySavedMethodRequest', 'model/PaymentAuthorizationResource', 'model/PaymentMethodResource', 'model/PaymentMethodTypeResource', 'model/PermissionResource', 'model/PollAnswerResource', 'model/PollResource', 'model/PollResponseResource', 'model/PreReqEntitlement', 'model/PredicateOperation', 'model/PredicateResource', 'model/PriceOverridable', 'model/Property', 'model/PropertyDefinitionResource', 'model/PropertyFieldListResource', 'model/PropertyFieldResource', 'model/QuestionResource', 'model/QuestionTemplateResource', 'model/RawEmailResource', 'model/RawSMSResource', 'model/ReactivateSubscriptionRequest', 'model/RefundRequest', 'model/RefundResource', 'model/RemoveCustomerEvent', 'model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc', 'model/Result', 'model/RevenueCountryReportResource', 'model/RevenueProductReportResource', 'model/RevenueReportResource', 'model/RewardCurrencyResource', 'model/RewardItemResource', 'model/RewardSetResource', 'model/RoleResource', 'model/S3Config', 'model/SampleCountriesResponse', 'model/SavedAddressResource', 'model/Schedule', 'model/SearchReferenceMapping', 'model/SelectedSettingResource', 'model/SettingOption', 'model/ShippingItem', 'model/SimpleReferenceResourceint', 'model/SimpleReferenceResourcelong', 'model/SimpleReferenceResourceobject', 'model/SimpleReferenceResourcestring', 'model/SimpleUserResource', 'model/SimpleWallet', 'model/Sku', 'model/SkuRequest', 'model/Spendable', 'model/SqlDatabaseConfig', 'model/StateResource', 'model/StateTaxResource', 'model/StoreItem', 'model/StoreItemTemplateResource', 'model/StringOperationResource', 'model/StripeCreatePaymentMethod', 'model/StripePaymentRequest', 'model/Subscription', 'model/SubscriptionCreditResource', 'model/SubscriptionPlan', 'model/SubscriptionPlanResource', 'model/SubscriptionPriceOverrideRequest', 'model/SubscriptionResource', 'model/SubscriptionTemplateResource', 'model/TemplateEmailResource', 'model/TemplateResource', 'model/TemplateSMSResource', 'model/TextProperty', 'model/TextPropertyDefinitionResource', 'model/TheDefinitionOfAnActivityParametersExDifficultyLevel', 'model/TierResource', 'model/TimePeriodGettable', 'model/TimePeriodUsable', 'model/TokenDetailsResource', 'model/TransactionResource', 'model/TypeHintLookupResource', 'model/UsageInfo', 'model/UserAchievementGroupResource', 'model/UserAchievementResource', 'model/UserActionLog', 'model/UserActivityResults', 'model/UserActivityResultsResource', 'model/UserBaseResource', 'model/UserInventoryAddRequest', 'model/UserInventoryResource', 'model/UserItemLogResource', 'model/UserLevelingResource', 'model/UserRelationshipReferenceResource', 'model/UserRelationshipResource', 'model/UserResource', 'model/UsernameLookupResource', 'model/VariableTypeResource', 'model/VendorEmailLookupResource', 'model/VendorResource', 'model/Version', 'model/VideoGroupProperty', 'model/VideoGroupPropertyDefinitionResource', 'model/VideoProperty', 'model/VideoPropertyDefinitionResource', 'model/VideoRelationshipResource', 'model/VideoResource', 'model/WalletAlterRequest', 'model/WalletTotalResponse', 'model/WalletTransactionResource', 'model/XsollaPaymentRequest', 'api/AccessTokenApi', 'api/ActivitiesApi', 'api/AmazonWebServicesS3Api', 'api/AuthClientsApi', 'api/AuthPermissionsApi', 'api/AuthRolesApi', 'api/AuthTokensApi', 'api/BRERuleEngineActionsApi', 'api/BRERuleEngineCategoriesApi', 'api/BRERuleEngineEventsApi', 'api/BRERuleEngineExpressionsApi', 'api/BRERuleEngineGlobalsApi', 'api/BRERuleEngineRulesApi', 'api/BRERuleEngineTriggersApi', 'api/BRERuleEngineVariablesApi', 'api/CampaignsApi', 'api/CampaignsChallengesApi', 'api/CampaignsRewardsApi', 'api/CategoriesApi', 'api/ConfigsApi', 'api/ContentArticlesApi', 'api/ContentCommentsApi', 'api/ContentPollsApi', 'api/CurrenciesApi', 'api/DevicesApi', 'api/DispositionsApi', 'api/FulfillmentApi', 'api/GamificationAchievementsApi', 'api/GamificationLeaderboardsApi', 'api/GamificationLevelingApi', 'api/GamificationMetricsApi', 'api/GamificationTriviaApi', 'api/InvoicesApi', 'api/LocationsApi', 'api/LogsApi', 'api/MediaArtistsApi', 'api/MediaModerationApi', 'api/MediaVideosApi', 'api/MessagingApi', 'api/PaymentsApi', 'api/PaymentsAppleApi', 'api/PaymentsGoogleApi', 'api/PaymentsOptimalApi', 'api/PaymentsPayPalClassicApi', 'api/PaymentsStripeApi', 'api/PaymentsTransactionsApi', 'api/PaymentsWalletsApi', 'api/PaymentsXsollaApi', 'api/ReportingChallengesApi', 'api/ReportingOrdersApi', 'api/ReportingRevenueApi', 'api/ReportingSubscriptionsApi', 'api/ReportingUsageApi', 'api/ReportingUsersApi', 'api/SearchApi', 'api/SocialFacebookApi', 'api/SocialGoogleApi', 'api/StoreApi', 'api/StoreBundlesApi', 'api/StoreCouponsApi', 'api/StoreSalesApi', 'api/StoreShippingApi', 'api/StoreShoppingCartsApi', 'api/StoreSubscriptionsApi', 'api/StoreVendorsApi', 'api/TaxesApi', 'api/TemplatesPropertiesApi', 'api/UsersApi', 'api/UsersAddressesApi', 'api/UsersFriendshipsApi', 'api/UsersGroupsApi', 'api/UsersInventoryApi', 'api/UsersRelationshipsApi', 'api/UsersSubscriptionsApi', 'api/UtilBatchApi', 'api/UtilHealthApi', 'api/UtilMaintenanceApi', 'api/UtilSecurityApi', 'api/UtilVersionApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings'), require('./model/ARequestToResetAUsersPasswordByUsingAKnownUserProperty'), require('./model/AchievementDefinitionResource'), require('./model/ActionResource'), require('./model/ActionVariableResource'), require('./model/ActivityEntitlementResource'), require('./model/ActivityOccurrenceCreationFailure'), require('./model/ActivityOccurrenceJoinResult'), require('./model/ActivityOccurrenceResults'), require('./model/ActivityOccurrenceResultsResource'), require('./model/ActivityUserResource'), require('./model/AddressResource'), require('./model/AggregateCountResource'), require('./model/AggregateInvoiceReportResource'), require('./model/AmazonS3Activity'), require('./model/AnswerResource'), require('./model/ApplyPaymentRequest'), require('./model/ArticleResource'), require('./model/ArtistResource'), require('./model/AudioGroupProperty'), require('./model/AudioGroupPropertyDefinitionResource'), require('./model/AudioProperty'), require('./model/AudioPropertyDefinitionResource'), require('./model/BareActivityResource'), require('./model/BareChallengeActivityResource'), require('./model/Batch'), require('./model/BatchRequest'), require('./model/BatchResult'), require('./model/BatchReturn'), require('./model/Behavior'), require('./model/BehaviorDefinitionResource'), require('./model/BillingReport'), require('./model/BooleanProperty'), require('./model/BooleanPropertyDefinitionResource'), require('./model/BooleanResource'), require('./model/BreCategoryResource'), require('./model/BreEvent'), require('./model/BreEventLog'), require('./model/BreGlobalResource'), require('./model/BreGlobalScopeDefinition'), require('./model/BreRule'), require('./model/BreRuleLog'), require('./model/BreTriggerParameterDefinition'), require('./model/BreTriggerResource'), require('./model/BroadcastableEvent'), require('./model/BundleItem'), require('./model/BundledSku'), require('./model/CacheClearEvent'), require('./model/CampaignResource'), require('./model/Cart'), require('./model/CartItemRequest'), require('./model/CartLineItem'), require('./model/CartShippableResponse'), require('./model/CartShippingAddressRequest'), require('./model/CartShippingOption'), require('./model/CartSummary'), require('./model/CatalogSale'), require('./model/CategoryResource'), require('./model/ChallengeActivityResource'), require('./model/ChallengeEventParticipantResource'), require('./model/ChallengeEventResource'), require('./model/ChallengeResource'), require('./model/ClientResource'), require('./model/CollectionCountry'), require('./model/Collectionstring'), require('./model/CommentResource'), require('./model/CommentSearch'), require('./model/Config'), require('./model/ConfigLookupResource'), require('./model/ConstantResource'), require('./model/Consumable'), require('./model/ContributionResource'), require('./model/Country'), require('./model/CountryResource'), require('./model/CountryTaxResource'), require('./model/CouponDefinition'), require('./model/CouponItem'), require('./model/CreateBillingAgreementRequest'), require('./model/CreatePayPalPaymentRequest'), require('./model/CurrencyResource'), require('./model/CustomerConfig'), require('./model/DatabaseConfig'), require('./model/DateOperationResource'), require('./model/DateProperty'), require('./model/DatePropertyDefinitionResource'), require('./model/DeltaResource'), require('./model/DeviceResource'), require('./model/Discount'), require('./model/DispositionCount'), require('./model/DispositionResource'), require('./model/DoubleOperationResource'), require('./model/DoubleProperty'), require('./model/DoublePropertyDefinitionResource'), require('./model/EntitlementGrantRequest'), require('./model/EntitlementItem'), require('./model/ErrorResource'), require('./model/EventContextResource'), require('./model/Expirable'), require('./model/ExpressionResource'), require('./model/Expressionobject'), require('./model/FacebookToken'), require('./model/FileGroupProperty'), require('./model/FileGroupPropertyDefinitionResource'), require('./model/FileProperty'), require('./model/FilePropertyDefinitionResource'), require('./model/FinalizeBillingAgreementRequest'), require('./model/FinalizePayPalPaymentRequest'), require('./model/FlagReportResource'), require('./model/FlagResource'), require('./model/FormattedTextProperty'), require('./model/FormattedTextPropertyDefinitionResource'), require('./model/ForwardLog'), require('./model/Fulfillable'), require('./model/FulfillmentType'), require('./model/GlobalCheckAndIncrementResource'), require('./model/GlobalResource'), require('./model/GooglePaymentRequest'), require('./model/GoogleToken'), require('./model/GrantTypeResource'), require('./model/GroupMemberResource'), require('./model/GroupResource'), require('./model/GuestPlayable'), require('./model/IOConfig'), require('./model/ImageGroupProperty'), require('./model/ImageGroupPropertyDefinitionResource'), require('./model/ImageProperty'), require('./model/ImagePropertyDefinitionResource'), require('./model/ImportJobOutputResource'), require('./model/ImportJobResource'), require('./model/IntegerOperationResource'), require('./model/IntegerProperty'), require('./model/IntegerPropertyDefinitionResource'), require('./model/InventorySubscriptionResource'), require('./model/InvoiceCreateRequest'), require('./model/InvoiceItemResource'), require('./model/InvoiceLogEntry'), require('./model/InvoicePaymentStatusRequest'), require('./model/InvoiceResource'), require('./model/Item'), require('./model/ItemBehaviorDefinitionResource'), require('./model/ItemTemplateResource'), require('./model/KeyValuePairstringstring'), require('./model/LeaderboardEntryResource'), require('./model/LeaderboardResource'), require('./model/LevelingResource'), require('./model/LimitedGettable'), require('./model/LimitedGettableGroup'), require('./model/Localizer'), require('./model/LocationLogResource'), require('./model/LongProperty'), require('./model/LongPropertyDefinitionResource'), require('./model/LookupResource'), require('./model/LookupTypeResource'), require('./model/Maintenance'), require('./model/MapResource'), require('./model/Mapstringobject'), require('./model/MetricResource'), require('./model/MongoDatabaseConfig'), require('./model/NestedCategory'), require('./model/NewCustomerEvent'), require('./model/NewPasswordRequest'), require('./model/OAuth2Resource'), require('./model/OauthAccessTokenResource'), require('./model/Operator'), require('./model/OptimalPaymentRequest'), require('./model/Order'), require('./model/PageResourceAchievementDefinitionResource'), require('./model/PageResourceAggregateCountResource'), require('./model/PageResourceAggregateInvoiceReportResource'), require('./model/PageResourceArticleResource'), require('./model/PageResourceArtistResource'), require('./model/PageResourceBareActivityResource'), require('./model/PageResourceBareChallengeActivityResource'), require('./model/PageResourceBillingReport'), require('./model/PageResourceBreCategoryResource'), require('./model/PageResourceBreEventLog'), require('./model/PageResourceBreGlobalResource'), require('./model/PageResourceBreRule'), require('./model/PageResourceBreTriggerResource'), require('./model/PageResourceCampaignResource'), require('./model/PageResourceCartSummary'), require('./model/PageResourceCatalogSale'), require('./model/PageResourceCategoryResource'), require('./model/PageResourceChallengeEventParticipantResource'), require('./model/PageResourceChallengeEventResource'), require('./model/PageResourceChallengeResource'), require('./model/PageResourceClientResource'), require('./model/PageResourceCommentResource'), require('./model/PageResourceConfig'), require('./model/PageResourceCountryTaxResource'), require('./model/PageResourceCurrencyResource'), require('./model/PageResourceDeviceResource'), require('./model/PageResourceDispositionResource'), require('./model/PageResourceEntitlementItem'), require('./model/PageResourceFlagReportResource'), require('./model/PageResourceForwardLog'), require('./model/PageResourceFulfillmentType'), require('./model/PageResourceGroupMemberResource'), require('./model/PageResourceGroupResource'), require('./model/PageResourceImportJobResource'), require('./model/PageResourceInvoiceLogEntry'), require('./model/PageResourceInvoiceResource'), require('./model/PageResourceItemTemplateResource'), require('./model/PageResourceLevelingResource'), require('./model/PageResourceLocationLogResource'), require('./model/PageResourceMapstringobject'), require('./model/PageResourceOauthAccessTokenResource'), require('./model/PageResourcePermissionResource'), require('./model/PageResourcePollResource'), require('./model/PageResourceQuestionResource'), require('./model/PageResourceQuestionTemplateResource'), require('./model/PageResourceRevenueCountryReportResource'), require('./model/PageResourceRevenueProductReportResource'), require('./model/PageResourceRewardSetResource'), require('./model/PageResourceRoleResource'), require('./model/PageResourceSavedAddressResource'), require('./model/PageResourceSimpleReferenceResourceobject'), require('./model/PageResourceSimpleUserResource'), require('./model/PageResourceSimpleWallet'), require('./model/PageResourceStateTaxResource'), require('./model/PageResourceStoreItem'), require('./model/PageResourceStoreItemTemplateResource'), require('./model/PageResourceSubscriptionResource'), require('./model/PageResourceSubscriptionTemplateResource'), require('./model/PageResourceTemplateResource'), require('./model/PageResourceTransactionResource'), require('./model/PageResourceUsageInfo'), require('./model/PageResourceUserAchievementGroupResource'), require('./model/PageResourceUserActionLog'), require('./model/PageResourceUserBaseResource'), require('./model/PageResourceUserInventoryResource'), require('./model/PageResourceUserItemLogResource'), require('./model/PageResourceUserLevelingResource'), require('./model/PageResourceUserRelationshipResource'), require('./model/PageResourceVendorResource'), require('./model/PageResourceVideoRelationshipResource'), require('./model/PageResourceVideoResource'), require('./model/PageResourceWalletTotalResponse'), require('./model/PageResourceWalletTransactionResource'), require('./model/PageResourcestring'), require('./model/ParameterResource'), require('./model/PayBySavedMethodRequest'), require('./model/PaymentAuthorizationResource'), require('./model/PaymentMethodResource'), require('./model/PaymentMethodTypeResource'), require('./model/PermissionResource'), require('./model/PollAnswerResource'), require('./model/PollResource'), require('./model/PollResponseResource'), require('./model/PreReqEntitlement'), require('./model/PredicateOperation'), require('./model/PredicateResource'), require('./model/PriceOverridable'), require('./model/Property'), require('./model/PropertyDefinitionResource'), require('./model/PropertyFieldListResource'), require('./model/PropertyFieldResource'), require('./model/QuestionResource'), require('./model/QuestionTemplateResource'), require('./model/RawEmailResource'), require('./model/RawSMSResource'), require('./model/ReactivateSubscriptionRequest'), require('./model/RefundRequest'), require('./model/RefundResource'), require('./model/RemoveCustomerEvent'), require('./model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc'), require('./model/Result'), require('./model/RevenueCountryReportResource'), require('./model/RevenueProductReportResource'), require('./model/RevenueReportResource'), require('./model/RewardCurrencyResource'), require('./model/RewardItemResource'), require('./model/RewardSetResource'), require('./model/RoleResource'), require('./model/S3Config'), require('./model/SampleCountriesResponse'), require('./model/SavedAddressResource'), require('./model/Schedule'), require('./model/SearchReferenceMapping'), require('./model/SelectedSettingResource'), require('./model/SettingOption'), require('./model/ShippingItem'), require('./model/SimpleReferenceResourceint'), require('./model/SimpleReferenceResourcelong'), require('./model/SimpleReferenceResourceobject'), require('./model/SimpleReferenceResourcestring'), require('./model/SimpleUserResource'), require('./model/SimpleWallet'), require('./model/Sku'), require('./model/SkuRequest'), require('./model/Spendable'), require('./model/SqlDatabaseConfig'), require('./model/StateResource'), require('./model/StateTaxResource'), require('./model/StoreItem'), require('./model/StoreItemTemplateResource'), require('./model/StringOperationResource'), require('./model/StripeCreatePaymentMethod'), require('./model/StripePaymentRequest'), require('./model/Subscription'), require('./model/SubscriptionCreditResource'), require('./model/SubscriptionPlan'), require('./model/SubscriptionPlanResource'), require('./model/SubscriptionPriceOverrideRequest'), require('./model/SubscriptionResource'), require('./model/SubscriptionTemplateResource'), require('./model/TemplateEmailResource'), require('./model/TemplateResource'), require('./model/TemplateSMSResource'), require('./model/TextProperty'), require('./model/TextPropertyDefinitionResource'), require('./model/TheDefinitionOfAnActivityParametersExDifficultyLevel'), require('./model/TierResource'), require('./model/TimePeriodGettable'), require('./model/TimePeriodUsable'), require('./model/TokenDetailsResource'), require('./model/TransactionResource'), require('./model/TypeHintLookupResource'), require('./model/UsageInfo'), require('./model/UserAchievementGroupResource'), require('./model/UserAchievementResource'), require('./model/UserActionLog'), require('./model/UserActivityResults'), require('./model/UserActivityResultsResource'), require('./model/UserBaseResource'), require('./model/UserInventoryAddRequest'), require('./model/UserInventoryResource'), require('./model/UserItemLogResource'), require('./model/UserLevelingResource'), require('./model/UserRelationshipReferenceResource'), require('./model/UserRelationshipResource'), require('./model/UserResource'), require('./model/UsernameLookupResource'), require('./model/VariableTypeResource'), require('./model/VendorEmailLookupResource'), require('./model/VendorResource'), require('./model/Version'), require('./model/VideoGroupProperty'), require('./model/VideoGroupPropertyDefinitionResource'), require('./model/VideoProperty'), require('./model/VideoPropertyDefinitionResource'), require('./model/VideoRelationshipResource'), require('./model/VideoResource'), require('./model/WalletAlterRequest'), require('./model/WalletTotalResponse'), require('./model/WalletTransactionResource'), require('./model/XsollaPaymentRequest'), require('./api/AccessTokenApi'), require('./api/ActivitiesApi'), require('./api/AmazonWebServicesS3Api'), require('./api/AuthClientsApi'), require('./api/AuthPermissionsApi'), require('./api/AuthRolesApi'), require('./api/AuthTokensApi'), require('./api/BRERuleEngineActionsApi'), require('./api/BRERuleEngineCategoriesApi'), require('./api/BRERuleEngineEventsApi'), require('./api/BRERuleEngineExpressionsApi'), require('./api/BRERuleEngineGlobalsApi'), require('./api/BRERuleEngineRulesApi'), require('./api/BRERuleEngineTriggersApi'), require('./api/BRERuleEngineVariablesApi'), require('./api/CampaignsApi'), require('./api/CampaignsChallengesApi'), require('./api/CampaignsRewardsApi'), require('./api/CategoriesApi'), require('./api/ConfigsApi'), require('./api/ContentArticlesApi'), require('./api/ContentCommentsApi'), require('./api/ContentPollsApi'), require('./api/CurrenciesApi'), require('./api/DevicesApi'), require('./api/DispositionsApi'), require('./api/FulfillmentApi'), require('./api/GamificationAchievementsApi'), require('./api/GamificationLeaderboardsApi'), require('./api/GamificationLevelingApi'), require('./api/GamificationMetricsApi'), require('./api/GamificationTriviaApi'), require('./api/InvoicesApi'), require('./api/LocationsApi'), require('./api/LogsApi'), require('./api/MediaArtistsApi'), require('./api/MediaModerationApi'), require('./api/MediaVideosApi'), require('./api/MessagingApi'), require('./api/PaymentsApi'), require('./api/PaymentsAppleApi'), require('./api/PaymentsGoogleApi'), require('./api/PaymentsOptimalApi'), require('./api/PaymentsPayPalClassicApi'), require('./api/PaymentsStripeApi'), require('./api/PaymentsTransactionsApi'), require('./api/PaymentsWalletsApi'), require('./api/PaymentsXsollaApi'), require('./api/ReportingChallengesApi'), require('./api/ReportingOrdersApi'), require('./api/ReportingRevenueApi'), require('./api/ReportingSubscriptionsApi'), require('./api/ReportingUsageApi'), require('./api/ReportingUsersApi'), require('./api/SearchApi'), require('./api/SocialFacebookApi'), require('./api/SocialGoogleApi'), require('./api/StoreApi'), require('./api/StoreBundlesApi'), require('./api/StoreCouponsApi'), require('./api/StoreSalesApi'), require('./api/StoreShippingApi'), require('./api/StoreShoppingCartsApi'), require('./api/StoreSubscriptionsApi'), require('./api/StoreVendorsApi'), require('./api/TaxesApi'), require('./api/TemplatesPropertiesApi'), require('./api/UsersApi'), require('./api/UsersAddressesApi'), require('./api/UsersFriendshipsApi'), require('./api/UsersGroupsApi'), require('./api/UsersInventoryApi'), require('./api/UsersRelationshipsApi'), require('./api/UsersSubscriptionsApi'), require('./api/UtilBatchApi'), require('./api/UtilHealthApi'), require('./api/UtilMaintenanceApi'), require('./api/UtilSecurityApi'), require('./api/UtilVersionApi'));
  }
}(function(ApiClient, AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings, ARequestToResetAUsersPasswordByUsingAKnownUserProperty, AchievementDefinitionResource, ActionResource, ActionVariableResource, ActivityEntitlementResource, ActivityOccurrenceCreationFailure, ActivityOccurrenceJoinResult, ActivityOccurrenceResults, ActivityOccurrenceResultsResource, ActivityUserResource, AddressResource, AggregateCountResource, AggregateInvoiceReportResource, AmazonS3Activity, AnswerResource, ApplyPaymentRequest, ArticleResource, ArtistResource, AudioGroupProperty, AudioGroupPropertyDefinitionResource, AudioProperty, AudioPropertyDefinitionResource, BareActivityResource, BareChallengeActivityResource, Batch, BatchRequest, BatchResult, BatchReturn, Behavior, BehaviorDefinitionResource, BillingReport, BooleanProperty, BooleanPropertyDefinitionResource, BooleanResource, BreCategoryResource, BreEvent, BreEventLog, BreGlobalResource, BreGlobalScopeDefinition, BreRule, BreRuleLog, BreTriggerParameterDefinition, BreTriggerResource, BroadcastableEvent, BundleItem, BundledSku, CacheClearEvent, CampaignResource, Cart, CartItemRequest, CartLineItem, CartShippableResponse, CartShippingAddressRequest, CartShippingOption, CartSummary, CatalogSale, CategoryResource, ChallengeActivityResource, ChallengeEventParticipantResource, ChallengeEventResource, ChallengeResource, ClientResource, CollectionCountry, Collectionstring, CommentResource, CommentSearch, Config, ConfigLookupResource, ConstantResource, Consumable, ContributionResource, Country, CountryResource, CountryTaxResource, CouponDefinition, CouponItem, CreateBillingAgreementRequest, CreatePayPalPaymentRequest, CurrencyResource, CustomerConfig, DatabaseConfig, DateOperationResource, DateProperty, DatePropertyDefinitionResource, DeltaResource, DeviceResource, Discount, DispositionCount, DispositionResource, DoubleOperationResource, DoubleProperty, DoublePropertyDefinitionResource, EntitlementGrantRequest, EntitlementItem, ErrorResource, EventContextResource, Expirable, ExpressionResource, Expressionobject, FacebookToken, FileGroupProperty, FileGroupPropertyDefinitionResource, FileProperty, FilePropertyDefinitionResource, FinalizeBillingAgreementRequest, FinalizePayPalPaymentRequest, FlagReportResource, FlagResource, FormattedTextProperty, FormattedTextPropertyDefinitionResource, ForwardLog, Fulfillable, FulfillmentType, GlobalCheckAndIncrementResource, GlobalResource, GooglePaymentRequest, GoogleToken, GrantTypeResource, GroupMemberResource, GroupResource, GuestPlayable, IOConfig, ImageGroupProperty, ImageGroupPropertyDefinitionResource, ImageProperty, ImagePropertyDefinitionResource, ImportJobOutputResource, ImportJobResource, IntegerOperationResource, IntegerProperty, IntegerPropertyDefinitionResource, InventorySubscriptionResource, InvoiceCreateRequest, InvoiceItemResource, InvoiceLogEntry, InvoicePaymentStatusRequest, InvoiceResource, Item, ItemBehaviorDefinitionResource, ItemTemplateResource, KeyValuePairstringstring, LeaderboardEntryResource, LeaderboardResource, LevelingResource, LimitedGettable, LimitedGettableGroup, Localizer, LocationLogResource, LongProperty, LongPropertyDefinitionResource, LookupResource, LookupTypeResource, Maintenance, MapResource, Mapstringobject, MetricResource, MongoDatabaseConfig, NestedCategory, NewCustomerEvent, NewPasswordRequest, OAuth2Resource, OauthAccessTokenResource, Operator, OptimalPaymentRequest, Order, PageResourceAchievementDefinitionResource, PageResourceAggregateCountResource, PageResourceAggregateInvoiceReportResource, PageResourceArticleResource, PageResourceArtistResource, PageResourceBareActivityResource, PageResourceBareChallengeActivityResource, PageResourceBillingReport, PageResourceBreCategoryResource, PageResourceBreEventLog, PageResourceBreGlobalResource, PageResourceBreRule, PageResourceBreTriggerResource, PageResourceCampaignResource, PageResourceCartSummary, PageResourceCatalogSale, PageResourceCategoryResource, PageResourceChallengeEventParticipantResource, PageResourceChallengeEventResource, PageResourceChallengeResource, PageResourceClientResource, PageResourceCommentResource, PageResourceConfig, PageResourceCountryTaxResource, PageResourceCurrencyResource, PageResourceDeviceResource, PageResourceDispositionResource, PageResourceEntitlementItem, PageResourceFlagReportResource, PageResourceForwardLog, PageResourceFulfillmentType, PageResourceGroupMemberResource, PageResourceGroupResource, PageResourceImportJobResource, PageResourceInvoiceLogEntry, PageResourceInvoiceResource, PageResourceItemTemplateResource, PageResourceLevelingResource, PageResourceLocationLogResource, PageResourceMapstringobject, PageResourceOauthAccessTokenResource, PageResourcePermissionResource, PageResourcePollResource, PageResourceQuestionResource, PageResourceQuestionTemplateResource, PageResourceRevenueCountryReportResource, PageResourceRevenueProductReportResource, PageResourceRewardSetResource, PageResourceRoleResource, PageResourceSavedAddressResource, PageResourceSimpleReferenceResourceobject, PageResourceSimpleUserResource, PageResourceSimpleWallet, PageResourceStateTaxResource, PageResourceStoreItem, PageResourceStoreItemTemplateResource, PageResourceSubscriptionResource, PageResourceSubscriptionTemplateResource, PageResourceTemplateResource, PageResourceTransactionResource, PageResourceUsageInfo, PageResourceUserAchievementGroupResource, PageResourceUserActionLog, PageResourceUserBaseResource, PageResourceUserInventoryResource, PageResourceUserItemLogResource, PageResourceUserLevelingResource, PageResourceUserRelationshipResource, PageResourceVendorResource, PageResourceVideoRelationshipResource, PageResourceVideoResource, PageResourceWalletTotalResponse, PageResourceWalletTransactionResource, PageResourcestring, ParameterResource, PayBySavedMethodRequest, PaymentAuthorizationResource, PaymentMethodResource, PaymentMethodTypeResource, PermissionResource, PollAnswerResource, PollResource, PollResponseResource, PreReqEntitlement, PredicateOperation, PredicateResource, PriceOverridable, Property, PropertyDefinitionResource, PropertyFieldListResource, PropertyFieldResource, QuestionResource, QuestionTemplateResource, RawEmailResource, RawSMSResource, ReactivateSubscriptionRequest, RefundRequest, RefundResource, RemoveCustomerEvent, RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc, Result, RevenueCountryReportResource, RevenueProductReportResource, RevenueReportResource, RewardCurrencyResource, RewardItemResource, RewardSetResource, RoleResource, S3Config, SampleCountriesResponse, SavedAddressResource, Schedule, SearchReferenceMapping, SelectedSettingResource, SettingOption, ShippingItem, SimpleReferenceResourceint, SimpleReferenceResourcelong, SimpleReferenceResourceobject, SimpleReferenceResourcestring, SimpleUserResource, SimpleWallet, Sku, SkuRequest, Spendable, SqlDatabaseConfig, StateResource, StateTaxResource, StoreItem, StoreItemTemplateResource, StringOperationResource, StripeCreatePaymentMethod, StripePaymentRequest, Subscription, SubscriptionCreditResource, SubscriptionPlan, SubscriptionPlanResource, SubscriptionPriceOverrideRequest, SubscriptionResource, SubscriptionTemplateResource, TemplateEmailResource, TemplateResource, TemplateSMSResource, TextProperty, TextPropertyDefinitionResource, TheDefinitionOfAnActivityParametersExDifficultyLevel, TierResource, TimePeriodGettable, TimePeriodUsable, TokenDetailsResource, TransactionResource, TypeHintLookupResource, UsageInfo, UserAchievementGroupResource, UserAchievementResource, UserActionLog, UserActivityResults, UserActivityResultsResource, UserBaseResource, UserInventoryAddRequest, UserInventoryResource, UserItemLogResource, UserLevelingResource, UserRelationshipReferenceResource, UserRelationshipResource, UserResource, UsernameLookupResource, VariableTypeResource, VendorEmailLookupResource, VendorResource, Version, VideoGroupProperty, VideoGroupPropertyDefinitionResource, VideoProperty, VideoPropertyDefinitionResource, VideoRelationshipResource, VideoResource, WalletAlterRequest, WalletTotalResponse, WalletTransactionResource, XsollaPaymentRequest, AccessTokenApi, ActivitiesApi, AmazonWebServicesS3Api, AuthClientsApi, AuthPermissionsApi, AuthRolesApi, AuthTokensApi, BRERuleEngineActionsApi, BRERuleEngineCategoriesApi, BRERuleEngineEventsApi, BRERuleEngineExpressionsApi, BRERuleEngineGlobalsApi, BRERuleEngineRulesApi, BRERuleEngineTriggersApi, BRERuleEngineVariablesApi, CampaignsApi, CampaignsChallengesApi, CampaignsRewardsApi, CategoriesApi, ConfigsApi, ContentArticlesApi, ContentCommentsApi, ContentPollsApi, CurrenciesApi, DevicesApi, DispositionsApi, FulfillmentApi, GamificationAchievementsApi, GamificationLeaderboardsApi, GamificationLevelingApi, GamificationMetricsApi, GamificationTriviaApi, InvoicesApi, LocationsApi, LogsApi, MediaArtistsApi, MediaModerationApi, MediaVideosApi, MessagingApi, PaymentsApi, PaymentsAppleApi, PaymentsGoogleApi, PaymentsOptimalApi, PaymentsPayPalClassicApi, PaymentsStripeApi, PaymentsTransactionsApi, PaymentsWalletsApi, PaymentsXsollaApi, ReportingChallengesApi, ReportingOrdersApi, ReportingRevenueApi, ReportingSubscriptionsApi, ReportingUsageApi, ReportingUsersApi, SearchApi, SocialFacebookApi, SocialGoogleApi, StoreApi, StoreBundlesApi, StoreCouponsApi, StoreSalesApi, StoreShippingApi, StoreShoppingCartsApi, StoreSubscriptionsApi, StoreVendorsApi, TaxesApi, TemplatesPropertiesApi, UsersApi, UsersAddressesApi, UsersFriendshipsApi, UsersGroupsApi, UsersInventoryApi, UsersRelationshipsApi, UsersSubscriptionsApi, UtilBatchApi, UtilHealthApi, UtilMaintenanceApi, UtilSecurityApi, UtilVersionApi) {
  'use strict';

  /**
   * This_is_the_spec_for_the_Knetik_API___Use_this_in_conjunction_with_the_documentation_found_at_httpsknetikcloud_com_.<br>
  ...
  var exports = {
    ...
    ApiClient: ApiClient,
    /**
     * The AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings model constructor.
     * @property {module:model/AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings}
     */
    AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings: AOccurrenceOfAnActivityTheActualGameForExampleUsedToTrackScoresParticipantsAndProvideSettings,
    /**
     * The ARequestToResetAUsersPasswordByUsingAKnownUserProperty model constructor.
     * @property {module:model/ARequestToResetAUsersPasswordByUsingAKnownUserProperty}
     */
    ARequestToResetAUsersPasswordByUsingAKnownUserProperty: ARequestToResetAUsersPasswordByUsingAKnownUserProperty,
    /**
    ...
    /**
     * The RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc model constructor.
     * @property {module:model/RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc}
     */
    RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc: RepresentsAnActivityThatCanBeParameterizedAndTrackedThroughMetricsScoresEtc,
    /**
    ...
    /**
     * The TheDefinitionOfAnActivityParametersExDifficultyLevel model constructor.
     * @property {module:model/TheDefinitionOfAnActivityParametersExDifficultyLevel}
     */
    TheDefinitionOfAnActivityParametersExDifficultyLevel: TheDefinitionOfAnActivityParametersExDifficultyLevel,
    /**
