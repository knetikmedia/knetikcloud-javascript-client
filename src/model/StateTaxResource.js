...
* @version 3.0.7
*/
export default class StateTaxResource {
    /**
    ...
    */
    ...
    constructor(countryIso3, federallyExempt, name, rate, stateCode, taxShipping) {
        

        
        

        this['country_iso3'] = countryIso3;this['federally_exempt'] = federallyExempt;this['name'] = name;this['rate'] = rate;this['state_code'] = stateCode;this['tax_shipping'] = taxShipping;
