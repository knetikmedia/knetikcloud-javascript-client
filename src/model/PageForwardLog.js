...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ForwardLog', 'model/Sort'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ForwardLog'), require('./Sort'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.PageForwardLog = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.ForwardLog, root.KnetikPlatformApiDocumentationLatest.Sort);
  }
}(this, function(ApiClient, ForwardLog, Sort) {
  'use strict';
  ...
  /**
   * The PageForwardLog model module.
   * @module model/PageForwardLog
   * @version Latest
   */

  /**
   * Constructs a new <code>PageForwardLog</code>.
   * @alias module:model/PageForwardLog
   * @class
   */
  ...
  /**
   * Constructs a <code>PageForwardLog</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageForwardLog} obj Optional instance to populate.
   * @return {module:model/PageForwardLog} The populated <code>PageForwardLog</code> instance.
   */
