...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CartLineItem', 'model/CartShippingAddressRequest', 'model/CartShippingOption', 'model/CouponDefinition', 'model/Set'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CartLineItem'), require('./CartShippingAddressRequest'), require('./CartShippingOption'), require('./CouponDefinition'), require('./Set'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.Cart = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.CartLineItem, root.KnetikPlatformApiDocumentationLatest.CartShippingAddressRequest, root.KnetikPlatformApiDocumentationLatest.CartShippingOption, root.KnetikPlatformApiDocumentationLatest.CouponDefinition, root.KnetikPlatformApiDocumentationLatest.Set);
  }
}(this, function(ApiClient, CartLineItem, CartShippingAddressRequest, CartShippingOption, CouponDefinition, Set) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('shipping_options')) {
        obj['shipping_options'] = ApiClient.convertToType(data['shipping_options'], {'String': Set});
      }
  ...
  /**
   * @member {Object.<String, module:model/Set>} shipping_options
   */
  exports.prototype['shipping_options'] = undefined;
  /**
