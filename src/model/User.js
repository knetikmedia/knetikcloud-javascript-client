...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Affiliate', 'model/Country', 'model/Currency', 'model/Language', 'model/Property', 'model/Role', 'model/Timezone'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Affiliate'), require('./Country'), require('./Currency'), require('./Language'), require('./Property'), require('./Role'), require('./Timezone'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.User = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.Affiliate, root.KnetikPlatformApiDocumentationLatest.Country, root.KnetikPlatformApiDocumentationLatest.Currency, root.KnetikPlatformApiDocumentationLatest.Language, root.KnetikPlatformApiDocumentationLatest.Property, root.KnetikPlatformApiDocumentationLatest.Role, root.KnetikPlatformApiDocumentationLatest.Timezone);
  }
}(this, function(ApiClient, Affiliate, Country, Currency, Language, Property, Role, Timezone) {
  'use strict';
