...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ActionResource', 'model/PredicateOperation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ActionResource'), require('./PredicateOperation'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.BreRule = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.ActionResource, root.KnetikPlatformApiDocumentationLatest.PredicateOperation);
  }
}(this, function(ApiClient, ActionResource, PredicateOperation) {
  'use strict';
   ...
   * @class
   * @param actions {module:model/ActionResource} A list of actions to execute, and the mapping for their parameters, when the rule runs. Minimum 1
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('actions')) {
        obj['actions'] = ActionResource.constructFromObject(data['actions']);
      }
      if (data.hasOwnProperty('condition')) {
        obj['condition'] = PredicateOperation.constructFromObject(data['condition']);
      }
   ...
   * @member {module:model/ActionResource} actions
   */
   ...
   * @member {module:model/PredicateOperation} condition
   */
