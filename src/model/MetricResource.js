...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikPlatformApiDocumentationLatest.MetricResource = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient);
  }
   ...
   * @class
   * @param activityOccurenceId {Number} The id of the activity occurence where this score/metric occured
   * @param name {String} The name of the metric
   * @param value {Number} The value/score of the metric
   */
  var exports = function(activityOccurenceId, name, value) {
    var _this = this;
