...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BreCategoryResource', 'model/Order'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BreCategoryResource'), require('./Order'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikPlatformApiDocumentationLatest) {
      root.KnetikPlatformApiDocumentationLatest = {};
    }
    root.KnetikPlatformApiDocumentationLatest.PageResourceBreCategoryResource = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.BreCategoryResource, root.KnetikPlatformApiDocumentationLatest.Order);
  }
}(this, function(ApiClient, BreCategoryResource, Order) {
  'use strict';
  ...
  var discriminatorValue = 'PageResource«BreCategoryResource»';
