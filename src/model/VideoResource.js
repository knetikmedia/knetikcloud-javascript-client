...
export default class VideoResource {
    ...
    */
    ...
    constructor(category, extension, height, length, location, name, width) {
        

        
        

        this['category'] = category;this['extension'] = extension;this['height'] = height;this['length'] = length;this['location'] = location;this['name'] = name;this['width'] = width;
