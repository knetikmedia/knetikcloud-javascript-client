...
* @version 3.0.7
*/
export default class TimePeriodGettable {
    /**
    ...
    */
    ...
    constructor(getLimit, timeLength, unitOfTime) {
        

        Behavior.call(this);
        

        this['get_limit'] = getLimit;this['time_length'] = timeLength;this['unit_of_time'] = unitOfTime;
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimePeriodGettable();
