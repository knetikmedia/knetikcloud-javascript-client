...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikPlatformApiDocumentationLatest.AvailableSettingResource = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.SettingOption);
  }
   ...
   * @class
   * @param defaultValue {String} The value of the default option (must be in options array)
   * @param key {String} The unique ID for the setting
   * @param name {String} The textual name of the setting
   * @param options {Array.<module:model/SettingOption>} The set of options available for this setting
   */
