...
* @version 3.0.7
*/
export default class AchievementDefinitionResource {
    /**
    ...
    */
    ...
    constructor(hidden, name, requiredProgress) {
        

        
        

        this['hidden'] = hidden;this['name'] = name;this['required_progress'] = requiredProgress;
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AchievementDefinitionResource();
