...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikPlatformApiDocumentationLatest.AchievementDefinitionResource = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient, root.KnetikPlatformApiDocumentationLatest.Property);
  }
   ...
   * @param maxValue {Number} The maximum value for the achievement definition. Must be greater than or equal to min_value.
   * @param minValue {Number} The minimum value for the achievement definition. Must be greater than zero.
   * @param name {String} The name of the achievement. Must be at least 6 characters in length. IMMUTABLE
   */
  var exports = function(hidden, maxValue, minValue, name) {
    var _this = this;
    ...
    _this['hidden'] = hidden;
    _this['max_value'] = maxValue;
    _this['min_value'] = minValue;
    _this['name'] = name;
