...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikPlatformApiDocumentationLatest.GroupMemberResource = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient);
  }
   ...
   * @param status {module:model/GroupMemberResource.StatusEnum} The member's access level. Default: member
   */
