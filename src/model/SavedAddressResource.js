...
* @version 3.0.7
*/
export default class SavedAddressResource {
    /**
    ...
    */
    ...
    constructor(address1, city, countryCode, firstName, lastName, name) {
        

        
        

        this['address1'] = address1;this['city'] = city;this['country_code'] = countryCode;this['first_name'] = firstName;this['last_name'] = lastName;this['name'] = name;
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SavedAddressResource();
