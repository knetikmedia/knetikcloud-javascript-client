...
* @version 3.0.7
*/
export default class CouponDefinition {
    /**
    ...
    */
    ...
    constructor(code, discountType, name, type, uniqueKey, value) {
        

        
        

        this['code'] = code;this['discount_type'] = discountType;this['name'] = name;this['type'] = type;this['unique_key'] = uniqueKey;this['value'] = value;
