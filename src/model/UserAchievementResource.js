...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikPlatformApiDocumentationLatest.UserAchievementResource = factory(root.KnetikPlatformApiDocumentationLatest.ApiClient);
  }
   ...
   * @class
   * @param achievementName {String} The achievement being tracked
   * @param progress {Number} The current progress of the user on the achievement
   * @param userId {Number} The id of the user whose progress is being tracked
   */
  var exports = function(achievementName, progress, userId) {
    var _this = this;
