...
* @version 3.0.7
*/
export default class PaymentMethodResource {
    /**
    ...
    */
    ...
    constructor(name, paymentMethodType) {
        

        
        

        this['name'] = name;this['payment_method_type'] = paymentMethodType;
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentMethodResource();
