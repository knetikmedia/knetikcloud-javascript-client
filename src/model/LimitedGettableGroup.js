...
* @version 3.0.7
*/
export default class LimitedGettableGroup {
    /**
    ...
    */
    ...
    constructor(activeOnly, ownedLimit) {
        

        
        

        this['active_only'] = activeOnly;this['owned_limit'] = ownedLimit;
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LimitedGettableGroup();
